 ...
 * intervals by compound states.
 */
enum ShiftLeftOperator implements ICCOperator {
  ...
  public CompoundInterval apply(SimpleInterval pFirstOperand, CompoundInterval pSecondOperand) {
    ...
    for (SimpleInterval interval : pSecondOperand.getIntervals()) {
      CompoundInterval current = IICOperator.SHIFT_LEFT_OPERATOR.apply(pFirstOperand,interval);
      if (current != null) {
