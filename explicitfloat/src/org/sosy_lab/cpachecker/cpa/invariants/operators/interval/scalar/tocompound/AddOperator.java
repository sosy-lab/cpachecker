...
/**
 * This class represents the addition operator for adding scalar
 * values to simple intervals.
 */
enum AddOperator implements ISCOperator {
  ...
  public CompoundInterval apply(SimpleInterval pFirstOperand, BigInteger pSecondOperand) {
    return CompoundInterval.of(ISIOperator.ADD_OPERATOR.apply(pFirstOperand, pSecondOperand));
  }
