...
public class McMillanTransferRelation implements TransferRelation {

  private final FormulaManager fmgr;

  public McMillanTransferRelation(FormulaManager pFmgr) {
    fmgr = pFmgr;
  }
  ...
  public Collection<? extends AbstractElement> getAbstractSuccessors(AbstractElement pElement, Precision pPrecision,
      CFAEdge pCfaEdge) {
    return Collections.singleton(new McMillanAbstractElement(fmgr.makeTrue()));
  }
