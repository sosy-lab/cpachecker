...
public class McMillanAbstractDomain implements AbstractDomain {

  private final Solver solver;

  public McMillanAbstractDomain(Solver pSolver) {
    solver = pSolver;
  }
  ...
  public boolean isLessOrEqual(AbstractElement pElement1, AbstractElement pElement2) throws CPAException {
    McMillanAbstractElement element1 = (McMillanAbstractElement)pElement1;
    McMillanAbstractElement element2 = (McMillanAbstractElement)pElement2;
