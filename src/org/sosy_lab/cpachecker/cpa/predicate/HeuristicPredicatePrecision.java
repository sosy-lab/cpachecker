...
public class HeuristicPredicatePrecision extends PredicatePrecision {

  public HeuristicPredicatePrecision(
      ...
      Multimap<String, AbstractionPredicate> pFunctionPredicates, Collection<AbstractionPredicate> pGlobalPredicates) {
