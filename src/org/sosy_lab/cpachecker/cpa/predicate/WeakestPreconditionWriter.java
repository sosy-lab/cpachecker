...
public class WeakestPreconditionWriter {
  ...
  public WeakestPreconditionWriter(CFA pCfa, Configuration pConfig, LogManager pLogger,
  ...
  public void writeWeakestPrecondition(@Nonnull Appendable pWriteTo, @Nonnull ReachedSet pReached) throws IOException, CPATransferException, InterruptedException {
    ...
    FluentIterable<AbstractState> targetStates = from(pReached).filter(IS_TARGET_STATE);
  ...
  public void writeWeakestPrecondition(Path pWriteTo, ReachedSet pReached) throws IOException, CPATransferException, InterruptedException {
    ...
    try (Writer w = Files.openOutputFile(pWriteTo)) {
      writeWeakestPrecondition(w, pReached);
    }
  }
