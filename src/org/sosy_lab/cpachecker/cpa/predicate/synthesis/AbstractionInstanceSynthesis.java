...
public interface AbstractionInstanceSynthesis {

  public Collection<AbstractionPredicate> getSyntheticPredicates(
      ComputeAbstractionState pElement, CFANode pLoc,
