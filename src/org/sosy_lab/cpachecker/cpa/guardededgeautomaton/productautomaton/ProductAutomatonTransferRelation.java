...
public class ProductAutomatonTransferRelation extends CompositeTransferRelation {
  ...
  public ProductAutomatonTransferRelation(
    ...
    super(pTransferRelations, null, false); // TODO is true correct here?
  }
  ...
  public Collection<CompositeState> getAbstractSuccessorsForEdge(
    ...
    for (int i = 0; i < size; i++) {
      ...
      Collection<? extends AbstractState> componentSuccessors = lCurrentTransfer
          .getAbstractSuccessorsForEdge(lCurrentElement, lCurrentPrecision, pCfaEdge);
  ...
  public Collection<? extends AbstractState> strengthen(
    ...
    if (pElement instanceof ProductAutomatonElement.PredicateElement) {
      ProductAutomatonElement.PredicateElement lElement =
          (ProductAutomatonElement.PredicateElement) pElement;
      ...
      for (AbstractState lSubelement : lElement.getWrappedStates()) {
        if (lSubelement instanceof GuardedEdgeAutomatonPredicateElement) {
          GuardedEdgeAutomatonPredicateElement lPredicateElement =
              (GuardedEdgeAutomatonPredicateElement) lSubelement;
