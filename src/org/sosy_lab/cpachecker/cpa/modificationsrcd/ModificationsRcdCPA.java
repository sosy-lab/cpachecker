...
public class ModificationsRcdCPA implements ConfigurableProgramAnalysis {
  ...
  public ModificationsRcdCPA(
    ...
    try {
      ...
      if (ignoreDeclarations) {
        ...
        transfer =
            new ModificationsRcdTransferRelation(
  ...
  public AbstractState getInitialState(CFANode node, StateSpacePartition partition)
    ...
    return new ModificationsRcdState(node, cfaForComparison.getMainFunction(), ImmutableSet.of());
  }
}
