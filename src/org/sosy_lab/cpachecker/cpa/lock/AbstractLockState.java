...
public abstract class AbstractLockState implements LatticeAbstractState<AbstractLockState>, Comparable<AbstractLockState> {
  ...
  public boolean isCompatibleWith(AbstractLockState state) {
    return Sets.intersection(getLocks(), state.getLocks()).isEmpty();
  }
  ...
  public abstract AbstractLockState prepareToStore();
}
