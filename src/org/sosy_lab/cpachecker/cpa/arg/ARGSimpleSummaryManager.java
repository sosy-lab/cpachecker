...
public class ARGSimpleSummaryManager implements SimpleSummaryManager {
  private final SimpleSummaryManager wrapped;

  public ARGSimpleSummaryManager(ConfigurableProgramAnalysis pWrapped) {
  ...
  public List<? extends AbstractState> applyFunctionSummary(
    ...
    return wrapped.applyFunctionSummary(callSite, exitState, callNode, calledBlock);
  }

  @Override
  public List<? extends AbstractState> getEntryStates(
      AbstractState callSite, CFANode callNode, Block calledBlock) {
    return wrapped.getEntryStates(callSite, callNode, calledBlock);
  }

  @Override
  public boolean isSummaryApplicable(
      AbstractState callSite, AbstractState exitState, CFANode callNode, Block calledBlock) {
    return wrapped.isSummaryApplicable(callSite, exitState, callNode, calledBlock);
  }
