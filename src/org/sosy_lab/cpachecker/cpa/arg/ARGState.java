    ...
    if (singleEdge == null) {
      ...
      if (currentLoc != null && childLoc != null) {
        ...
        if (allEdges.isEmpty() && object != null) {
          //environment
          PredicateInferenceObject pO =
              AbstractStates.extractStateByType(object, PredicateInferenceObject.class);
          if (pO != null) {
          ...
          ValueInferenceObject vO =
              AbstractStates.extractStateByType(object, ValueInferenceObject.class);
          if (vO != null) {
            Collection<CAssignment> effects = vO.getStatements();
