...
public class WitnessExporter {
  ...
  private static final class ProofInvariantProvider implements InvariantProvider {
    ...
    private ExpressionTree<Object>
        extractPredicateAnalysisAbstractionStateInvariants(String functionName, ARGState state)
    ...
    private ImmutableCollection<ExpressionTree<Object>>
        extractValueAnalysisInvariants(CFAEdge pEdge, ARGState state) {
