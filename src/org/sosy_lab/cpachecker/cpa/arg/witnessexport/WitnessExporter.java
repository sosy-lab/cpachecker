          ...
          private ExpressionTree<Object> extractValueAnalysisInvariants(
            ...
            if (valueAnalysisState != null) {
              ConcreteState concreteState =
                  ValueAnalysisConcreteErrorPathAllocator.createConcreteState(valueAnalysisState, null); // TODO added as we don't care about value analysis in this fix
    ...
    while (!worklist.isEmpty()) {
      ...
      for (CFAEdge e : CFAUtils.leavingEdges(l)) {
        ...
        if (!fileLocations.isEmpty()) {
          String fileName = String.valueOf(fileLocations.iterator().next().getFileName());
          if (fileName != null) {
            return fileName;
          }
        }
