...
public class ARGMergeForInferenceObjects implements MergeOperator {

  private final MergeOperator wrappedMerge;

  public ARGMergeForInferenceObjects(MergeOperator merge) {
    wrappedMerge = merge;
  }
  ...
  public AbstractState merge(AbstractState pState1, AbstractState pState2, Precision pPrecision) throws CPAException, InterruptedException {
    ...
    AbstractState wrappedState1 = object1.getWrappedState();
    AbstractState wrappedState2 = object2.getWrappedState();
