...
/**
 * This abstract class contains the common methods for both {@link ARGStopSep} and {@link
 * ARGStopJoin}
 */
abstract class ARGStop implements ForcedCoveringStopOperator {
  protected final boolean keepCoveredStatesInReached;
  protected final boolean inCPAEnabledAnalysis;
  protected final boolean coverTargetStates;
  protected final StopOperator wrappedStop;
