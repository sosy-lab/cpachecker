...
public interface AutomatonBoolExpr extends AutomatonExpression<Boolean> {
  ...
  class EpsilonMatch implements AutomatonBoolExpr {
    ...
    static AutomatonBoolExpr
        forwardEpsilonMatch(AutomatonBoolExpr pExpr, boolean pContinueAtBranching) {
      return of(pExpr, true, pContinueAtBranching);
    }

    static AutomatonBoolExpr
        backwardEpsilonMatch(AutomatonBoolExpr pExpr, boolean pContinueAtBranching) {
      return of(pExpr, false, pContinueAtBranching);
    }

    private static AutomatonBoolExpr
        of(AutomatonBoolExpr pExpr, boolean pForward, boolean pContinueAtBranching) {
  ...
  static class MatchLocationDescriptor implements AutomatonBoolExpr {
    ...
    public MatchLocationDescriptor(
        FunctionEntryNode pMainEntry,
        java.util.function.Predicate<FileLocation> pDescriptor) {
  ...
  static class CPAQuery implements AutomatonBoolExpr {
    ...
    public ResultValue<Boolean> eval(AutomatonExpressionArguments pArgs) {
      ...
      return new ResultValue<>(
          "No State of CPA \"" + cpaName + "\" was found!",
          "AutomatonBoolExpr.CPAQuery");
    }
  ...
  /** Constant for true. */
  static final AutomatonBoolExpr TRUE = new AutomatonBoolExpr() {
    @Override
    public ResultValue<Boolean> eval(AutomatonExpressionArguments pArgs) {
      return CONST_TRUE;
    }
  ...
  /** Constant for false. */
  static final AutomatonBoolExpr FALSE = new AutomatonBoolExpr() {
    @Override
    public ResultValue<Boolean> eval(AutomatonExpressionArguments pArgs) {
      return CONST_FALSE;
    }
