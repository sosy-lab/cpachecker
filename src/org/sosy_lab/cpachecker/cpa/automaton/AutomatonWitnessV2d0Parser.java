    ...
    if (AutomatonWitnessV2ParserUtils.getWitnessTypeIfYAML(entries)
          ...
          switch (AutomatonWitnessV2ParserUtils.getWitnessVersion(entries).orElseThrow()) {
            ...
            case V2d2 ->
                throw new UnsupportedOperationException(
                    "Correctness witnesses of version 2d2 are not supported yet to build an"
                        + " automaton out of them.");
          };
      ...
      AutomatonWitnessViolationV2d0Parser parser =
          switch (AutomatonWitnessV2ParserUtils.getWitnessVersion(entries).orElseThrow()) {
            ...
            case V2d2 ->
                throw new UnsupportedOperationException(
                    "Violation witnesses of version 2d2 are not supported yet to build an automaton"
                        + " out of them.");
          };
