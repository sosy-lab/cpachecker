...
public class BoundsCPA extends AbstractCPA<BoundsState> implements ReachedSetAdjustingCPA, StatisticsProvider, Statistics {
  ...
  @Override
  public BoundsState getInitialState(CFANode pNode, StateSpacePartition pPartition) {
