...
public class RangedAnalysisTransferRelation extends SingleEdgeTransferRelation {
  ...
  private SequenceTransferRelation leftTR;
  private SequenceTransferRelation rightTR;
  ...
  public Collection<RangedAnalysisState> getAbstractSuccessorsForEdge(
    ...
    SequenceState oldLeft = state.getLeftState();
    SequenceState oldRight = state.getRightState();
    ...
    if (cfaEdge instanceof CAssumeEdge assumeEdge) {
      ...
      // Check for being on left path and right path is empty:
  ...
  private boolean isMiddleState(SequenceState pOldLeft, SequenceState pOldRight) {
