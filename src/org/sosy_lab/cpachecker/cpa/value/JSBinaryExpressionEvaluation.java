...
final class JSBinaryExpressionEvaluation {
  ...
  static {
    ...
    operatorEvaluation.put(BinaryOperator.GREATER_EQUALS, new JSGreaterThanOrEqualEvaluation());
...
final class JSGreaterThanOrEqualEvaluation extends JSNumericBinaryOperatorEvaluation {
