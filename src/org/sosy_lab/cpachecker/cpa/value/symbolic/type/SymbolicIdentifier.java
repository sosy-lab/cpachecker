...
/**
 * Identifier for basic symbolic values. Symbolic identifiers are used to track
 * equality between variables that have non-deterministic values.
 * <p/>
 * <p>
 * Example:
 *
 ...
 * <code>b</code> is assigned the same symbolic identifier, so that the
 * condition <code>a != b</code> can be evaluated as <code>false</code>.
 * </p>
 */
public class SymbolicIdentifier implements SymbolicValue, Comparable<SymbolicIdentifier> {
     ...
     * <p/>
     * <p>
     * Each call to this method returns a new, unique
    ...
    /**
     * Converter for {@link SymbolicIdentifier} objects. Converts
     * SymbolicIdentifiers to and from Strings.
     */
    public static class Converter {
        ...
        /**
         * Converts a given {@link SymbolicIdentifier} to a String. The returned
         * <code>String</code> contains all information necessary for uniquely
         * identifying the given identifier.
         * <p/>
         * <p>
         * For a given identifier p,
         * <code>convertToIdentifier(convertToStringEncoding(p)) = p</code> is always
         * true.
         *
         * @param pIdentifier
         *            the <code>SymbolicIdentifier</code> to convert to a string
         * @return a <code>String</code> containing all information necessary for
         *         converting it to a identifier
         */
        ...
        /**
         * Returns, for a String representation s of a {@link SymbolicIdentifier}, the
         * string encoding that would result from calling
        ...
        /**
         * Converts a given encoding of a {@link SymbolicIdentifier} to the
         * corresponding <code>SymbolicIdentifier</code>.
         * <p/>
         * Only valid encodings, as produced by
         * {@link #convertToStringEncoding(SymbolicIdentifier)}, are allowed.
         *
         * @param pIdentifierInformation
         *            a <code>String</code> encoding of a
         *            <code>SymbolicIdentifier</code>
        ...
        /**
         * Returns whether the given string is a valid encoding of a
