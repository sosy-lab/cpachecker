...
public class ExpressionValueVisitorTest {
  ...
  public void checkIntegerCasts32() throws Exception {
    assume().that(machineModel).named("MachineModel").isSameInstanceAs(MachineModel.LINUX32);
  ...
  public void checkIntegerCasts64() throws Exception {
    assume().that(machineModel).named("MachineModel").isSameInstanceAs(MachineModel.LINUX64);
