...
public class ConstraintsStrengthenOperator {
  ...
  private ConstraintsStrengthenOperator(MachineModel pMachineModel) {
    machineModel = pMachineModel;
  }

  public static ConstraintsStrengthenOperator getInstance(MachineModel pMachineModel) {
    return new ConstraintsStrengthenOperator(pMachineModel);
  }
