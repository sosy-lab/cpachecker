...
class Composite2PrecisionAdjustment implements PrecisionAdjustment {
  ...
  private final Function<AbstractState, AbstractState> getStateProjectionFunction(int i) {
    return compState -> ((Composite2State) compState).get(i);
  }
  ...
  private Optional<PrecisionAdjustmentResult> prec0(
    ...
    AbstractState outElement = modified ? new Composite2State(outElements.build()) : pElement;
    Precision outPrecision     = modified ? new Composite2Precision(outPrecisions.build()) : pPrecision;
