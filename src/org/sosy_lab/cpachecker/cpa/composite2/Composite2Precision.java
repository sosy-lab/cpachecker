...
public class Composite2Precision implements WrapperPrecision {

  private final ImmutableList<Precision> precisions;

  Composite2Precision(List<Precision> precisions) {
  ...
  public boolean equals(Object other) {
    if (other == this) {
      return true;
    } else if (other == null || !(other instanceof Composite2Precision)) {
      return false;
    }

    return precisions.equals(((Composite2Precision)other).precisions);
  }
  ...
  public Precision replaceWrappedPrecision(Precision newPrecision, Predicate<? super Precision> replaceType) {
    ...
    return changed ? new Composite2Precision(newPrecisions.build()) : null;
  }
  ...
  public Precision join(Precision pOther) {
    Preconditions.checkArgument(pOther instanceof Composite2Precision);
    Composite2Precision other = (Composite2Precision) pOther;
    ...
    return changed ? new Composite2Precision(joinedPrecisions.build()) : null;
  }
}
