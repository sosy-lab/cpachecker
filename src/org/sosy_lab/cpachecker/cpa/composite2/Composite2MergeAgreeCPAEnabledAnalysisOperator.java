...
public class Composite2MergeAgreeCPAEnabledAnalysisOperator implements MergeOperator {
  ...
  Composite2MergeAgreeCPAEnabledAnalysisOperator(
  ...
  public AbstractState merge(AbstractState successorState, AbstractState reachedState, Precision precision)
    ...
    // Merge Sep Code
    Composite2State compSuccessorState = (Composite2State) successorState;
    Composite2State compReachedState = (Composite2State) reachedState;
    Composite2Precision compPrecision = (Composite2Precision) precision;
    ...
    if (identicalStates) {
      ...
      return new Composite2State(mergedStates.build());
    }
  }
