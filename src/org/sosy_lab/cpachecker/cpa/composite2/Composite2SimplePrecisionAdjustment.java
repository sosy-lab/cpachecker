...
/**
 * Alternative to {@link Composite2SimplePrecisionAdjustment} which is faster
 ...
 */
class Composite2SimplePrecisionAdjustment extends SimplePrecisionAdjustment {

  private final ImmutableList<SimplePrecisionAdjustment> precisionAdjustments;

  Composite2SimplePrecisionAdjustment(
  ...
  public Action prec(AbstractState pElement, Precision pPrecision) throws CPAException {
    Composite2State comp = (Composite2State) pElement;
    Composite2Precision prec = (Composite2Precision) pPrecision;
