...
public class GenericAssumptionsCPA implements
                                   ConfigurableProgramAnalysis<GenericAssumptionsState> {

  public static CPAFactory factory() {
    return AutomaticCPAFactory.forType(GenericAssumptionsCPA.class);
  }

  private final GenericAssumptionsState topState;
  private final AbstractDomain<GenericAssumptionsState> abstractDomain;
  ...
  @Override
  public AbstractDomain<GenericAssumptionsState> getAbstractDomain() {
    return abstractDomain;
  }

  @Override
  public GenericAssumptionsState getInitialState(CFANode pNode, StateSpacePartition pPartition) {
    return topState;
  }
