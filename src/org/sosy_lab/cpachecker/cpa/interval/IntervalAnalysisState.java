...
public class IntervalAnalysisState implements Serializable, LatticeAbstractState<IntervalAnalysisState>,
        AbstractQueryableState, Graphable, FormulaReportingState, PseudoPartitionable {
     ...
     */
    private final PersistentMap<String, NumberInterface> intervals;
    ...
    /**
     * This method acts as the default constructor, which initializes the
     * intervals and reference counts to empty maps and the previous element to
     * null.
     */
    ...
    /**
     * This method acts as constructor, which initializes the intervals, the
     * reference counts and the previous element to the respective objects.
     *
     * @param intervals
     *            the intervals
     * @param referencesMap
     ...
     */
    public IntervalAnalysisState(PersistentMap<String, NumberInterface> intervals,
    ...
    public NumberInterface getInterval(String variableName) {
        return intervals.getOrDefault(variableName, new CreatorIntegerInterval().factoryMethod(null).UNBOUND());
    }
    ...
    public IntervalAnalysisState addInterval(String variableName, NumberInterface interval, int pThreshold) {
        ...
        if (!intervals.containsKey(variableName) || !intervals.get(variableName).equals(interval)) {
            ...
            if (pThreshold == -1 || referenceCount < pThreshold) {
                return new IntervalAnalysisState(intervals.putAndCopy(variableName, interval),
     ...
     */
    public IntervalAnalysisState rebuildStateAfterFunctionCall(final IntervalAnalysisState callState,
    ...
    public String toString() {
        ...
        for (Map.Entry<String, NumberInterface> entry : intervals.entrySet()) {
    ...
    public String toDOTLabel() {
        ...
        for (Entry<String, NumberInterface> entry : intervals.entrySet()) {
    ...
    public Comparable<?> getPseudoPartitionKey() {
        ...
        for (NumberInterface i : intervals.values()) {
            // TODO doubles???
