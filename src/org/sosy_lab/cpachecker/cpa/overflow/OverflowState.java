...
class OverflowState implements AbstractStateWithAssumptions, Graphable, AbstractQueryableState {
  ...
  public OverflowState(
      List<? extends AExpression> pAssumptions, boolean pHasOverflow, OverflowState parent) {
  ...
  public PathFormula getPreviousPathFormula(PathFormula pPathFormula) {
    ...
    assert pPathFormula.getSsa().equals(currentPathFormula.getSsa())
        : "supplied path formula does not match!"
