...
public class MultiGoalPrecisionAdjustment extends SimplePrecisionAdjustment {
  @Override
  public Action prec(final AbstractState pState, final Precision pPrecision) throws CPAException {
    MultiGoalState tState = AbstractStates.extractStateByType(pState, MultiGoalState.class);
