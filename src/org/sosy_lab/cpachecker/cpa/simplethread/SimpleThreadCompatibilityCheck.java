...
public class SimpleThreadCompatibilityCheck implements CompatibilityCheck {

  @Override
  public boolean compatible(AbstractState pState, InferenceObject pObject) {
    SimpleThreadState state = (SimpleThreadState) pState;
    SimpleThreadInferenceObject object = (SimpleThreadInferenceObject) pObject;
