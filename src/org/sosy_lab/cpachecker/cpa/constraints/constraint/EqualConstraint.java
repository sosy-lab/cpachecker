...
public class EqualConstraint extends Constraint {
  ...
  /**
   * Creates a new <code>EqualConstraint</code> object with the given operator and operand.
   *
   * @param pLeftOperand the left operand of the constraint
   * @param pRightOperand the right operand of the constraint
   */
  EqualConstraint(ConstraintOperand pLeftOperand,
      ConstraintOperand pRightOperand) {
    super(pLeftOperand, pRightOperand);
  }

  /**
   * Creates a new positive or negative <code>EqualConstraint</code> object with the given operator and operand.
   *
   * @param pLeftOperand the left operand of the constraint
   * @param pRightOperand the right operand of the constraint
