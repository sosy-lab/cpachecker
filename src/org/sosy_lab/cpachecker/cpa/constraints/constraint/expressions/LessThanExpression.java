 ...
 */
public class LessThanExpression extends BinaryConstraintExpression {

  protected LessThanExpression(ConstraintExpression pOperand1, ConstraintExpression pOperand2, Type pType) {
