...
public class HybridAnalysisStatistics implements Statistics {
  ...
  public HybridAnalysisStatistics(
    ...
    pConfig.inject(this);
    logger = pLogger;
    generatedForNondet = new StatCounter("Values generated for non-deterministic function assignemnt calls");
    unableGeneration = new StatCounter("Unhandled non-deterministic function call assignments.");
    assumptionFound = new StatCounter("Examined uncovered paths overall");
    feasibleAssumptionFound = new StatCounter("Feasible uncovered paths");
    solverGenerated = new StatCounter("Values generated by the solver environment");
    removedOnAssumption = new StatCounter("Tracked values removed on assumption transition");
    removedOnAssignment = new StatCounter("Tracked values removed on concrete variable assignments");
    transferWithoutValueGeneration = new StatCounter("Program transitions without value generation");
  }
  ...
  public void printStatistics(PrintStream pOut, Result pResult, UnmodifiableReachedSet pReached) {
    ...
    writer.put(generatedForNondet)
        ...
        .put("Overall examined branches to new explored branches ration", uncoveredToFeasiblePathsRatio() + "%");
  }
