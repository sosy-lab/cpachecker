...
public class HybridAnalysisCPA implements ConfigurableProgramAnalysis {
  ...
  @Option(secure = true,
          name = "delimiter",
          description = "The delimiter for different assumptions in 'initialAssumptions' (e.g. main::x = 10.0; run::y = -5).")
  ...
  @Option(secure = true,
          name = "minNumber",
          description = "The minimum for any number generated by this CPA.")
  private double minNumber = -5;

  @Option(secure = true,
          name = "maxNumber",
          description = "The maximum for any number generated by this CPA.")
  private double maxNumber = 5;
  ...
  public AbstractState getInitialState(CFANode pNode, StateSpacePartition pPartition)
    ...
    // no
    if(initialAssumptionsStringEncoded.isEmpty())
    {
