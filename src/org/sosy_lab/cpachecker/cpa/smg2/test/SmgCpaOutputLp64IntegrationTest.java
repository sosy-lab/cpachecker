...
/** Tests YAML violation-witness output from SMG2 configurations on LP64 programs. */
public class SmgCpaOutputLp64IntegrationTest extends SMGCPAOutputIntegrationTest0 {

  @Test
  public void validDerefTargetWaypoint() throws Exception {
    if (!TestUtils.shouldRunExtendedTests()) {
      assume().that(configToUse).isEqualTo("svcomp27.properties");
      assume().that(specToUse).isEqualTo("config/properties/valid-memsafety.prp");
    }
    // Expected target: '*' in the for-loop update expression '*ptr = 1', line 22, column 26.
    assertThatOutputLP64Program(
            "smg2_tests/memory_allocation/valid_deref-null_from_malloc_fail2-false.c")
  ...
  public void validFreeLocalVarTargetWaypoint() throws Exception {
    ...
    assertThatOutputLP64Program("smg2_tests/memory_allocation/valid_free_local_var-false.c")
  ...
  public void validFreeDoubleFreeTargetWaypoint() throws Exception {
    ...
    assertThatOutputLP64Program(
            "smg2_tests/memory_allocation/valid_free-double_free_malloc1-false.c")
  ...
  public void validDerefWriteBeyondSizeTargetWaypoint() throws Exception {
    ...
    assertThatOutputLP64Program(
            "smg2_tests/memory_allocation/valid_deref-write_beyond_size-false.c")
  ...
  public void validDerefWriteBelowSizeTargetWaypoint() throws Exception {
    ...
    assertThatOutputLP64Program("smg2_tests/memory_allocation/valid_deref-write_below_size-false.c")
  ...
  public void validDerefReadBeyondSizeTargetWaypoint() throws Exception {
    ...
    assertThatOutputLP64Program("smg2_tests/memory_allocation/valid_deref-read_beyond_size-false.c")
  ...
  public void validDerefNullFromMallocFail3TargetWaypoint() throws Exception {
    ...
    assertThatOutputLP64Program(
            "smg2_tests/memory_allocation/valid_deref-null_from_malloc_fail3-false.c")
  ...
  public void validDerefNullFromMallocFail1TargetWaypoint() throws Exception {
    ...
    assertThatOutputLP64Program(
            "smg2_tests/memory_allocation/valid_deref-null_from_malloc_fail1-false.c")
  ...
  public void validDerefLiteralTargetWaypoint() throws Exception {
    ...
    assertThatOutputLP64Program("smg2_tests/memory_allocation/valid_deref-deref_literal-false.c")
