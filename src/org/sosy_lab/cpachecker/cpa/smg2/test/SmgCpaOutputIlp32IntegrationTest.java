...
public class SmgCpaOutputIlp32IntegrationTest extends SMGCPAOutputIntegrationTest0 {
  ...
  public void validFreeLocalVarTargetWaypoint() throws Exception {
    ...
    assertThatILP32Program("smg2_tests/memory_allocation/valid_free_local_var-false.c")
  ...
  public void validFreeDoubleFreeTargetWaypoint() throws Exception {
    ...
    assertThatILP32Program("smg2_tests/memory_allocation/valid_free-double_free_malloc1-false.c")
  ...
  public void validDerefWriteBeyondSizeTargetWaypoint() throws Exception {
    ...
    assertThatILP32Program("smg2_tests/memory_allocation/valid_deref-write_beyond_size-false.c")
  ...
  public void validDerefWriteBelowSizeTargetWaypoint() throws Exception {
    ...
    assertThatILP32Program("smg2_tests/memory_allocation/valid_deref-write_below_size-false.c")
  ...
  public void validDerefReadBeyondSizeTargetWaypoint() throws Exception {
    ...
    assertThatILP32Program("smg2_tests/memory_allocation/valid_deref-read_beyond_size-false.c")
  ...
  public void validDerefLiteralTargetWaypoint() throws Exception {
    ...
    assertThatILP32Program("smg2_tests/memory_allocation/valid_deref-deref_literal-false.c")
