...
public interface Type {
  ...
  public static final class PrimitiveType extends AbstractType {
    ...
    public PrimitiveType(Primitive primitiveType, boolean signed, boolean constant) {
     ...
     private PrimitiveType(boolean psigned,boolean pconstant, Primitive pprimitiveType){
       super(pconstant);
       this.signed = psigned;
    ...
    public PrimitiveType clone(){
       return new PrimitiveType(signed,this.isConst(), primitiveType);
     }
  ...
  public static final class PointerType extends AbstractType {
    ...
    public PointerType(Type targetType, boolean constant,int level) {
      super(constant);
      if (targetType == null) {
        throw new IllegalArgumentException();
      }
      this.targetType = targetType;
      levelOfIndirection = level;
    }
    ...
    public PointerType clone(){
      return new PointerType(targetType,this.isConst(),levelOfIndirection);
    }
  ...
  public static final class StructType extends CompositeType {
    ...
    public int offsetOf(String name) {
      ...
      for (String member : members.keySet()) {
        ...
        result = (int)(Math.ceil((double)(result)/(double)(members.get(name).getPaddingSize()))*members.get(name).getPaddingSize()) +members.get(name).sizeOf();
      }
      return result;
    }
    ...
    @Override
    public int getPaddingSize() {
      Iterator<Type> i = members.values().iterator();
      if(i.hasNext()){
        return i.next().getPaddingSize();
      }
      return -1;
    }
  }
