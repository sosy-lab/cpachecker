...
public class EnumVariable implements Variable{
  ...
  EnumType type;
  boolean isConst;
  EnumVariable clone=null;
  InterpreterElement tmp;


  public EnumVariable(String pname, Address paddr, EnumType ptype,boolean pisConst){
    name =pname;
    addr = paddr;
    type = ptype;
    isConst = pisConst;
  ...
  public void copyVar(String pPname, InterpreterElement pEl) throws Exception {
    ...
    EnumVariable tmp = new EnumVariable(pPname,naddr,type,isConst );
