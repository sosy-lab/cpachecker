...
public class VariableLEQ<ConstantType> extends AbstractVariableRelation<ConstantType> implements VariableRelation<ConstantType> {

  public VariableLEQ(Variable<ConstantType> pOperand1, Variable<ConstantType> pOperand2) {
    super(InvariantsFormulaManager.INSTANCE.<ConstantType>lessThanOrEqual(pOperand1, pOperand2), pOperand1, pOperand2);
  }
  ...
  public boolean equals(Object pO) {
    ...
    if (pO instanceof VariableLEQ<?>) {
      VariableLEQ<?> other = (VariableLEQ<?>) pO;
  ...
  public VariableRelation<ConstantType> intersect(VariableRelation<ConstantType> pOther) {
    ...
    return pOther.accept(new VariableRelationVisitor<ConstantType, VariableRelation<ConstantType>>() {
      ...
      public VariableRelation<ConstantType> visit(VariableLEQ<ConstantType> pVariableEquation) {
        ...
        return new VariableEQ<>(getOperand1(), getOperand2());
      }

      @Override
      public VariableRelation<ConstantType> visit(VariableNEQ<ConstantType> pVariableEquation) {
        return new VariableLT<>(getOperand1(), getOperand2());
      }
