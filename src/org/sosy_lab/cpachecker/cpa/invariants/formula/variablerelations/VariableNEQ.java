...
public class VariableNEQ<ConstantType> extends AbstractVariableRelation<ConstantType> implements VariableRelation<ConstantType> {

  public VariableNEQ(Variable<ConstantType> pOperand1, Variable<ConstantType> pOperand2) {
    super(InvariantsFormulaManager.INSTANCE.<ConstantType>logicalNot(
        InvariantsFormulaManager.INSTANCE.<ConstantType>equal(pOperand1, pOperand2)),
        pOperand1, pOperand2);
  }
  ...
  public boolean equals(Object pO) {
    ...
    if (pO instanceof VariableNEQ<?>) {
      VariableNEQ<?> other = (VariableNEQ<?>) pO;
