...
/** The singleton instance of this class provides operations for obtaining invariants formulae. */
public enum InvariantsFormulaManager {
  ...
  public <T> NumeralFormula<T> divide(
      NumeralFormula<T> pNumerator, NumeralFormula<T> pDenominator) {
  ...
  public <T> BooleanFormula<T> logicalAnd(
      BooleanFormula<T> pOperand1, BooleanFormula<T> pOperand2) {
  ...
  public <T> NumeralFormula<T> shiftLeft(
      NumeralFormula<T> pToShift, NumeralFormula<T> pShiftDistance) {
  ...
  /**
   * Gets a numeral formula representing an if-then-else condition-dependent value.
   *
  ...
  /**
   * Gets an invariants formula representing the cast of the given operand to the given bit vector.
   *
