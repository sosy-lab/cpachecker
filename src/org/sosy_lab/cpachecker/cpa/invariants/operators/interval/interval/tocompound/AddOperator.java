...
/**
 * This class represents the addition operator for adding simple
 * intervals to simple intervals.
 */
enum AddOperator implements IICOperator {
  ...
  public CompoundInterval apply(SimpleInterval pFirstOperand, SimpleInterval pSecondOperand) {
    return CompoundInterval.of(IIIOperator.ADD_OPERATOR.apply(pFirstOperand, pSecondOperand));
  }
