...
/**
 * This class represents the left shift operator for right shifting
 * intervals by scalar values.
 */
enum ShiftRightOperator implements ISCOperator {
  ...
  public CompoundState apply(SimpleInterval pFirstOperand, BigInteger pSecondOperand) {
    return CompoundState.of(ISIOperator.SHIFT_RIGHT_OPERATOR.apply(pFirstOperand, pSecondOperand));
  }
