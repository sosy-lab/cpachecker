 ...
 */
public enum ICCOperator implements Operator<BitVectorInterval, CompoundBitVectorInterval, CompoundBitVectorInterval> {
  ...
  DIVIDE {
    ...
    public CompoundBitVectorInterval apply(BitVectorInterval pFirstOperand, CompoundBitVectorInterval pSecondOperand) {
      ...
      for (BitVectorInterval interval : pSecondOperand.getBitVectorIntervals()) {
        CompoundBitVectorInterval current = IICOperator.DIVIDE.apply(pFirstOperand,interval);
        if (current != null) {
  ...
  MODULO {
    ...
    public CompoundBitVectorInterval apply(BitVectorInterval pFirstOperand, CompoundBitVectorInterval pSecondOperand) {
      CompoundBitVectorInterval result = CompoundBitVectorInterval.bottom(pFirstOperand.getBitVectorInfo());
      for (BitVectorInterval interval : pSecondOperand.getBitVectorIntervals()) {
        CompoundBitVectorInterval current = IICOperator.MODULO.apply(pFirstOperand, interval);
        if (current != null) {
          result = result.unionWith(current);
          if (result.isTop()) {
            return result;
  ...
  SHIFT_LEFT {
    ...
    public CompoundBitVectorInterval apply(BitVectorInterval pFirstOperand, CompoundBitVectorInterval pSecondOperand) {
      CompoundBitVectorInterval result = CompoundBitVectorInterval.bottom(pFirstOperand.getBitVectorInfo());
      for (BitVectorInterval interval : pSecondOperand.getBitVectorIntervals()) {
        CompoundBitVectorInterval current = IICOperator.SHIFT_LEFT.apply(pFirstOperand,interval);
        if (current != null) {
          result = result.unionWith(current);
          if (result.isTop()) {
            return result;
  ...
  SHIFT_RIGHT {
    ...
    public CompoundBitVectorInterval apply(BitVectorInterval pFirstOperand, CompoundBitVectorInterval pSecondOperand) {
      CompoundBitVectorInterval result = CompoundBitVectorInterval.bottom(pFirstOperand.getBitVectorInfo());
      for (BitVectorInterval interval : pSecondOperand.getBitVectorIntervals()) {
        CompoundBitVectorInterval current = IICOperator.SHIFT_RIGHT.apply(pFirstOperand,interval);
        if (current != null) {
          result = result.unionWith(current);
          if (result.isTop()) {
            return result;
   ...
   */
  @Override
  public abstract CompoundBitVectorInterval apply(BitVectorInterval pFirstOperand, CompoundBitVectorInterval pSecondOperand);
