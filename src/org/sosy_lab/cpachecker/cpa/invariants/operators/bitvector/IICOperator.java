 ...
 */
public enum IICOperator implements Operator<BitVectorInterval, BitVectorInterval, CompoundBitVectorInterval> {

  ADD {

    @Override
    public CompoundBitVectorInterval apply(BitVectorInterval pFirstOperand, BitVectorInterval pSecondOperand) {
      return CompoundBitVectorInterval.of(IIIOperator.ADD.apply(pFirstOperand, pSecondOperand));
    }
  },
  ...
  MODULO {
    ...
    @Override
    public CompoundBitVectorInterval apply(BitVectorInterval pFirstOperand, BitVectorInterval pSecondOperand) {
      return CompoundBitVectorInterval.of(pFirstOperand).modulo(pSecondOperand.getLowerBound().abs().max(pSecondOperand.getUpperBound().abs()));
    }
  ...
  MULTIPLY {
    ...
    @Override
    public CompoundBitVectorInterval apply(BitVectorInterval pFirstOperand, BitVectorInterval pSecondOperand) {
      return CompoundBitVectorInterval.of(IIIOperator.MULTIPLY.apply(pFirstOperand, pSecondOperand));
    }
  ...
  SHIFT_LEFT {
    ...
    public CompoundBitVectorInterval apply(BitVectorInterval pFirstOperand, BitVectorInterval pSecondOperand) {
      ...
      if (pSecondOperand.containsPositive()) {
         ...
         */
        CompoundBitVectorInterval posPartResult = ISCOperator.SHIFT_LEFT.apply(pFirstOperand, posPart.getLowerBound());

        posPartResult = CompoundBitVectorInterval.span(posPartResult, ISCOperator.SHIFT_LEFT.apply(pFirstOperand, posPart.getUpperBound()));
  ...
  SHIFT_RIGHT {
    ...
    public CompoundBitVectorInterval apply(BitVectorInterval pFirstOperand, BitVectorInterval pSecondOperand) {
      ...
      if (pSecondOperand.containsPositive()) {
         ...
         * the positive part and span over the results.
         */
        CompoundBitVectorInterval posPartResult = ISCOperator.SHIFT_RIGHT.apply(pFirstOperand, posPart.getLowerBound());

        posPartResult = CompoundBitVectorInterval.span(posPartResult, ISCOperator.SHIFT_RIGHT.apply(pFirstOperand, posPart.getUpperBound()));
   ...
   */
  @Override
  public abstract CompoundBitVectorInterval apply(BitVectorInterval pFirstOperand, BitVectorInterval pSecondOperand);
