...
public class CompositeMergeForInferenceObjects implements IOMergeOperator {

  private final ImmutableList<IOMergeOperator> mergeOperators;

  CompositeMergeForInferenceObjects(ImmutableList<IOMergeOperator> mergeOperators) {
  ...
  public InferenceObject merge(
    ...
    for (IOMergeOperator mergeOp : mergeOperators) {
      InferenceObject absSuccessorState = iter1.next();
      InferenceObject absReachedState = iter2.next();
      InferenceObject mergedState;
