...
public class ViolationCompositeState
  ...
  public ViolationCompositeState(List<AbstractState> elements) {
  ...
  public AbstractState forkWithReplacements(Collection<AbstractState> pReplacementStates) {
    ...
    ViolationCompositeState newState = new ViolationCompositeState(newWrappedStates);
    return newState;
  }
}
