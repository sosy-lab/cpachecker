...
public class OctagonInterval {
   ...
   * another OctInterval.
   *
   * <p>The lower bound and upper bound of the new OctInterval is the minimum of both lower bounds
   * and the maximum of both upper bounds, respectively.
   *
   ...
   *
   * <p>The lower bound and upper bound of the new OctInterval is the maximum of both lower bounds
   * and the minimum of both upper bounds, respectively.
   *
   * @param other the other OctInterval
   * @return the new OctInterval with the respective bounds
   */
   ...
   *
   * <p>The method still returns true, if the borders match. An empty OctInterval does not contain
   * any OctInterval and is not contained in any OctInterval either. So if the callee or parameter
  ...
  public boolean contains(OctagonInterval other) {
    return (!isEmpty()
        && !other.isEmpty()
        && low.lessEqual(other.low)
        && other.high.lessEqual(high));
  }
  ...
  public OctagonInterval plus(OctagonInterval OctInterval) {
    ...
    return new OctagonInterval(
        scalarPlus(low, OctInterval.low), scalarPlus(high, OctInterval.high));
  }
