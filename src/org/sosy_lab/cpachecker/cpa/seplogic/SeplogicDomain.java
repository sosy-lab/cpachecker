...
public class SeplogicDomain implements AbstractDomain {
  ...
  public boolean isLessOrEqual(AbstractElement pElement1, AbstractElement pElement2) throws CPAException {
    SeplogicElement newElement = (SeplogicElement) pElement1;
    SeplogicElement reachedElement = (SeplogicElement) pElement2;

    return newElement.entails(reachedElement);
  }
}
