...
public class PrintVisitor implements Visitor<String, Exception> {

  @Override
  public String visit(Addition pAdd) throws Exception {
    return pAdd.getSummand1().accept(this) + " + "+ pAdd.getSummand2().accept(this);
  }

  @Override
  public String visit(Multiplication pMult) throws Exception {
    return pMult.getFactor1().accept(this) + " * " + pMult.getFactor2().accept(this);
  }

  @Override
  public String visit(Exponent pExp) throws Exception {
    return visit(pExp.getBasis()) + " ** " + pExp.getExponent().accept(this);
  }

  @Override
  public String visit(Variable pVar) {
    return pVar.getIdentifier();
  }

  @Override
  public String visit(Constant pC) {
    return "" + pC.getValue();
  }
