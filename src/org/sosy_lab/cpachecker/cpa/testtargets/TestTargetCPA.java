...
public class TestTargetCPA extends AbstractCPA implements ConfigurableProgramAnalysisWithBAM {
  ...
  public static class TestTargetOptions {
    ...
    @Option(
        ...
        description =
            "Set to enable optimizations to be applied to result of previous optimizations")
    ...
    public Set<CFAEdge> getTargetEdges(final CFA pCfa, final LogManager pLogger) {
  ...
  public boolean isRunInParallel() {
    return targetOptions.isRunParallel();
  }
}
