...
public class SegmentedPaths {
  ...
  // All strings in this list should be generated by the method edgeToString
  ...
  public static SegmentedPaths deserialize(String input) {
    ...
    ImmutableList.Builder<ImmutableSet<ImmutableList<String>>> top = ImmutableList.builder();
    for (String setToken : SPLIT_TOP.split(input)) {
      if (setToken.isEmpty()) {
      ...
      for (String innerToken : SPLIT_SET.split(setToken)) {
        ...
        innerLists.add(ImmutableList.copyOf(SPLIT_LIST.split(innerToken)));
      }
      top.add(innerLists.build());
    }
    return new SegmentedPaths(top.build());
  }
}
