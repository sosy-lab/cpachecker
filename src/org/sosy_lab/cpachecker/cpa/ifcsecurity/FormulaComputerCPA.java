...
public class FormulaComputerCPA implements ConfigurableProgramAnalysis {
  ...
  public static CPAFactory factory() {
    return AutomaticCPAFactory.forType(FormulaComputerCPA.class);
  }

  private FormulaComputerCPA(LogManager logger, Configuration config,
