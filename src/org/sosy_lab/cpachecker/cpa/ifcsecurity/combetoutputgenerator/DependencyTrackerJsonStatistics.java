...
public class DependencyTrackerJsonStatistics implements Statistics {

  @Option(secure = true, description = "target file to hold the exported precision")
  @FileOption(FileOption.Type.OUTPUT_FILE)
  private Path jsonFile = Paths.get("dep.json");
  ...
  public DependencyTrackerJsonStatistics(DependencyTrackerCPA pCpa, Configuration pConfig, CFA pCfa,
      DependencyPrecision pPrecision) throws InvalidConfigurationException {
    this.cpa = pCpa;
    this.cfa = pCfa;
    this.precision = pPrecision;
    this.config=pConfig;
    pConfig.inject(this, DependencyTrackerJsonStatistics.class);
  }
  ...
  public void exportToJSon(UnmodifiableReachedSet pReached) {
    ...
    try (Writer writer = MoreFiles.openOutputFile(jsonFile, Charset.defaultCharset())) {
