...
/**
 * Auxilliary CPA-Abstract-State that contains a partially computed formula used for Non-interference evaluation
 */
public class FormulaState
    implements AbstractState, Cloneable, Serializable, LatticeAbstractState<FormulaState>,
        Graphable {
...
//    sb.append("\\n");
  ...
  public PathFormula formulajoin(PathFormula p1, PathFormula q1, int tag){
    ...
    SSAMap newmap1=SSAMap.merge(p1.getSsa(), q1.getSsa(), MapsDifference.collectMapsDifferenceTo(symbolDifferences1));
    ...
    PathFormula newpf=new PathFormula(newp1,newmap1,PointerTargetSet.emptyPointerTargetSet(),Math.max(length1,length2));
    return newpf;
  }
  ...
  @Override
  public boolean isLessOrEqual(FormulaState pOther)
