...
public class ApronInterpolationBasedRefiner implements Statistics {
  /**
  ...
  private final ApronInterpolator interpolator;

  protected ApronInterpolationBasedRefiner(Configuration config,
