...
public class TaintAnalysisCPAStatistics implements Statistics {
  ...
  private final TaintAnalysisCPA cpa;

  public TaintAnalysisCPAStatistics(TaintAnalysisCPA cpa, Configuration config)
      throws InvalidConfigurationException {
    this.cpa = cpa;

    config.inject(this, TaintAnalysisCPAStatistics.class);
  }
