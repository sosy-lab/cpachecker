...
import org.sosy_lab.cpachecker.cpa.value.TaintAnalysisState.ValueAndType;
...
public class ExpressionValueVisitor extends AbstractExpressionValueVisitor {
  ...
  protected final TaintAnalysisState readableState;
   ...
   */
  public ExpressionValueVisitor(TaintAnalysisState pState, String pFunctionName,
  ...
  public TaintAnalysisState getState() {
