...
public abstract class TaintPrecision implements Precision, Serializable {
  ...
  //  * classification.
  //  */
  // public static TaintPrecision createStaticPrecision(Configuration config, Optional<VariableClassification> vc, Class<? extends ConfigurableProgramAnalysis> cpaClass)
  ...
  //  */
  // public static TaintPrecision joinVariableTrackingPrecisionsInReachedSet(UnmodifiableReachedSet reached) {
