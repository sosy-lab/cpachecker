...
public final class TaintAnalysisState
    implements AbstractQueryableState,
        ...
        ForgetfulState<TaintAnalysisInformation>,
        Serializable,
        Graphable,
   ...
   */
  @Override
  public TaintAnalysisInformation forget(MemoryLocation pMemoryLocation) {

    if (!constantsMap.containsKey(pMemoryLocation)) {
      return TaintAnalysisInformation.EMPTY;
    }
    ...
    return new TaintAnalysisInformation(valueAssignment);
  }

  @Override
  public void remember(
      final MemoryLocation pLocation, final TaintAnalysisInformation pValueAndType) {
   ...
   */
  @Override
  public TaintAnalysisState join(TaintAnalysisState reachedState) {
  ...
  public boolean equals(Object other) {
    ...
    TaintAnalysisState otherElement = (TaintAnalysisState) other;
   ...
   */
  @Deprecated
  public Set<MemoryLocation> getDifference(TaintAnalysisState other) {
   ...
   */
  //  public TaintAnalysisInterpolant createInterpolant() {
  //    return new TaintAnalysisInterpolant(constantsMap);
  //  }
  //
  //  public TaintAnalysisInformation getInformation() {
  //    return new TaintAnalysisInformation(constantsMap);
  //  }
   ...
   */
  public TaintAnalysisState rebuildStateAfterFunctionCall(
      final TaintAnalysisState callState, final FunctionExitNode functionExit) {
    ...
    final TaintAnalysisState rebuildState = TaintAnalysisState.copyOf(callState);
