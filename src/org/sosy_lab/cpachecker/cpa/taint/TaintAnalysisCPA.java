...
import org.sosy_lab.cpachecker.cpa.taint.TaintAnalysisTransferRelation.ValueTransferOptions;
...
//        ConfigurableProgramAnalysisWithConcreteCex
  ...
  private final TaintAnalysisCPAStatistics statistics;
  ...
  private TaintAnalysisCPA(
    ...
    //    super("sep", "sep", new TaintTransferRelation(cfa));
    super(DelegateAbstractDomain.<TaintAnalysisState>getInstance(), null);
    this.config = config;
    this.logger = logger;
    ...
    statistics = new TaintAnalysisCPAStatistics(this, config);
  ...
  public AbstractState getInitialState(CFANode pNode, StateSpacePartition pPartition) {
    return new TaintAnalysisState(cfa.getMachineModel());
  }
