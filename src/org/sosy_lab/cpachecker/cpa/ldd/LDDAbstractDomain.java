...
public class LDDAbstractDomain implements AbstractDomain<LDDAbstractState> {
  ...
  public boolean isLessOrEqual(
      LDDAbstractState lddElement1, LDDAbstractState lddElement2)
      throws CPAException {
    if (this.topState.equals(lddElement1) || lddElement1.equals(lddElement2)) {
      return true;
    }
  ...
  @Override
  public LDDAbstractState join(
      LDDAbstractState pElement1, LDDAbstractState pElement2) throws CPAException {
    if (isLessOrEqual(pElement1, pElement2)) { return pElement2; }
    if (isLessOrEqual(pElement2, pElement1)) { return pElement1; }
    return new LDDAbstractState(this.regionManager.makeOr(pElement1.getRegion(),
        pElement2.getRegion()));
  }
