...
public final class TestHelpers {
  public static SMGValue createList(
    ...
    for (int i = 0; i < pLength; i++) {
      ...
      if (value == null) {
        hv =
            new SMGEdgeHasValue(pSmg.getMachineModel(), CPointerType.POINTER_TO_VOID, pOffset, node, SMGZeroValue.INSTANCE);
      } else {
  ...
  static public SMGEdgeHasValue createGlobalList(CLangSMG pSmg, int pLength, int pSize, int pOffset, String pVariable) {
    ...
    SMGEdgeHasValue hv = new SMGEdgeHasValue(pSmg.getMachineModel(), CPointerType.POINTER_TO_VOID, 0, globalVar, value);
