...
public class CLangSMGConsistencyVerifier {
   ...
   */
  static private boolean verifyDisjunctHeapAndGlobal(LogManager pLogger, ReadableSMG pSmg) {
   ...
   * @return True if {@link pSmg} is consistent w.r.t. this criteria. False otherwise.
   */
  static private boolean verifyDisjunctHeapAndStack(LogManager pLogger, ReadableSMG pSmg) {
   ...
   * @return True if {@link pSmg} is consistent w.r.t. this criteria. False otherwise.
   */
  static private boolean verifyDisjunctGlobalAndStack(LogManager pLogger, ReadableSMG pSmg) {
    ArrayDeque<CLangStackFrame> stack_frames = pSmg.getStackFrames();
    Set<SMGObject> stack = new HashSet<>();
   ...
   * @return True if {@link pSmg} is consistent w.r.t. this criteria. False otherwise.
   */
  static private boolean verifyStackGlobalHeapUnion(LogManager pLogger, ReadableSMG pSmg) {
   ...
   * @return True if {@link pSmg} is consistent w.r.t. this criteria. False otherwise.
   */
  static private boolean verifyNullObjectCLangProperties(LogManager pLogger, ReadableSMG pSmg) {
   ...
   * @return True if {@link pSmg} is consistent w.r.t. this criteria. False otherwise.
   */
  static private boolean verifyGlobalNamespace(LogManager pLogger, ReadableSMG pSmg) {
    Map<String, SMGRegion> globals = pSmg.getGlobalObjects();
   ...
   * @return True if {@link pSmg} is consistent w.r.t. this criteria. False otherwise.
   */
  static private boolean verifyStackNamespaces(LogManager pLogger, ReadableSMG pSmg) {
   ...
   * @return True if {@link pSmg} is consistent w.r.t. this criteria. False otherwise.
   */
  static public boolean verifyCLangSMG(LogManager pLogger, ReadableSMG pSmg) {
    boolean toReturn = SMGConsistencyVerifier.verifySMG(pLogger, (SMG)pSmg);
