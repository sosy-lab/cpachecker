...
public class SMGJoinMapTargetAddressTest {
  ...
  public void mapTargetAddressExistingNull() {
    ...
    SMGJoinMapTargetAddress mta = new SMGJoinMapTargetAddress(smg1, destSMG, mapping1, null, smg1.getNullValue(), null, false);
  ...
  public void mapTargetAddressExisting() {
    ...
    SMGJoinMapTargetAddress mta = new SMGJoinMapTargetAddress(smg1, destSMG, mapping1, null, value1, null, false);
    Assert.assertEquals(origDestSMG, mta.getSMG());
    Assert.assertEquals(origMapping1, mta.getMapping1());
    Assert.assertNull(mta.getMapping2());
  ...
  public void mapTargetAddressNew() {
    ...
    SMGJoinMapTargetAddress mta = new SMGJoinMapTargetAddress(smg1, destSMG, mapping1, mapping2, value1, value2, false);
