...
public class CollectorState extends AbstractSingleWrapperState implements Graphable, Serializable {
  // --Commented out by Inspection (09.05.20, 17:50):private static final UniqueIdGenerator idGenerator = new UniqueIdGenerator();
...
// --Commented out by Inspection START (09.05.20, 17:51):
//  public Collection<ARGState> getParents() {
//    return Collections.unmodifiableCollection(wrappedParent);
//  }
// --Commented out by Inspection STOP (09.05.20, 17:51)
