...
public interface RGEnvTransitionManager {
  ...
  /**
   * Generate an environmental transition from the candidate.
   * @param cand
   * @return
   */
  RGEnvTransition generateEnvTransition(RGEnvCandidate cand);

  /**
   * Returns a path formula representing the effect of applying et on pf.
   * The formula is meant for abstraction.
   * @param pf
   * @param et
   * @return
   */
  PathFormula formulaForAbstraction(PathFormula pf, RGEnvTransition et);
   ...
   * @return
   */
  PathFormula formulaForRefinement(PathFormula pf, RGEnvTransition et, int unique);
