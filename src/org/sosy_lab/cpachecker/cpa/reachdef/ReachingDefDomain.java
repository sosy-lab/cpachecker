...
public class ReachingDefDomain implements AbstractDomain {
  ...
  public boolean isLessOrEqual(AbstractState pState1, AbstractState pState2) throws CPAException {
    if (!(pState1 instanceof ReachingDefState && pState2 instanceof ReachingDefState)) { return false; }
    return ((ReachingDefState) pState1).isSubsetOf((ReachingDefState) pState2);
  }
