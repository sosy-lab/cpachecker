...
public record FieldScopeStructLocation(
    @Nullable String functionName, @NonNull CType structType, String instanceName, String fieldName)
    implements StructLocation {

  @Override
  public int compareTo(PointerLocation pOther) {
    if (!(pOther instanceof FieldScopeStructLocation other)) {
  ...
  public boolean equals(Object pOther) {
    ...
    return pOther instanceof FieldScopeStructLocation other
