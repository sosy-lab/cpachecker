...
public class OverflowCPA2 extends AbstractCPA implements ConfigurableProgramAnalysisWithBAM {
  ...
  public static CPAFactory factory() {
    return AutomaticCPAFactory.forType(OverflowCPA2.class);
  }

  private OverflowCPA2(CFA pCfa, LogManager pLogger, Configuration pConfiguration)
  ...
  public TransferRelation getTransferRelation() {
    return new OverflowTransferRelation2(noOverflowAssumptionBuilder, expressionBuilder);
  }
  ...
  public AbstractState getInitialState(
    ...
    return new OverflowState2(ImmutableSet.of(), false, false);
  }
}
