...
public class FiducciaMattheysesWeightedKWayAlgorithm {
  ...
  public FiducciaMattheysesWeightedKWayAlgorithm(
      ...
      WeightedGraph pWGraph,
      int pMaxLoad,
      OptimizationCriteria opt) {
  ...
  /**
   * Move a node from a partition to a partition updates data in internalDegree,externalDegree and
   * returns the gain check if nodeIsMovable is not done here!
   *
