 ...
 * and {@link #getAbstractPredecessors(AbstractState, Precision)}.
 */
public abstract class SingleEdgeTransferRelation implements TransferRelation {
  ...
  @Override
  public final Collection<? extends AbstractState> getAbstractPredecessors(AbstractState pState, Precision pPrecision)
      throws CPATransferException, InterruptedException {
