...
import org.sosy_lab.cpachecker.cpa.cer.CERAlgorithm;
...
public class CoreComponentsFactory {
  ...
  @Option(
    secure = true,
    name = "algorithm.CER",
    description = "Apply CER for counterexample reuse."
        + "\n CER requires an instance of the CEGAR algorithm.")
  private boolean useCer = false;
  ...
  public Algorithm createAlgorithm(
    ...
    if (useUndefinedFunctionCollector) {
      ...
      if (useCEGAR) {
        ...
        if (useCer) {
          algorithm = new CERAlgorithm(algorithm, cpa, logger);
        }
      }
