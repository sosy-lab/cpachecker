...
public class RestartAtRootIterationStrategy extends RestartAtDecisionIterationStrategy {

  public RestartAtRootIterationStrategy(StartupConfig pStartupConfig, ReachedSetFactory pReachedSetFactory,
      IterationModel pModel, TestGenStatistics pStats) {
    super(pStartupConfig, pReachedSetFactory, pModel, pStats);
  }
  ...
  public void updateIterationModelForNextIteration(PredicatePathAnalysisResult pResult) {
      ...
      reinitializeLocalReachedWithInitial(pResult.getWrongState(), getModel().getGlobalReached().getFirstState());
