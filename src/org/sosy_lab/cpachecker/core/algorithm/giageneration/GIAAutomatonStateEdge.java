...
public class GIAAutomatonStateEdge {
  private final AutomatonState source;
  private final Optional<AutomatonState> target;
  private final CFAEdge edge;

  public GIAAutomatonStateEdge(AutomatonState pSource, AutomatonState pTarget, CFAEdge pEdge) {
    this.source = pSource;
    this.target = Optional.of(pTarget);
    this.edge = pEdge;
  }

  public GIAAutomatonStateEdge(AutomatonState pSource, CFAEdge pEdge) {
    this.source = pSource;
  ...
  public boolean equals(Object pO) {
    ...
    if (!(pO instanceof GIAAutomatonStateEdge)) {
      return false;
    }
    GIAAutomatonStateEdge giaEdge = (GIAAutomatonStateEdge) pO;
  ...
  String getName(AutomatonState s) {
    return s.isTarget() ? GIAGenerator.NAME_OF_ERROR_STATE : s.getInternalStateName();
  }
}
