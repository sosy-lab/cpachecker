...
public class TerminationUtils {
  ...
  public static CVariableDeclaration createPrimedVariable(CVariableDeclaration variable) {
    return new CVariableDeclaration(
        FileLocation.DUMMY,
        false,
        CStorageClass.AUTO,
        variable.getType(),
        variable.getName() + PRIMED_VARIABLE_POSTFIX,
        variable.getOrigName() + PRIMED_VARIABLE_POSTFIX,
