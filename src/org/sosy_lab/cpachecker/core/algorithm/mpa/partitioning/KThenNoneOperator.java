...
public class KThenNoneOperator extends PartitioningBudgetOperator {

  @Option(secure=true, description="Add at most k properties to one partition.")
  private int k = 5;

  public KThenNoneOperator(Configuration pConfig, LogManager pLogger)
  ...
  public Partitioning partition(
    ...
    if (pLastCheckedPartitioning.getStatus() == PartitioningStatus.K_FOR_EACH) {
      return create(PartitioningStatus.BREAK, InfinitePropertyBudgeting.INSTANCE,
