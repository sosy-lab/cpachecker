...
@Options
public class AllThenNoneOperator extends PartitioningBudgetOperator {

  public AllThenNoneOperator(Configuration pConfig, LogManager pLogger)
  ...
  public Partitioning partition(
    ...
    return pLastCheckedPartitioning.getStatus() == PartitioningStatus.NONE
        ...
        : create(PartitioningStatus.BREAK, InfinitePropertyBudgeting.INSTANCE, getPartitionBudgetingOperator(),
