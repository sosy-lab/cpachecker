...
public class FormulaToSvLibTransformationVisitor implements FormulaVisitor<SvLibTerm> {

  private final FormulaManagerView fmgr;
  private final SvLibCurrentScope scope;

  public FormulaToSvLibTransformationVisitor(FormulaManagerView pFmgr, SvLibCurrentScope pScope) {
    fmgr = pFmgr;
    scope = pScope;
  }
