  ...
  @Option(
      ...
      description =
          "List of files with configurations to use. Files can be suffixed with"
              ...
              + " 1 colon ':' separating each). An annotation can be either of 'refinable',"
              + " 'supply-reached', or 'ignore-result'. 'refinable' enables iterative refinement of"
              + " the analysis precision (one of the CPAs has to be instanceof"
              + " ReachedSetAdjustingCPA). 'supply-reached' enables sharing of the (parial or"
              + " finished) reached set for use in other analyses (e.g. for invariants"
              + " computation). If 'ignore-result' is specified, the returned result of the"
