...
import org.sosy_lab.cpachecker.core.algorithm.mpor.sequentialization.ast.custom_statements.SeqExportStatementBuilder;
...
public class SequentializationBuilder {
  ...
  public static String buildFunctionDeclarations(
    ...
    rDeclarations.add(SeqExportStatementBuilder.REACH_ERROR_FUNCTION_DECLARATION.toASTString());
