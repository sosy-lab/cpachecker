...
public class SequentializationTest {
  ...
  public void testCompileSeq_lazy01() throws Exception {
    ...
    assertThat(Files.exists(path)).isTrue();
    MPOROptions options =
        MPOROptions.testInstance(true, false, true, true, false, true, true, true, false);
    testCompile(path, options);
  }
  ...
  public void testCompileSeq_singleton_with_uninit_problems_b() throws Exception {
    ...
    assertThat(Files.exists(path)).isTrue();
    MPOROptions options =
        MPOROptions.testInstance(false, true, false, true, true, false, true, false, true);
    testCompile(path, options);
  }
  ...
  public void testCompileSeq_stack1() throws Exception {
    ...
    assertThat(Files.exists(path)).isTrue();
    MPOROptions options =
        MPOROptions.testInstance(false, false, false, true, false, true, true, true, false);
    testCompile(path, options);
  }
  ...
  public void testCompileSeq_mix013_power_oepc_pso_oepc_rmo_oepc() throws Exception {
    ...
    assertThat(Files.exists(path)).isTrue();
    MPOROptions options =
        MPOROptions.testInstance(true, true, false, true, false, true, false, true, true);
    testCompile(path, options);
  }
