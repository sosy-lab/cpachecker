...
enum StandardLiftings implements Lifting {
  ...
  UNSAT_BASED_LIFTING {
    ...
    public SingleLocationFormulaInvariant lift(
      ...
      return lift(pFMGR, pProver, pCti, pAssertPredecessor, (pLiftedCTI) -> {});
    }
    ...
    public SingleLocationFormulaInvariant lift(
        ...
        UnsatCallback pUnsatCallback)
          throws CPATransferException, InterruptedException, SolverException {
      Iterator<CandidateInvariant> literalIterator = pCti.splitLiterals(pFMGR, true).iterator();
      ...
      if (isUnsat) {
        ...
        pUnsatCallback.unsat(liftedCTI);
      } else {
        liftedCTI = pCti;
      }
  ...
  static interface UnsatCallback {
    ...
    void unsat(SingleLocationFormulaInvariant pLiftedCTI);
  }
}