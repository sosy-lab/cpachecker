...
public class InfeasibilityPropagation {
  ...
  private static class IsIdStarVisitor implements PathPatternVisitor<Boolean> {
    ...
    public Boolean visit(
        org.sosy_lab.cpachecker.core.algorithm.tiger.fql.ast.pathpattern.Concatenation pConcatenation) {
    ...
    @Override
    public Boolean visit(
        org.sosy_lab.cpachecker.core.algorithm.tiger.fql.ast.pathpattern.Union pUnion) {
      return Boolean.FALSE;
    }
