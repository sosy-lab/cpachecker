...
public class TargetGraphUtil {
  ...
  public static Set<CFAEdge> getBasicBlockEntries(CFANode pInitialNode) {
    ...
    while (!lWorklist.isEmpty()) {
      ...
      while (!isLastEdge(lCurrentTraceEdge)) {
        ...
        if (lSuccessor.getNumLeavingEdges() != 1) { throw new RuntimeException(); }
  ...
  private static boolean isLastEdge(CFAEdge pCFAEdge) {
    ...
    if (lSuccessor.getNumLeavingEdges() != 1) { return true; }

    if (lSuccessor.getNumEnteringEdges() != 1) { return true; }

    if (pCFAEdge.getEdgeType().equals(CFAEdgeType.FunctionCallEdge)) { return true; }
  ...
  public static TargetGraph cfa(CFANode pInitialNode) {
    if (pInitialNode == null) { throw new IllegalArgumentException(); }

    if (pInitialNode.getFunctionName().equals(WrapperUtil.CPAtiger_MAIN)) { throw new IllegalArgumentException(
        "Do not start target graph construction inside wrapper code!"); }
  ...
  public static TargetGraph union(TargetGraph pTargetGraph1, TargetGraph pTargetGraph2) {
    if (pTargetGraph1 == null || pTargetGraph2 == null) { throw new IllegalArgumentException(); }
  ...
  public static TargetGraph minus(TargetGraph pTargetGraph1, TargetGraph pTargetGraph2) {
    ...
    for (Node lNode : pTargetGraph1.getNodes()) {
      if (!pTargetGraph2.contains(lNode) || pTargetGraph1.getNumberOfOutgoingEdges(lNode) != 0
          || pTargetGraph1.getNumberOfIncomingEdges(lNode) != 0) {
        lBuilder.addNode(lNode);
  ...
  public static TargetGraph predicate(TargetGraph pTargetGraph, Predicate pPredicate) {
    if (pTargetGraph == null || pPredicate == null) { throw new IllegalArgumentException(); }
  ...
  public static TargetGraph applyFunctionNameFilter(TargetGraph pTargetGraph, String pFunctionName) {
    if (pTargetGraph == null || pFunctionName == null) { throw new IllegalArgumentException(); }
  ...
  public static TargetGraph applyStandardEdgeBasedFilter(TargetGraph pTargetGraph,
      MaskFunctor<Node, Edge> pMaskFunctor) {
    if (pTargetGraph == null || pMaskFunctor == null) { throw new IllegalArgumentException(); }
