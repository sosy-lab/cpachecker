      ...
      switch (CUP$FQLParser$act_num)
        {
          ...
          case 46: // Predicate ::= TOK_L_BRACE Term Comparison Term TOK_R_BRACE
            {
              ...
              Object comparison = ((java_cup.runtime.Symbol) CUP$FQLParser$stack.elementAt(CUP$FQLParser$top-2)).value;
              Object rightterm = ((java_cup.runtime.Symbol) CUP$FQLParser$stack.elementAt(CUP$FQLParser$top-1)).value;
          ...
          case 28: // Filter ::= TOK_PREDICATION TOK_L_PARENTHESIS Filter TOK_COMMA Predicate TOK_R_PARENTHESIS
            {
              ...
              Object predicate = ((java_cup.runtime.Symbol) CUP$FQLParser$stack.elementAt(CUP$FQLParser$top-1)).value;
          ...
          case 16: // PathPattern ::= PathPatternBlock TOK_ALTERNATIVE PathPattern
            {
              Object RESULT =null;
              Object leftPattern = ((java_cup.runtime.Symbol) CUP$FQLParser$stack.elementAt(CUP$FQLParser$top-2)).value;
              ...
              RESULT = new org.sosy_lab.cpachecker.core.algorithm.tiger.fql.ast.pathpattern.Union((PathPattern)leftPattern, (PathPattern)rightPattern);
          ...
          case 15: // PathPattern ::= PathPatternBlock TOK_CONCAT PathPattern
            {
              ...
              RESULT = new org.sosy_lab.cpachecker.core.algorithm.tiger.fql.ast.pathpattern.Concatenation((PathPattern)leftPattern, (PathPattern)rightPattern);
          ...
          case 10: // CoveragePattern ::= CoveragePattern TOK_ALTERNATIVE CoveragePattern
            {
              ...
              RESULT = new org.sosy_lab.cpachecker.core.algorithm.tiger.fql.ast.coveragespecification.Union((CoverageSpecification)leftPattern, (CoverageSpecification)rightPattern);
          ...
          case 0: // $START ::= FQLSpecification EOF
            {
              Object RESULT =null;
              Object start_val = ((java_cup.runtime.Symbol) CUP$FQLParser$stack.elementAt(CUP$FQLParser$top-1)).value;
              RESULT = start_val;
