...
@edu.umd.cs.findbugs.annotations.SuppressFBWarnings(
    value = { "EI_EXPOSE_REP", "MS_PKGPROTECT", "SIC_INNER_SHOULD_BE_STATIC" })
public class FQLParser extends java_cup.runtime.lr_parser {
  ...
  class CUP$FQLParser$actions {
    ...
    public final java_cup.runtime.Symbol CUP$FQLParser$do_action_part00000000(
      ...
      switch (CUP$FQLParser$act_num) {
        ...
        {
          Object RESULT = null;
          Object start_val = ((java_cup.runtime.Symbol) CUP$FQLParser$stack
              .elementAt(CUP$FQLParser$top - 1)).value;
          RESULT = start_val;
        ...
        {
          Object RESULT = null;
          Object coverage = ((java_cup.runtime.Symbol) CUP$FQLParser$stack
              .elementAt(CUP$FQLParser$top - 1)).value;
        ...
        {
          Object RESULT = null;
          Object filter = ((java_cup.runtime.Symbol) CUP$FQLParser$stack
              .elementAt(CUP$FQLParser$top - 2)).value;
          Object coverage = ((java_cup.runtime.Symbol) CUP$FQLParser$stack
              .elementAt(CUP$FQLParser$top - 1)).value;
          Object passing = ((java_cup.runtime.Symbol) CUP$FQLParser$stack.peek()).value;
          ...
          CoverageSpecification lScopedSpecification =
              ((CoverageSpecification) coverage).accept(lScopePropagator);
        ...
        {
          Object RESULT = null;
          Object pattern = ((java_cup.runtime.Symbol) CUP$FQLParser$stack
              .elementAt(CUP$FQLParser$top - 1)).value;
        ...
        {
          Object RESULT = null;
          Object leftPattern = ((java_cup.runtime.Symbol) CUP$FQLParser$stack
              .elementAt(CUP$FQLParser$top - 2)).value;
          Object rightPattern =
              ((java_cup.runtime.Symbol) CUP$FQLParser$stack.peek()).value;
          ...
          RESULT = new Concatenation((CoverageSpecification) leftPattern,
              (CoverageSpecification) rightPattern);
        ...
        case 10: // CoveragePattern ::= CoveragePattern TOK_ALTERNATIVE CoveragePattern
        {
          ...
          assert (rightPattern instanceof CoverageSpecification);
          RESULT =
              new org.sosy_lab.cpachecker.core.algorithm.tiger.fql.ast.coveragespecification.Union(
        ...
        case 13: // PathPatternBlock ::= PathPatternBlock TOK_KLEENE
        {
          ...
          RESULT = new org.sosy_lab.cpachecker.core.algorithm.tiger.fql.ast.pathpattern.Repetition(
              (PathPattern) pattern);
        ...
        case 15: // PathPattern ::= PathPatternBlock TOK_CONCAT PathPattern
        {
          ...
          RESULT =
              new org.sosy_lab.cpachecker.core.algorithm.tiger.fql.ast.pathpattern.Concatenation(
        ...
        case 16: // PathPattern ::= PathPatternBlock TOK_ALTERNATIVE PathPattern
        {
          ...
          RESULT = new org.sosy_lab.cpachecker.core.algorithm.tiger.fql.ast.pathpattern.Union(
              (PathPattern) leftPattern, (PathPattern) rightPattern);
        ...
        case 19: // Atom ::= TOK_PATHCOV TOK_L_PARENTHESIS Filter TOK_COMMA TOK_NAT_NUMBER TOK_R_PARENTHESIS
        {
          Object RESULT = null;
          Object filter = ((java_cup.runtime.Symbol) CUP$FQLParser$stack
              .elementAt(CUP$FQLParser$top - 3)).value;
          Integer bound = (Integer) ((java_cup.runtime.Symbol) CUP$FQLParser$stack
              .elementAt(CUP$FQLParser$top - 1)).value;
        ...
        {
          Object RESULT = null;
          Object obj1 = ((java_cup.runtime.Symbol) CUP$FQLParser$stack
              .elementAt(CUP$FQLParser$top - 1)).value;
        ...
        {
          Object RESULT = null;
          Object filter1 = ((java_cup.runtime.Symbol) CUP$FQLParser$stack
              .elementAt(CUP$FQLParser$top - 3)).value;
          Object filter2 = ((java_cup.runtime.Symbol) CUP$FQLParser$stack
              .elementAt(CUP$FQLParser$top - 1)).value;
        ...
        case 28: // Filter ::= TOK_PREDICATION TOK_L_PARENTHESIS Filter TOK_COMMA Predicate TOK_R_PARENTHESIS
        {
          ...
          Object filter = ((java_cup.runtime.Symbol) CUP$FQLParser$stack
              .elementAt(CUP$FQLParser$top - 3)).value;
          Object predicate = ((java_cup.runtime.Symbol) CUP$FQLParser$stack
              .elementAt(CUP$FQLParser$top - 1)).value;
        ...
        {
          Object RESULT = null;
          Object e1 = ((java_cup.runtime.Symbol) CUP$FQLParser$stack
              .elementAt(CUP$FQLParser$top - 2)).value;
        ...
        {
          Object RESULT = null;
          String filename = (String) ((java_cup.runtime.Symbol) CUP$FQLParser$stack
              .elementAt(CUP$FQLParser$top - 1)).value;
        ...
        {
          Object RESULT = null;
          Integer linenumber = (Integer) ((java_cup.runtime.Symbol) CUP$FQLParser$stack
              .elementAt(CUP$FQLParser$top - 1)).value;
        ...
        case 34: // Filter_Function ::= TOK_LINE_ABBREV
        {
          Object RESULT = null;
          Integer linenumber =
              (Integer) ((java_cup.runtime.Symbol) CUP$FQLParser$stack.peek()).value;
        ...
        {
          Object RESULT = null;
          Integer columnnumber = (Integer) ((java_cup.runtime.Symbol) CUP$FQLParser$stack
              .elementAt(CUP$FQLParser$top - 1)).value;
        ...
        {
          Object RESULT = null;
          String function = (String) ((java_cup.runtime.Symbol) CUP$FQLParser$stack
              .elementAt(CUP$FQLParser$top - 1)).value;
        ...
        {
          Object RESULT = null;
          String label = (String) ((java_cup.runtime.Symbol) CUP$FQLParser$stack
              .elementAt(CUP$FQLParser$top - 1)).value;
        ...
        {
          Object RESULT = null;
          String expression = (String) ((java_cup.runtime.Symbol) CUP$FQLParser$stack
              .elementAt(CUP$FQLParser$top - 1)).value;
        ...
        {
          Object RESULT = null;
          String regularexpression = (String) ((java_cup.runtime.Symbol) CUP$FQLParser$stack
              .elementAt(CUP$FQLParser$top - 1)).value;
        ...
        {
          Object RESULT = null;
          Object leftterm = ((java_cup.runtime.Symbol) CUP$FQLParser$stack
              .elementAt(CUP$FQLParser$top - 3)).value;
          Object comparison = ((java_cup.runtime.Symbol) CUP$FQLParser$stack
              .elementAt(CUP$FQLParser$top - 2)).value;
          Object rightterm = ((java_cup.runtime.Symbol) CUP$FQLParser$stack
              .elementAt(CUP$FQLParser$top - 1)).value;
          ...
          RESULT = new Predicate(
              new org.sosy_lab.cpachecker.util.predicates.simpleformulas.Predicate((Term) leftterm,
                  (org.sosy_lab.cpachecker.util.predicates.simpleformulas.Predicate.Comparison) comparison,
                  (Term) rightterm));
        ...
        case 51: // Comparison ::= TOK_GREATER_OR_EQ
        {
          ...
          RESULT =
              org.sosy_lab.cpachecker.util.predicates.simpleformulas.Predicate.Comparison.GREATER_OR_EQUAL;
        ...
        case 52: // Comparison ::= TOK_GREATER
        {
          ...
          RESULT =
              org.sosy_lab.cpachecker.util.predicates.simpleformulas.Predicate.Comparison.GREATER;
        ...
        case 53: // Comparison ::= TOK_EQ
        {
          ...
          RESULT =
              org.sosy_lab.cpachecker.util.predicates.simpleformulas.Predicate.Comparison.EQUAL;
        ...
        case 54: // Comparison ::= TOK_LESS_OR_EQ
        {
          ...
          RESULT =
              org.sosy_lab.cpachecker.util.predicates.simpleformulas.Predicate.Comparison.LESS_OR_EQUAL;
        ...
        case 56: // Comparison ::= TOK_NEQ
        {
          ...
          RESULT =
              org.sosy_lab.cpachecker.util.predicates.simpleformulas.Predicate.Comparison.NOT_EQUAL;
        ...
        default:
          throw new Exception(
              "Invalid action number " + CUP$FQLParser$act_num + "found in internal parse table");
    ...
    public final java_cup.runtime.Symbol CUP$FQLParser$do_action(
        ...
        int CUP$FQLParser$top)
        throws java.lang.Exception {
      return CUP$FQLParser$do_action_part00000000(
          CUP$FQLParser$act_num,
          CUP$FQLParser$parser,
          CUP$FQLParser$stack,
          CUP$FQLParser$top);
    }
  }
