    ...
    testgoalString +=
        " " + pGoal.toSkeleton()
            + (pGoal.getPresenceCondition() != null ? " with targetPC "
                + bddCpaNamedRegionManager.dumpRegion((org.sosy_lab.cpachecker.util.predicates.regions.Region) pGoal.getPresenceCondition()) : "");
        ...
        for (Goal goal : entry.getValue()) {
          ...
          testgoalStringCmp +=
              ...
              + (goal.getPresenceCondition() != null ? " with targetPC "
                  + bddCpaNamedRegionManager.dumpRegion((org.sosy_lab.cpachecker.util.predicates.regions.Region) goal.getPresenceCondition()) : "");
    ...
    for (Map.Entry<TestCase, List<Goal>> entry : mapping.entrySet()) {
      ...
      for (Goal goal : entry.getValue()) {
        ...
        if (presenceCondition != null) {
          str.append(": " + bddCpaNamedRegionManager.dumpRegion((org.sosy_lab.cpachecker.util.predicates.regions.Region) presenceCondition));
        }
        str.append("\n");
      }
