...
public class InputGenerationWithRandomWalkAlgorithm implements Algorithm {
  ...
  public InputGenerationWithRandomWalkAlgorithm(
    ...
    PredicateCPA predicateCPA =
        CPAs.retrieveCPAOrFail(
            cpa, PredicateCPA.class, InputGenerationWithRandomWalkAlgorithm.class);
    ...
    utils =
        new TestcaseGenUtils(
            namesOfRandomFunctions,
            solver,
            pLogger,
