...
public class Behavior {
    ...
    private void makePredicateRepresentation() {
        ...
        predicateRepresentation =  new ACSLLogicalPredicate(new ACSLLogicalPredicate(assumesPredicate, inner, BinaryOperator.AND), negatedAssumesPredicate, BinaryOperator.OR);
    }
