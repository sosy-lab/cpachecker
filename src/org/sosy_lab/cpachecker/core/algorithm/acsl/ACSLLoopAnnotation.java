...
public class ACSLLoopAnnotation implements ACSLAnnotation {
    ...
    public ACSLLoopAnnotation(LoopInvariant invariant, Map<List<Behavior>, LoopInvariant> pAdditionalInvariants) {
    ...
    private void makePredicateRepresentation() {
        ...
        for(List<Behavior> behaviors : additionalInvariants.keySet()) {
            ...
            for(Behavior behavior : behaviors) {
                ...
                enclosingConjunction = enclosingConjunction.and(assumesClause.getPredicate().getCopy().negate());
            ...
            ACSLPredicate behaviorRepresentation = new ACSLLogicalPredicate(enclosingDisjunction, additionalInvariants.get(behaviors).getPredicate(), BinaryOperator.AND);
            behaviorRepresentation = new ACSLLogicalPredicate(behaviorRepresentation, enclosingConjunction, BinaryOperator.OR);
