...
public abstract class ACSLPredicate {
    ...
    /**
     * Returns a copy of the predicate that has the same logical value as the original but is a valid C expression.
     */
    ...
    /**
     * Returns true iff the given ACSLPredicate is a negation of the one this method is called on.
     * It is advised to call <code>simplify()</code> on both predicates before calling this method.
     *
