...
public class CompletenessClause {
    ...
    private void makePredicateRepresentation() {
        //TODO: Representation for complete clauses could get simplified to true, so currently only usable for indication that something is wrong!?
