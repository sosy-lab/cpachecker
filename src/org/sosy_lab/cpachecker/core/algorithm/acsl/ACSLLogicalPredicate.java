...
public class ACSLLogicalPredicate extends ACSLPredicate {
    ...
    public ACSLLogicalPredicate(ACSLPredicate pLeft, ACSLPredicate pRight, BinaryOperator op) {
        ...
        right = pRight;
        Preconditions
            .checkArgument(BinaryOperator.isLogicOperator(op), "Unknown logic operator: %s", op);
        operator = op;
    }
    ...
    public ACSLPredicate simplify() {
        ...
        switch(operator) {
            case AND:
                if(simpleLeft.equals(getFalse()) || simpleRight.equals(getFalse()) || simpleLeft.isNegationOf(simpleRight)) {
                    return getFalse();
                ...
                break;
            case OR:
                if(simpleLeft.equals(getTrue()) || simpleRight.equals(getTrue()) || simpleLeft.isNegationOf(simpleRight)) {
                    return getTrue();
                } else if(simpleLeft.equals(simpleRight)) {
                    return simpleLeft;
