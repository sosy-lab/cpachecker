...
public class TimeSelectionStrategy implements CFATraversal.CFAVisitor {
  ...
  public AlgSelectionBooleanVector extractStatisticsFromCfa() {
    ...
    final boolean hasLoop =
        loopStructure.isEmpty() || !loopStructure.orElseThrow().getAllLoops().isEmpty();
    ...
    return AlgSelectionBooleanVector.init(hasAlias, hasArray, hasCompositeType, hasFloat, hasLoop,
        hasSingleLoop);
  }
}
