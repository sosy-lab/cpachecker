...
final class AlwaysReplacePreconditionHandler implements DssPreconditionHandler {
  ...
  public DssMessageProcessing store(DssPostConditionMessage pReceived)
    ...
    // history itself, but keeps recording it for debugging and for violation conditions derived
    // from these states, which otherwise would carry no history at all.
