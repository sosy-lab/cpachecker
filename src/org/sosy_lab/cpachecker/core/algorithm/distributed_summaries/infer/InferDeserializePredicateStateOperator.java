...
public class InferDeserializePredicateStateOperator implements DeserializeOperator {
  ...
  public InferDeserializePredicateStateOperator(
  ...
  public AbstractState deserialize(BlockSummaryMessage pMessage) throws InterruptedException {
    ...
    BooleanFormula uninstantiated =
        PredicateOperatorUtil.uninstantiateInfer(abstraction, formulaManagerView).booleanFormula();
