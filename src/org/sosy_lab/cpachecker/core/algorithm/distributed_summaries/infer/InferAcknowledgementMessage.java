...
public class InferAcknowledgementMessage extends BlockSummaryMessage {

  protected InferAcknowledgementMessage(
      String pUniqueBlockId,
      int pTargetNodeNumber,
      BlockSummaryMessagePayload pPayload,
      Instant pTimeStamp) {
    super(
        MessageType.INFER_ACKNOWLEDGMENT, pUniqueBlockId, pTargetNodeNumber, pPayload, pTimeStamp);
  }

  public static BlockSummaryMessage newAcknowledgement(
    ...
    return new InferAcknowledgementMessage(
        pUniqueBlockId, pTargetNodeNumber, payload, Instant.now());
  }
}
