...
public interface DSSConnection extends Closeable {
   ...
   * read by the Connection, and waits on the {@link DSSActor} for processing. Since the method is
   * probably used frequently, the calculation should be cheap (preferably in O(1)).
   *
