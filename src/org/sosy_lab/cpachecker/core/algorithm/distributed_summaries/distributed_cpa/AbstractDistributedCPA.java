...
public abstract class AbstractDistributedCPA implements ConfigurableProgramAnalysis {
   ...
   * @return a set of messages paired with a boolean telling the {@link org.sosy_lab.cpachecker.core.algorithm.distributed_summaries.worker.AnalysisWorker} whether to proceed
   * @throws InterruptedException thread interrupted
