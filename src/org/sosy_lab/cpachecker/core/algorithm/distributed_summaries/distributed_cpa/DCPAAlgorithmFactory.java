...
public class DCPAAlgorithmFactory {
  ...
  public static DistributedConfigurableProgramAnalysis distribute(
    ...
    if (pCPA instanceof CallstackCPA callstackCPA) {
      return distribute(callstackCPA, pBlockNode, pCFA, integerToNodeMap, pLogManager);
    }
  ...
  private static DistributedConfigurableProgramAnalysis distribute(
    ...
    return new DistributedValueAnalysisCPA(pValueAnalysisCPA, pNode, pCFA);
  }
  ...
  private static DistributedConfigurableProgramAnalysis distribute(
      ...
      LogManager pLogManager) {
    return new DistributedCallstackCPA(pCallstackCPA, pNode, pCFA, pIdToNodeMap, pLogManager);
  }
  ...
  private static DistributedConfigurableProgramAnalysis distribute(
    ...
    return new DistributedFunctionPointerCPA(pFunctionPointerCPA, pNode, pIntegerCFANodeMap);
  }
