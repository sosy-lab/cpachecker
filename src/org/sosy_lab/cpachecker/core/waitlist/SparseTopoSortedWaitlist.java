...
public class SparseTopoSortedWaitlist extends AbstractSortedWaitlist<Integer> {

  @SuppressWarnings("deprecation")
  protected SparseTopoSortedWaitlist(WaitlistFactory pSecondaryStrategy) {
  ...
  protected Integer getSortKey(AbstractElement pElement) {
    return AbstractElements.extractLocation(pElement).getSparseTopoSortId();
  }
  ...
  public static WaitlistFactory factory(final WaitlistFactory pSecondaryStrategy) {
    return new WaitlistFactory() {
      ...
      public Waitlist createWaitlistInstance() {
        return new SparseTopoSortedWaitlist(pSecondaryStrategy);
      }
    };
  }
}
