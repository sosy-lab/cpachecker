 ...
 */
public class CallstackPccSortedWaitlist extends AbstractSortedWaitlist<Integer> {

  protected CallstackPccSortedWaitlist(WaitlistFactory pSecondaryStrategy) {
    super(pSecondaryStrategy);
  }

  @Override
  protected Integer getSortKey(AbstractState pState) {
    CallstackPccState callstackState =
      AbstractStates.extractStateByType(pState, CallstackPccState.class);
  ...
  public static WaitlistFactory factory(final WaitlistFactory pSecondaryStrategy) {
    return new WaitlistFactory() {
      ...
      public Waitlist createWaitlistInstance() {
        return new CallstackPccSortedWaitlist(pSecondaryStrategy);
      }
    };
  }
}
