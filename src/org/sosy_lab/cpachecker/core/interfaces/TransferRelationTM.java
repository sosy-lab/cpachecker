...
public interface TransferRelationTM extends TransferRelation {
   ...
   *
   * @param transition current abstract transition
   * @param precision precision for abstract state
   * @return collection of all successors of the current state (may be empty)
   */
  Collection<? extends AbstractTransition>
      getAbstractSuccessors(AbstractTransition transition, Precision precision)
