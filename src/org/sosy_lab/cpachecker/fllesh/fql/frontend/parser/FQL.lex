...
import static org.sosy_lab.cpachecker.fllesh.fql.frontend.parser.FQLSym.*;
...
{TOK_L_SEQ}				{ return sym(TOK_L_SEQ); }
{TOK_R_SEQ}				{ return sym(TOK_R_SEQ); }

/* path monitors */
{TOK_NEXT}				{ return sym(TOK_NEXT); }
