...
public class CTypeToStringTest {
  ...
  private static final CType CONST_VOLATILE_INT =
      new CSimpleType(
          CTypeQualifiers.create(true, true),
          CBasicType.INT,
          false,
          false,
          false,
  ...
  public static Object[][] types() {
    return new Object[][] {
      { // declare var as pointer to int
        "int *var", new CPointerType(CTypeQualifiers.create(false, false), CNumericTypes.INT),
      },
      { // declare var as const volatile pointer to int
        "int * const volatile var",
        new CPointerType(CTypeQualifiers.create(true, true), CNumericTypes.INT),
      },
      { // declare var as pointer to const volatile int
        "const volatile int *var",
        new CPointerType(CTypeQualifiers.create(false, false), CONST_VOLATILE_INT),
      },
      { // declare var as const volatile pointer to const volatile int
        "const volatile int * const volatile var",
        new CPointerType(CTypeQualifiers.create(true, true), CONST_VOLATILE_INT),
      },
      { // declare var as array 1 of int
        "int var[1]",
        new CArrayType(
            CTypeQualifiers.create(false, false), CNumericTypes.INT, CIntegerLiteralExpression.ONE),
      },
      { // not possible to specify directly, but with typedefs
        "const volatile int var[1]",
        new CArrayType(
            CTypeQualifiers.create(true, true), CNumericTypes.INT, CIntegerLiteralExpression.ONE),
      },
      ...
      { // not possible to specify directly, but with typedefs
        ...
        new CArrayType(
            CTypeQualifiers.create(true, true), CONST_VOLATILE_INT, CIntegerLiteralExpression.ONE),
      },
      { // declare var as array 1 of pointer to int
        "int *var[1]",
        new CArrayType(
            CTypeQualifiers.create(false, false),
            new CPointerType(CTypeQualifiers.create(false, false), CNumericTypes.INT),
            CIntegerLiteralExpression.ONE),
      },
      ...
      { // declare var as function (int) returning pointer to double
        "double *var(int)",
        new CFunctionType(
            new CPointerType(CTypeQualifiers.create(false, false), CNumericTypes.DOUBLE),
      ...
      { // declare var as function (int) returning const volatile pointer to double
        ...
        new CFunctionType(
            new CPointerType(CTypeQualifiers.create(true, true), CNumericTypes.DOUBLE),
            ImmutableList.of(CNumericTypes.INT),
            false),
      },
      { // declare var as function (int) returning pointer to double
