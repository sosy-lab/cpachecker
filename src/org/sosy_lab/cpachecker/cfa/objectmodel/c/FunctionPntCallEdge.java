...
public class FunctionPntCallEdge extends AbstractCFAEdge
{
	private final List<IASTExpression> arguments;
	private final IASTStatement rawAST;

    public FunctionPntCallEdge (String rawStatement, IASTStatement rawAST, int lineNumber, CFANode predecessor, FunctionDefinitionNode successor, List<IASTExpression> arguments) {
    ...
    {
        return CFAEdgeType.FunctionPntCallEdge;
    }
