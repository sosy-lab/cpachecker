...
public class FunctionPntReturnEdge extends AbstractCFAEdge {

  public FunctionPntReturnEdge(String rawStatement, int lineNumber, CFAFunctionExitNode predecessor, CFANode successor) {
    super(rawStatement, lineNumber, predecessor, successor);
  }

  @Override
  public CFAEdgeType getEdgeType() {
    return CFAEdgeType.FunctionPntReturnEdge;
  }
