...
class RegisteredFunctionDeclarationCFABuilder implements FunctionDeclarationAppendable {

  private final FunctionDeclarationRegistry registry;
  private final FunctionDeclarationAppendable functionDeclarationAppendable;

  RegisteredFunctionDeclarationCFABuilder(
      final FunctionDeclarationRegistry pRegistry,
  ...
  public JSFunctionDeclaration append(
    ...
    registry.add(pFunctionDeclaration, jsFunctionDeclaration);
