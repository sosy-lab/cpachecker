...
public class ASTLiteralConverter {
  ...
  static CLiteralExpression conv(final IASTLiteralExpression e) {
    final CFileLocation fileLoc = ASTConverter.getLocation(e);
    final CType type = ASTTypeConverter.conv(e.getExpressionType());

    final String valueStr = String.valueOf(e.getValue());
    switch (e.getKind()) {
  ...
  /** private method, only visible for ASTConverterTest */
