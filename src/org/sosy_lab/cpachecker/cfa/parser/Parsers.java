...
public class Parsers {
  ...
  public static Parser getJavaParser(LogManager logger, Configuration config, String entryFunction)
    ...
    try {
      ...
      try {
        return parserConstructor.newInstance(logger, config, entryFunction);
