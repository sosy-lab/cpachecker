...
public final class K3LeapStep extends K3TraceStep {
  ...
  K3LeapStep(
      FileLocation pFileLocation, Map<K3IdTerm, K3ConstantTerm> pAssignments, String pLeapTag) {
    super(pFileLocation);
  ...
  public boolean equals(Object obj) {
    ...
    return obj instanceof K3LeapStep other
