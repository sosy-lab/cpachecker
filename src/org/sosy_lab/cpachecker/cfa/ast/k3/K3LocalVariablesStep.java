...
public final class K3LocalVariablesStep extends K3TraceStep {
  ...
  public K3LocalVariablesStep(Map<K3IdTerm, K3ConstantTerm> pValues, FileLocation pFileLocation) {
    super(pFileLocation);
    assignments = pValues;
  }
  ...
  public boolean equals(Object obj) {
    ...
    return obj instanceof K3LocalVariablesStep other && assignments.equals(other.assignments);
  }
}
