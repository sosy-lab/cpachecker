...
public class K3ToAstParser {
  private static ParseTree generateParseTree(
    ...
    try {
      ...
      throw new K3ParseException(e.getMessage(), e);
    }
  ...
  public static K3Script parseScript(String pInput) throws K3ParseException {
    return parseScript(pInput, Optional.empty());
  }

  public static K3Script parseScript(String pInput, Path pFilePath) throws K3ParseException {
    return parseScript(pInput, Optional.of(pFilePath));
  }

  public static class K3ParseException extends Exception {

    @Serial private static final long serialVersionUID = 45185700123046139L;

    public K3ParseException(String pMsg) {
      super(checkNotNull(pMsg));
    }

    public K3ParseException(String pMsg, Throwable pCause) {
