 ...
 * </pre>
 *
 * The array expression gives the identifier of the array. The subscript Expression gives the index
 * of the arraycell to be read.
 */
public final class JArraySubscriptExpression extends AArraySubscriptExpression
  ...
  public AArraySubscriptExpression copyWithExpressions(
    ...
    if (pArrayExpression instanceof JExpression && pSubscriptExpression instanceof JExpression) {
