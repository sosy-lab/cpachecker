...
public abstract class ForwardingJSExpressionVisitor<R, X extends Exception>
    implements JSExpressionVisitor<R, X> {

  protected final JSExpressionVisitor<R, X> delegate;

  public ForwardingJSExpressionVisitor(JSExpressionVisitor<R, X> pDelegate) {
    delegate = pDelegate;
  }
