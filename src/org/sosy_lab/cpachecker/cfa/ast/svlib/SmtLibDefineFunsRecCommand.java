...
public final class SmtLibDefineFunsRecCommand implements SmtLibCommand, SvLibCommand {
  ...
  private final ImmutableList<SvLibFunctionDeclaration> functionDeclarations;
  private final ImmutableList<SvLibTerm> bodies;
  private final FileLocation fileLocation;

  public SmtLibDefineFunsRecCommand(
      List<SvLibFunctionDeclaration> pFunctionDeclarations,
                ...
                functionDeclarations.stream()
                    .map(
                        pFunctionDeclaration ->
                            pFunctionDeclaration.getProcedureName()
  ...
  public List<SvLibFunctionDeclaration> getFunctionDeclarations() {
