...
public abstract class SvLibScope {
  ...
  protected final ImmutableMap.Builder<String, SvLibFunctionDeclaration> functionDeclarations;
  ...
  protected SvLibScope(
      ...
      ImmutableMap.Builder<String, SvLibFunctionDeclaration> pFunctionDeclarations) {
    logics = pLogics;
  ...
  void addFunctionDeclaration(SvLibFunctionDeclaration pDeclaration) {
    functionDeclarations.put(pDeclaration.getName(), pDeclaration);
  }

  SvLibFunctionDeclaration getFunctionDeclaration(String pName) {
    return Objects.requireNonNull(
