...
/**
 * We need the metadata of the choice index in K3 choice edges to properly reconstruct
 ...
 */
public class K3BlankChoiceEdge extends BlankEdge {
  private final int choiceIndex;

  public K3BlankChoiceEdge(
