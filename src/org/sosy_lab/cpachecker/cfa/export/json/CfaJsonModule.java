...
import org.sosy_lab.cpachecker.cfa.export.json.mixins.AArraySubscriptExpressionMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.AArrayTypeMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.AAssignmentMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.AAstNodeMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.ABinaryExpressionMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.ACastExpressionMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.ACharLiteralExpressionMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.ADeclarationEdgeMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.ADeclarationMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.AExpressionAssignmentStatementMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.AExpressionMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.AExpressionStatementMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.AFloatLiteralExpressionMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.AFunctionCallAssignmentStatementMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.AFunctionCallExpressionMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.AFunctionCallMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.AFunctionCallStatementMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.AFunctionDeclarationMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.AFunctionTypeMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.AIdExpressionMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.AInitializerExpressionMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.AInitializerMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.AIntegerLiteralExpressionMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.ALeftHandSideMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.ALiteralExpressionMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.AParameterDeclarationMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.APointerExpressionMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.AReturnStatementEdgeMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.AReturnStatementMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.ARightHandSideMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.ASimpleDeclarationMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.AStatementEdgeMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.AStatementMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.AStringLiteralExpressionMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.AUnaryExpressionMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.AVariableDeclarationMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.AbstractAstNodeMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.AbstractCFAEdgeMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.AbstractDeclarationMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.AbstractExpressionMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.AbstractFunctionTypeMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.AbstractInitializerMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.AbstractLeftHandSideMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.AbstractReturnStatementMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.AbstractRightHandSideMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.AbstractSimpleDeclarationMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.AbstractStatementMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.AssumeEdgeMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.BlankEdgeMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.CAddressOfLabelExpressionMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.CArrayDesignatorMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.CArrayRangeDesignatorMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.CArraySubscriptExpressionMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.CArrayTypeMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.CAssignmentMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.CAssumeEdgeMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.CAstNodeMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.CBinaryExpressionMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.CBitFieldTypeMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.CCastExpressionMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.CCharLiteralExpressionMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.CComplexCastExpressionMixin;
...
import org.sosy_lab.cpachecker.cfa.export.json.mixins.CExpressionStatementMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.CFAEdgeMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.CFALabelNodeMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.CFANodeMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.CFATerminationNodeMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.CFieldDesignatorMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.CFieldReferenceMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.CFloatLiteralExpressionMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.CFunctionCallAssignmentStatementMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.CFunctionCallEdgeMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.CFunctionCallExpressionMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.CFunctionCallMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.CFunctionCallStatementMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.CFunctionDeclarationMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.CFunctionEntryNodeMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.CFunctionReturnEdgeMixin;
...
import org.sosy_lab.cpachecker.cfa.export.json.mixins.CInitializerListMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.CInitializerMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.CIntegerLiteralExpressionMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.CLeftHandSideMixin;
...
import org.sosy_lab.cpachecker.cfa.export.json.mixins.CRightHandSideMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.CSimpleDeclarationMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.CSimpleTypeMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.CStatementEdgeMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.CStatementMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.CStringLiteralExpressionMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.CThreadCreateStatementMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.CThreadJoinStatementMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.CThreadOperationStatementMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.CTypeDeclarationMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.CTypeDefDeclarationMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.CTypeIdExpressionMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.CTypeMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.CTypedefTypeMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.CUnaryExpressionMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.CVariableDeclarationMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.CVoidTypeMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.CfaMetadataMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.DummyCFAEdgeMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.FileLocationMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.FunctionCallEdgeMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.FunctionEntryNodeMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.FunctionExitNodeMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.FunctionReturnEdgeMixin;
import org.sosy_lab.cpachecker.cfa.export.json.mixins.FunctionSummaryEdgeMixin;
...
public class CfaJsonModule extends SimpleModule {
  ...
  public void setupModule(SetupContext pContext) {
    ...
    pContext.setMixInAnnotations(
        CAddressOfLabelExpression.class, CAddressOfLabelExpressionMixin.class);
    pContext.setMixInAnnotations(CArrayDesignator.class, CArrayDesignatorMixin.class);
    pContext.setMixInAnnotations(CArrayRangeDesignator.class, CArrayRangeDesignatorMixin.class);
    pContext.setMixInAnnotations(
    ...
    pContext.setMixInAnnotations(CBitFieldType.class, CBitFieldTypeMixin.class);
    pContext.setMixInAnnotations(CCastExpression.class, CCastExpressionMixin.class);
    pContext.setMixInAnnotations(CCharLiteralExpression.class, CCharLiteralExpressionMixin.class);
    pContext.setMixInAnnotations(CComplexCastExpression.class, CComplexCastExpressionMixin.class);
    pContext.setMixInAnnotations(CComplexTypeDeclaration.class, CComplexTypeDeclarationMixin.class);
    ...
    pContext.setMixInAnnotations(CFieldDesignator.class, CFieldDesignatorMixin.class);
    pContext.setMixInAnnotations(CFieldReference.class, CFieldReferenceMixin.class);
    pContext.setMixInAnnotations(CFloatLiteralExpression.class, CFloatLiteralExpressionMixin.class);
    pContext.setMixInAnnotations(
    ...
    pContext.setMixInAnnotations(CThreadCreateStatement.class, CThreadCreateStatementMixin.class);
    pContext.setMixInAnnotations(CThreadJoinStatement.class, CThreadJoinStatementMixin.class);
    pContext.setMixInAnnotations(
    ...
    pContext.setMixInAnnotations(CTypeDefDeclaration.class, CTypeDefDeclarationMixin.class);
    pContext.setMixInAnnotations(CTypeIdExpression.class, CTypeIdExpressionMixin.class);
    pContext.setMixInAnnotations(CType.class, CTypeMixin.class);
    pContext.setMixInAnnotations(CTypedefType.class, CTypedefTypeMixin.class);
    pContext.setMixInAnnotations(CUnaryExpression.class, CUnaryExpressionMixin.class);
    ...
    pContext.setMixInAnnotations(DummyCFAEdge.class, DummyCFAEdgeMixin.class);
