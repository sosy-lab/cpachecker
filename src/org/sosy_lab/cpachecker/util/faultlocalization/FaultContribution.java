...
public class FaultContribution {
  ...
  public boolean equals(Object q) {
    return q instanceof FaultContribution casted
        && correspondingEdge.equals(casted.correspondingEdge())
        && casted.getInfos().size() == getInfos().size()
        && ImmutableList.sortedCopyOf(infos).equals(ImmutableList.sortedCopyOf(casted.infos));
  }
