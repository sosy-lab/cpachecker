...
/**
 * Faults are ranked by their score.
 * FaultScoring is meant to implement one measurement.
 */
public interface FaultScoring {
  ...
  /**
   * Calculates the RankInfo for every fault in the result set and normalizes the scores.
   * Normalized scores are more comparable.
