...
/**
 * A HolderBoolean holds a value of type boolean. This class is meant as a workaround for inner
 * classes and lambdas which require the variables they use from the outer block to be final or
 * effectively final.
 */
public final class HolderBoolean {
  ...
  private HolderBoolean(boolean pValue) {
    value = pValue;
  }
  ...
  public boolean equals(Object pO) {
    ...
    HolderBoolean holder = (HolderBoolean) pO;
