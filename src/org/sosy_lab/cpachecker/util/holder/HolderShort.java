...
/**
 * A HolderShort holds a value of type short. This class is meant as a workaround for inner
 * classes and lambdas which require the variables they use from the outer block to be final or
 * effectively final.
 */
public final class HolderShort {
  ...
  private HolderShort(short pValue) {
    value = pValue;
  }
  ...
  public boolean equals(Object pO) {
    ...
    HolderShort holder = (HolderShort) pO;
