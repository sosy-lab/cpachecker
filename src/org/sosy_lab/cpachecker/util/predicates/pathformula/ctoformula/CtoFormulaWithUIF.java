...
class ExpressionToFormulaVisitorUIF extends ExpressionToFormulaVisitor {
  ...
  public Formula visit(CUnaryExpression exp) throws UnrecognizedCCodeException {
    ...
    case AMPER:
      ...
      int idx = conv.getIndex(CtoFormulaWithUIF.OP_ADDRESSOF_NAME, expType, ssa);
      //int idx = getIndex(
      ...
      return conv.ffmgr.createFuncAndCall(
          CtoFormulaWithUIF.OP_ADDRESSOF_NAME, idx, conv.getFormulaTypeFromCType(expType), ImmutableList.of(term));
