...
public class TABooleanVarLocations implements TALocations {
  private final TABooleanVarFeatureEncoding<TCFANode> encoding;

  public TABooleanVarLocations(TABooleanVarFeatureEncoding<TCFANode> pEncoding) {
    encoding = pEncoding;
  }
