...
class DynamicMemoryHandler {
   ...
   * @param expressionVisitor A visitor to evaluate the value of the function
   *                          call.
  ...
  *
  * @param type the revealing <em>pointed</em> type (e.g. {@code char} for
  ...
  */
   ...
   * @param lhsUsedDeferredAllocationPointers A map of all used deferred
   *                                          allocation pointers on the left
   *                                          hand side.
   * @param rhsUsedDeferredAllocationPointers A map of all used deferred
   ...
   * @param usedDeferredAllocationPointers A map of all used deferred allocation
   *                                       pointers.
   * @throws UnrecognizedCCodeException If the C code was unrecognizable.
   * @throws InterruptedException If the execution gets interrupted.
   */
