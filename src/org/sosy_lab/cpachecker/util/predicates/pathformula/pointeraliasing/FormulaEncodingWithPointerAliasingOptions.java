...
public class FormulaEncodingWithPointerAliasingOptions extends FormulaEncodingOptions {
  ...
  private boolean useByteArrayForHeap = true;
  ...
  @Option(
      secure = true,
      description =
          "When then builtin strlen is called, approximate it up to length set by this option.If"
              + " the string passed to strlen is longer, the return value will be overapproximated"
              + " via nondet.")
