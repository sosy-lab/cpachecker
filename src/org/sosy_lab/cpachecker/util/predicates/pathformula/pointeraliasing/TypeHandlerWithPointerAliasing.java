...
public class TypeHandlerWithPointerAliasing extends CtoFormulaTypeHandler {
  ...
  private long getSizeofUncached(CType cType) {
    if (cType instanceof CArrayType t && !cType.hasKnownConstantSize()) {
   ...
   *
   * <p>This method will also remove all qualifiers (e.g., const/volatile/_Atomic) from the type.
   * This means that for a variable of an atomic type, {@link
