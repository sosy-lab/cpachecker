...
public class WrappingBooleanFormulaManagerView extends BooleanFormulaManagerView {
  ...
  @Override
  public BooleanFormulaView wrapInView(BooleanFormula pFormula) {
    return new BooleanFormulaView(pFormula, this);
  }


  @Override
  public BooleanFormula extractFromView(BooleanFormula pFormula) {
    return ((BooleanFormulaView)pFormula).getWrapped();
  }
}
