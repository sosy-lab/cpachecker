...
//       reducer.printInlinedCfa(inlinedCfa, System.out);
  ...
  public void testApplySequenceRule_Summarization() {
   try {
     ...
     ReducedNode n9 = new ReducedNode(new CFANode(9, "test"));
     ReducedNode n10 = new ReducedNode(new CFANode(10, "test"));
     ReducedNode n11 = new ReducedNode(new CFANode(11, "test"));
     ...
     reducer.printInlinedCfa(funct.getInlinedCfa(), System.out, new ItemTree<String, CFANode>());

     assertEquals(1, funct.getLeavingEdges(entryNode).length);
  ...
  private ReducedFunction getSimple() {
    ReducedNode n1 = new ReducedNode(new CFANode(1, "test"));
    ReducedNode n2 = new ReducedNode(new CFANode(2, "test"));
    ReducedNode n3 = new ReducedNode(new CFANode(3, "test"));
    ReducedNode n4 = new ReducedNode(new CFANode(4, "test"));
  ...
  private ReducedFunction getSimpleWithLoop() {
    ReducedNode n1 = new ReducedNode(new CFANode(1, "test"));
    ReducedNode n2 = new ReducedNode(new CFANode(2, "test"));
    ReducedNode n3 = new ReducedNode(new CFANode(3, "test"));
    ReducedNode n4 = new ReducedNode(new CFANode(4, "test"));
    ...
    funct.addEdge(n6, n7);
    funct.addEdge(n7, n8);
    funct.addEdge(n8, exitNode);

    return funct;
  }

  @Test
  public void testApplySequenceRule_Summarization_Simple1() {
   try {
     ReducedFunction funct = getSimple();

     assertEquals(6, funct.getNumOfActiveNodes());

     ReducerUnderTest reducer = new ReducerUnderTest(null, null);
     reducer.setReductionThreshold(1);
     do  {
     } while (reducer.applySequenceRule(funct));
  ...
  @Test
  public void testApplySequenceRule_Summarization_Simple2() {
   try {
     ReducedFunction funct = getSimple();
     ...
     ReducerUnderTest reducer = new ReducerUnderTest(null, null);
     reducer.setReductionThreshold(2);
     do  {
     } while (reducer.applySequenceRule(funct));
  ...
  @Test
  public void testApplySequenceRule_Summarization_SimpleLoop1() {
   try {
     ReducedFunction funct = getSimpleWithLoop();

     assertEquals(10, funct.getNumOfActiveNodes());
  ...
  @Test
  public void testApplySequenceRule_Summarization_SimpleLoop2() {
   try {
     ReducedFunction funct = getSimpleWithLoop();
     ...
     ReducerUnderTest reducer = new ReducerUnderTest(null, null);
     reducer.setReductionThreshold(1);
     reducer.setAllowAbstOnGenericNodes(false);
     do  {
     } while (reducer.applySequenceRule(funct));
