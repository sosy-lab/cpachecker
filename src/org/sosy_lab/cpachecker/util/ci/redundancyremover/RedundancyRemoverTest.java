...
//    Truth.assertThat(intervalStateImpl.getAbstractValue(intervalState2, "x")).isEqualTo(new Interval(-1L, 4L)); // TODO
  ...
  public void testGetAbstractValueValueAnalysisState() {
    ...
    valState1.assignConstant(MemoryLocation.parseExtendedQualifiedName("1"), val1, CNumericTypes.INT);
    ...
    valState2.assignConstant(MemoryLocation.parseExtendedQualifiedName("x"), val2, CNumericTypes.INT);
    ...
    valState3.assignConstant(MemoryLocation.parseExtendedQualifiedName("y"), val3, CNumericTypes.INT);
