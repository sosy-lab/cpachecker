...
/**
 * Represents a {@link SdgVisitor} that is used for backwards traversals of system dependence graphs
 * (SDGs).
 *
 ...
 */
public interface BackwardsSdgVisitor<V, N extends SdgNode<?, ?, V>, E extends SdgEdge<V>>
