...
public class TFtester {
  ...
  public static void main(String[] args) {
    ...
    FormulaType<NumericFormula> type = FormulaType.RationalType;
    NumericFormula a1 = view.makeVariable(type, "a", 1);
    NumericFormula a2 = view.makeVariable(type, "a", 2);
    NumericFormula b1 = view.makeVariable(type, "b", 1);
    NumericFormula b2 = view.makeVariable(type, "b", 2);
    NumericFormula c1 = view.makeVariable(type, "c", 1);
    NumericFormula c2 = view.makeVariable(type, "c", 2);
    NumericFormula d1 = view.makeVariable(type, "d", 1);
    NumericFormula d2 = view.makeVariable(type, "d", 2);
