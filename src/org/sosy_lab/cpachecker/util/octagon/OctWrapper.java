...
public class OctWrapper {
	...
	/* num copy */
	public native void J_num_set (long n1, long n2); // void num_set (num_t* a, const num_t* b)
	/* set int */
	public native void J_num_set_int (long n, int pos, int i); // void num_set_int (num_t* a, long i)
	/* set float */
  ...
  public native long J_full_copy (long oct); //oct_t* oct_full_copy (oct_t* m)
	...
	/* Test Functions */
	public native boolean J_isEmpty (long oct);			//bool oct_is_empty (oct_t* m)
	public native int J_isEmptyLazy (long oct);			//tbool oct_is_empty_lazy (oct_t* m)
	public native boolean J_isUniverse (long oct);		//bool oct_is_universe (oct_t* m)
	public native boolean J_isIncludedIn (long oct1, long oct2);	//bool oct_is_included_in (oct_t* ma, oct_t* mb)
	public native int J_isIncludedInLazy (long oct1, long oct2);	//tbool oct_is_included_in_lazy (oct_t* ma, oct_t* mb)
	public native boolean J_isEqual (long oct1, long oct2);		//bool oct_is_equal (oct_t* ma, oct_t* mb)
	public native int J_isEqualLazy (long oct1, long oct2);		//tbool oct_is_equal_lazy (oct_t* ma, oct_t* mb)
	public native boolean J_isIn (long oct1, long array);			//bool oct_is_in (oct_t* m, const num_t* v)

	/* Operators */
	public native long J_intersection (long oct1, long oct2, boolean dest);	//oct_t* oct_intersection (oct_t* ma, oct_t* mb, bool destructive)
	public native long J_union (long oct1, long oct2, boolean dest);			//oct_t* oct_convex_hull (oct_t* ma, oct_t* mb, bool destructive)
	/* int widening = 0 -> OCT_WIDENING_FAST
	 * int widening = 1 ->  OCT_WIDENING_ZERO
	 * int widening = 2 -> OCT_WIDENING_UNIT*/
	public native long J_widening (long oct1, long oct2, boolean dest, int widening);	//oct_t* oct_widening( oct_t* ma, oct_t* mb, bool destructive,oct_widening_type)
	public native long J_narrowing (long oct1, long oct2, boolean dest);		//oct_t* oct_narrowing (oct_t* ma, oct_t* mb, bool destructive)
	...
	public native long J_intervSubstituteVar (long oct, int x, long array, boolean dest);	//oct_t* oct_inter_substitute_variable ( oct_t* m, var_t x, const num_t* tab, bool destructive)
	public native long J_intervAddConstraint (long oct, long array, boolean dest);	//oct_t* oct_inter_add_constraint ( oct_t* m, const num_t* tab, bool destructive)

	/* change of dimensions */
	public native long J_addDimenensionAndEmbed (long oct, int k, boolean dest);		//oct_t* oct_add_dimensions_and_embed( oct_t* m, var_t dimsup, bool destructive)
	public native long J_addDimenensionAndProject (long oct, int k, boolean dest);	//oct_t* oct_add_dimensions_and_project( oct_t* m, var_t dimsup, bool destructive)
	public native long J_removeDimension (long oct, int k, boolean dest);			//oct_t*  oct_remove_dimensions( oct_t* m, var_t dimsup, bool destructive)

	// TODO implement rest of the functions

	public native void J_print (long oct);		//void oct_print (const oct_t* m)

	/* For debuggin purposes */
	public native long getRandomOct();
