...
public class OctagonIntManager extends OctagonManager {
  ...
  public Pair<InfinityNumericWrapper, InfinityNumericWrapper> getVariableBounds(Octagon oct, int id) {
    ...
    Pair<InfinityNumericWrapper, InfinityNumericWrapper> retVal = Pair.of(new InfinityNumericWrapper(J_num_get_int(lower.getArray(), 0) * -1),
                                                                          new InfinityNumericWrapper(J_num_get_int(upper.getArray(), 0)));
    J_num_clear_n(lower.getArray(), 1);
    J_num_clear_n(upper.getArray(), 1);
    return retVal;
  }
