...
/**
 * Exports a counterexample as a violation witness. A subclass provides the steps of the
 * counterexample and the constraints that hold along them, which may be obtained from the analyzed
 * program itself or, for a transformed program, from the program it was created from.
 */
public abstract class AbstractCounterexampleToWitness extends AbstractYAMLWitnessExporter {

  protected AbstractCounterexampleToWitness(
   ...
   */
  protected abstract void exportWitness(
