...
public interface CFAEdgeVisitor<ReturnType> {
  ...
  /* TODO extract simplification code into separate interface/class */
  ...
  public static boolean isGlobal(final CExpression exp) {
  ...
  public static boolean isGlobal(final JExpression exp) {
