...
public class ScopePropagator implements CoverageSpecificationVisitor<CoverageSpecification> {
  ...
  private org.sosy_lab.cpachecker.tiger.fql.ast.pathpattern.ScopePropagator mPatternScopePropagator;

  public ScopePropagator(Filter pFilter) {
    mPatternScopePropagator = new org.sosy_lab.cpachecker.tiger.fql.ast.pathpattern.ScopePropagator(pFilter);
  }
