...
public class BuggyExecutionException extends Exception {
  ...
  public BuggyExecutionException(TestCase pTestCase, GuardedEdgeAutomatonCPA pCoverCPA, GuardedEdgeAutomatonCPA pPassingCPA) {
    super();
  ...
  public String toString() {
    return "The test case " + mTestCase.toString() + " results in a bug.\n" + mCoverCPA.toString() + ((mPassingCPA == null)?"":("\n" + mPassingCPA.toString()));
  }
