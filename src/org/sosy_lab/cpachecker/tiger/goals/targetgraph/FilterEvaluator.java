 ...
 */
package org.sosy_lab.cpachecker.tiger.goals.targetgraph;

import java.util.Set;

import org.jgrapht.graph.MaskFunctor;
import org.sosy_lab.cpachecker.cfa.model.CFAEdge;
import org.sosy_lab.cpachecker.tiger.fql.ast.filter.BasicBlockEntry;
import org.sosy_lab.cpachecker.tiger.fql.ast.filter.Column;
import org.sosy_lab.cpachecker.tiger.fql.ast.filter.Complement;
import org.sosy_lab.cpachecker.tiger.fql.ast.filter.Compose;
import org.sosy_lab.cpachecker.tiger.fql.ast.filter.ConditionEdge;
import org.sosy_lab.cpachecker.tiger.fql.ast.filter.ConditionGraph;
import org.sosy_lab.cpachecker.tiger.fql.ast.filter.DecisionEdge;
import org.sosy_lab.cpachecker.tiger.fql.ast.filter.EnclosingScopes;
import org.sosy_lab.cpachecker.tiger.fql.ast.filter.Expression;
import org.sosy_lab.cpachecker.tiger.fql.ast.filter.File;
import org.sosy_lab.cpachecker.tiger.fql.ast.filter.Filter;
import org.sosy_lab.cpachecker.tiger.fql.ast.filter.FilterVisitor;
import org.sosy_lab.cpachecker.tiger.fql.ast.filter.Function;
import org.sosy_lab.cpachecker.tiger.fql.ast.filter.FunctionCall;
import org.sosy_lab.cpachecker.tiger.fql.ast.filter.FunctionCalls;
import org.sosy_lab.cpachecker.tiger.fql.ast.filter.FunctionEntry;
import org.sosy_lab.cpachecker.tiger.fql.ast.filter.FunctionExit;
import org.sosy_lab.cpachecker.tiger.fql.ast.filter.Identity;
import org.sosy_lab.cpachecker.tiger.fql.ast.filter.Intersection;
import org.sosy_lab.cpachecker.tiger.fql.ast.filter.Label;
import org.sosy_lab.cpachecker.tiger.fql.ast.filter.Line;
import org.sosy_lab.cpachecker.tiger.fql.ast.filter.Predication;
import org.sosy_lab.cpachecker.tiger.fql.ast.filter.RegularExpression;
import org.sosy_lab.cpachecker.tiger.fql.ast.filter.SetMinus;
import org.sosy_lab.cpachecker.tiger.fql.ast.filter.Union;
import org.sosy_lab.cpachecker.tiger.goals.targetgraph.mask.AssumeEdgeMaskFunctor;
import org.sosy_lab.cpachecker.tiger.goals.targetgraph.mask.BasicBlockEntryMaskFunctor;
import org.sosy_lab.cpachecker.tiger.goals.targetgraph.mask.FunctionCallMaskFunctor;
import org.sosy_lab.cpachecker.tiger.goals.targetgraph.mask.FunctionCallsMaskFunctor;
import org.sosy_lab.cpachecker.tiger.goals.targetgraph.mask.FunctionEntryMaskFunctor;
import org.sosy_lab.cpachecker.tiger.goals.targetgraph.mask.LabelMaskFunctor;
import org.sosy_lab.cpachecker.tiger.goals.targetgraph.mask.LineNumberMaskFunctor;
