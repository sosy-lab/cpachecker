...
public class UnnecessaryRepetitionRemoverTest {
  ...
  public void testFQLParserScanner001() throws Exception {
    ...
    FQLSpecification lNewSpecification = UnnecessaryRepetitionRemover.getFQLSpecificationRewriter().rewrite(lSpecification);
