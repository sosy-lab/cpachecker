...
public class BasicBlockNodes3Coverage extends ExperimentalSeries {

  @Test
  public void test_locks_101() throws Exception {
    String[] lArguments = Main.getParameters(PredefinedCoverageCriteria.BASIC_BLOCK_NODES_3_COVERAGE,
