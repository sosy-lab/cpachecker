...
public class Test1 extends ExperimentalSeries {

  @Test
  public void test002() throws Exception {
    String[] lArguments = Main.getParameters(Main.STATEMENT_COVERAGE, 
                                        "test/programs/fql/data-structures/primitive/int.cil.c", 
                                        "main", 
                                        true);
  ...
  public void test003() throws Exception {
    String[] lArguments = Main.getParameters(Main.STATEMENT_COVERAGE, 
                                        "test/programs/fql/ssh-simplified/s3_clnt_1_BUG.2.cil.c", 
                                        "main", 
                                        true);
