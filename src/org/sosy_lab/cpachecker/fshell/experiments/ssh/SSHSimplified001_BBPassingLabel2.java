...
public class SSHSimplified001_BBPassingLabel2 extends ExperimentalSeries {

  @Test
  public void ssh_001() throws Exception {
    String lCFile = "s3_clnt_1_BUG.2.cil.c";

    String[] lArguments = Main.getParameters(PredefinedCoverageCriteria.BASIC_BLOCK_COVERAGE + " PASSING EDGES(ID)*.EDGES(@LABEL(switch_1_16384)).EDGES(ID)*",
