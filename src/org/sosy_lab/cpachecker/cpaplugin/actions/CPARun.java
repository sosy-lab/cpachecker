 ...
 */
package org.sosy_lab.cpachecker.cpaplugin.actions;
...
public class CPARun implements IWorkbenchWindowActionDelegate
{
	...
	public void run (IAction action)
	{
	  Configuration cpaConfig = null;
		numberOfRuns++;
    try {
      String configFile = org.sosy_lab.cpachecker.cpaplugin.PreferencesActivator.getDefault().getPreferenceStore().getString(org.sosy_lab.cpachecker.cpaplugin.preferences.PreferenceConstants.P_PATH);
