...
public class ItpTransferRelation implements TransferRelation {
    ...
    class ART {
        Map<AbstractElementWithLocation, Vector<AbstractElementWithLocation>> tree;
        AbstractElement root;

        public ART() {
            tree = new HashMap<AbstractElementWithLocation, Vector<AbstractElementWithLocation>>();
            root = null;
        }
            ...
            while (!toProcess.empty()) {
              AbstractElementWithLocation cur = toProcess.pop();
                ...
                if (tree.containsKey(cur)) {
                    Collection<AbstractElementWithLocation> c =
...
//        }
    ...
    private void performRefinement(Deque<ItpAbstractElement> path,
        ...
        for (ItpAbstractElement ie : falseAbst) {
            Collection<AbstractElementWithLocation> tmp = abstractTree.getSubtree(
                    ie, true, false);
