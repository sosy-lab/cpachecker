...
//          "BAD INITIALIZER: " + edge.getRawStatement());
  ...
  public Pair<SymbolicFormula, SSAMap> makeAndEnterFunction(
  ...
  private Pair<SymbolicFormula, SSAMap> makeAndFunctionCall(
  ...
  private Pair<SymbolicFormula, SSAMap> makeAndReturn(
