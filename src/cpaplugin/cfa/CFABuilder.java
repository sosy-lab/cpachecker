...
public class CFABuilder extends ASTVisitor
{
    ...
    private List<CFAFunctionDefinitionNode> cfas;
    ...
    public CFABuilder ()
    {
        ...
        cfas = new ArrayList<CFAFunctionDefinitionNode> ();
        returnNode = null;
     ...
     * ************************************************************************************/
    public List<CFAFunctionDefinitionNode> getCFAs ()
    {
        return cfas;
    }
    ...
    public int visit (IASTDeclaration declaration)
    {
        ...
        else if (declaration instanceof IASTFunctionDefinition)
        {
            ...
            returnNode = new CFANode (fileloc.getEndingLineNumber ());
