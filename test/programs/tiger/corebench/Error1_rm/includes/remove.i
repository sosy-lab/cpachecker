...
# 77 "lib/sys/select.h" 2 3
# 98 "lib/sys/select.h" 3
...
# 99 "lib/sys/select.h" 2 3
# 597 "lib/sys/select.h" 3
...
# 308 "src/system.h" 3 4
 (*__errno_location ()) 
# 308 "src/system.h"
       = 0;
  dp = readdir_ignoring_dot_and_dotdot (dirp);
  saved_errno = 
# 310 "src/system.h" 3 4
               (*__errno_location ())
# 310 "src/system.h"
                    ;
  closedir (dirp);
  if (dp != 
# 312 "src/system.h" 3 4
           ((void *)0)
# 312 "src/system.h"
               )
    return 
# 313 "src/system.h" 3 4
          0
# 313 "src/system.h"
               ;
  return saved_errno == 0 ? 
# 314 "src/system.h" 3 4
                           1 
# 314 "src/system.h"
                                : 
# 314 "src/system.h" 3 4
...
{
  GETOPT_HELP_CHAR = (
# 324 "src/system.h" 3 4
                     (-0x7f - 1) 
# 324 "src/system.h"
                              - 2),
  GETOPT_VERSION_CHAR = (
# 325 "src/system.h" 3 4
                        (-0x7f - 1) 
# 325 "src/system.h"
                                 - 3)
};
...
# 102 "src/remove.c" 3 4
                                       0x100
# 102 "src/remove.c"
                                                          ) != 0)
    return -1;
  if (
# 104 "src/remove.c" 3 4
     ((((
# 104 "src/remove.c"
     buf->st_mode
# 104 "src/remove.c" 3 4
...
# 220 "src/remove.c" 3 4
                                                DT_UNKNOWN
# 220 "src/remove.c"
                                                          )
        {
          if (cache_fstatat (fd_cwd, filename, sbuf, 
# 222 "src/remove.c" 3 4
                                                    0x100
# 222 "src/remove.c"
                                                                       ) == 0)
            {
              if (
# 224 "src/remove.c" 3 4
                 ((((
# 224 "src/remove.c"
                 sbuf->st_mode
# 224 "src/remove.c" 3 4
...
# 224 "src/remove.c"
                ...
                dirent_type = 
# 225 "src/remove.c" 3 4
                             DT_LNK
# 225 "src/remove.c"
                                   ;
              else if (
# 226 "src/remove.c" 3 4
                      ((((
# 226 "src/remove.c"
                      sbuf->st_mode
# 226 "src/remove.c" 3 4
...
# 271 "src/remove.c"
        ...
        {
          if (cache_fstatat (fd_cwd, filename, sbuf, 
# 278 "src/remove.c" 3 4
                                                    0x100
# 278 "src/remove.c"
                                                                       ) != 0)
            {
              error (0, 
# 280 "src/remove.c" 3 4
                       (*__errno_location ())
# 280 "src/remove.c"
...
# 319 "src/remove.c"
  switch (errnum)
    {
    case 
# 321 "src/remove.c" 3 4
        84
# 321 "src/remove.c"
              :
    case 
# 322 "src/remove.c" 3 4
        22
# 322 "src/remove.c"
              :
    case 
# 323 "src/remove.c" 3 4
        2
# 323 "src/remove.c"
              :
    case 
# 324 "src/remove.c" 3 4
        20
# 324 "src/remove.c"
               :
      return 
# 325 "src/remove.c" 3 4
            1
# 325 "src/remove.c"
                ;
    default:
      return 
# 327 "src/remove.c" 3 4
            0
# 327 "src/remove.c"
                 ;
    }
...
# 366 "src/remove.c" 3 4
                                                          _Bool 
# 366 "src/remove.c"
                                                               is_dir)
{
  int flag = is_dir ? 
# 368 "src/remove.c" 3 4
                     0x200 
# 368 "src/remove.c"
                                  : 0;
...
# 404 "src/remove.c" 3 4
   (*__errno_location ()) 
# 404 "src/remove.c"
         = ent->fts_errno;
  error (0, 
# 405 "src/remove.c" 3 4
           (*__errno_location ())
# 405 "src/remove.c"
      ...
      if (ent->fts_level == 0)
        {
          ...
          if (dot_or_dotdot (last_component (ent->fts_accpath)))
            {
              error (0, 0, gettext ("cannot remove directory: %s"),
                     quote (ent->fts_path));
              fts_skip_tree (fts, ent);
              return RM_ERROR;
            }
      ...
      while (1)
        {
          ...
          ent = fts_read (fts);
          if (ent == 
# 558 "src/remove.c" 3 4
                    ((void *)0)
# 558 "src/remove.c"
                        )
            {
              if (
# 560 "src/remove.c" 3 4
                 (*__errno_location ()) 
# 560 "src/remove.c"
                       != 0)
                {
                  error (0, 
# 562 "src/remove.c" 3 4
                           (*__errno_location ())
# 562 "src/remove.c"
...
# 570 "src/remove.c"
         "VALID_STATUS (s)"
# 570 "src/remove.c" 3 4
         , "src/remove.c", 570, __extension__ __PRETTY_FUNCTION__); }))
# 570 "src/remove.c"
                                  ;
