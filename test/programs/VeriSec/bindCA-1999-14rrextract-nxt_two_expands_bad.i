# 1 "../versisec/bind/progs1/bindCA-1999-14rrextract-nxt_two_expands_bad.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../versisec/bind/progs1/bindCA-1999-14rrextract-nxt_two_expands_bad.c"
...
# 2 "../versisec/bind/progs1/bindCA-1999-14rrextract-nxt_two_expands_bad.c" 2
...
# 3 "../versisec/bind/progs1/bindCA-1999-14rrextract-nxt_two_expands_bad.c" 2
...
rrextract(u_char *msg, int msglen, u_char *rrp, u_char *dname, int namelen)
{
  ...
  ((dlen - n <= sizeof data - (strlen((char *)data) + 1)) ? (void) (0) : __assert_fail ("dlen - n <= sizeof data - (strlen((char *)data) + 1)", "../versisec/bind/progs1/bindCA-1999-14rrextract-nxt_two_expands_bad.c", 42, __PRETTY_FUNCTION__));
