...
void reach_error() { __assert_fail("0", "memsafety_invalid-read_not_influencing_reachsafety1.c", 3, "reach_error"); }
...
int main() {
  ...
  *(miniArray + 1) = b;
  ...
  // Unknown value returned, ReachSafety should be UNKNOWN due to invalid-deref!
  __VERIFIER_assert_w_assert(*(miniArray + 2) == b, miniArray);  
