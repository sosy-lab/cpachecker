...
int main() {
    ...
    // arr5_2 is the same pointer initially, but we increment and check equality and pointer arith
    for (int i = 0; i < 10; i++) {
        assert(*arr5_2 >= 0 + i + 11 && *arr5_2 <= 10 + i + 11);
        assert(!(*arr5_2 > 10 + i + 11 || *arr5_2 < 0 + i + 11));
        assert(*(arr + i) == *arr5_2);
