...
int main() {
  ...
  assert(longlong_array[0] == -9223372036854775807l);
  assert(longlong_array[1] == -2147483650l);
  assert(longlong_array[2] == 2147483649l);
  assert(longlong_array[3] == 9223372036854775807l);

  assert(ulonglong_array[0] == 0);
  assert(ulonglong_array[1] == 9223372036854775807lu);
  assert(ulonglong_array[2] == 9223372036854775808lu);
  assert(ulonglong_array[3] == 18446744073709551615lu);

  assert(longlong_array[0] == -9223372036854775807ll);
  assert(longlong_array[1] == -2147483650ll);
  assert(longlong_array[2] == 2147483649ll);
  ...
  assert(ulong_array[0] == 18446744073709551615lu);
