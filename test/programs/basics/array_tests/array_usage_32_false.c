...
int main() {
  ...
  if (long_array[0] != -2147483648l) {
    goto NO_ERROR;
  }
  if (long_array[1] != -32769) {
    goto NO_ERROR;
  }
  if (long_array[2] != 32768) {
    goto NO_ERROR;
  }
  if (long_array[3] != 2147483647l) {
    goto NO_ERROR;
  }
  ...
  if (ulong_array[1] != 2147483647) {
    goto NO_ERROR;
  }
  if (ulong_array[2] != 2147483649u) {
    goto NO_ERROR;
  }
  if (ulong_array[3] != 4294967295u) {
    goto NO_ERROR;
  }
  ...
  if (longlong_array[2] != 2147483649) {
    goto NO_ERROR;
  }
