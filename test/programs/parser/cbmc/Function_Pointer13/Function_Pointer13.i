...
u32 myfunc_2(u32 value2){
   ((value2==4) ? (void) (0) : __assert_fail ("value2==4", "Function_Pointer13/main.c", 15, __PRETTY_FUNCTION__));
   return value2*4;
}

int main(void){
myfuncptr fptr=((void *)0);
u32 value;


((fptr == ((void *)0)) ? (void) (0) : __assert_fail ("fptr == ((void *)0)", "Function_Pointer13/main.c", 24, __PRETTY_FUNCTION__));

fptr=myfunc_1;
value=2;
value=fptr(value);
((value == 4) ? (void) (0) : __assert_fail ("value == 4", "Function_Pointer13/main.c", 29, __PRETTY_FUNCTION__));

fptr=myfunc_2;
value=fptr(value);
((value == 16) ? (void) (0) : __assert_fail ("value == 16", "Function_Pointer13/main.c", 33, __PRETTY_FUNCTION__));
