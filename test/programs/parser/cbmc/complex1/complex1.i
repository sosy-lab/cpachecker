...
int main()
{
  ...
  ((__real__ c == 2) ? (void) (0) : __assert_fail ("__real__ c == 2", "complex1/main.c", 10, __PRETTY_FUNCTION__));
  ((__imag__ c == 1) ? (void) (0) : __assert_fail ("__imag__ c == 1", "complex1/main.c", 11, __PRETTY_FUNCTION__));

  _Complex double d;
  ((sizeof(c)==sizeof(d)) ? (void) (0) : __assert_fail ("sizeof(c)==sizeof(d)", "complex1/main.c", 14, __PRETTY_FUNCTION__));

  _Complex signed char char_complex, char_complex2;

  char_complex=0x3i-2;

  ((sizeof(d)==sizeof(c)) ? (void) (0) : __assert_fail ("sizeof(d)==sizeof(c)", "complex1/main.c", 20, __PRETTY_FUNCTION__));
  ((sizeof(char_complex)==sizeof(signed char)*2) ? (void) (0) : __assert_fail ("sizeof(char_complex)==sizeof(signed char)*2", "complex1/main.c", 21, __PRETTY_FUNCTION__));




  ((((signed char *)&char_complex)[0]==-2) ? (void) (0) : __assert_fail ("((signed char *)&char_complex)[0]==-2", "complex1/main.c", 26, __PRETTY_FUNCTION__));
  ((((signed char *)&char_complex)[1]==3) ? (void) (0) : __assert_fail ("((signed char *)&char_complex)[1]==3", "complex1/main.c", 27, __PRETTY_FUNCTION__));


  ((__real__ char_complex == -2) ? (void) (0) : __assert_fail ("__real__ char_complex == -2", "complex1/main.c", 30, __PRETTY_FUNCTION__));
  ((__imag__ char_complex == 3) ? (void) (0) : __assert_fail ("__imag__ char_complex == 3", "complex1/main.c", 31, __PRETTY_FUNCTION__));
  ...
  ((__real__ char_complex == 100) ? (void) (0) : __assert_fail ("__real__ char_complex == 100", "complex1/main.c", 38, __PRETTY_FUNCTION__));
  ((__imag__ char_complex == 3) ? (void) (0) : __assert_fail ("__imag__ char_complex == 3", "complex1/main.c", 39, __PRETTY_FUNCTION__));


  char_complex++;
  ((__real__ char_complex == 101) ? (void) (0) : __assert_fail ("__real__ char_complex == 101", "complex1/main.c", 43, __PRETTY_FUNCTION__));
  ((__imag__ char_complex == 3) ? (void) (0) : __assert_fail ("__imag__ char_complex == 3", "complex1/main.c", 44, __PRETTY_FUNCTION__));


  (__real__ char_complex)++;
  ((__real__ char_complex == 102) ? (void) (0) : __assert_fail ("__real__ char_complex == 102", "complex1/main.c", 48, __PRETTY_FUNCTION__));
  ((__imag__ char_complex == 3) ? (void) (0) : __assert_fail ("__imag__ char_complex == 3", "complex1/main.c", 49, __PRETTY_FUNCTION__));


  (((int) char_complex == 102) ? (void) (0) : __assert_fail ("(int) char_complex == 102", "complex1/main.c", 52, __PRETTY_FUNCTION__));
