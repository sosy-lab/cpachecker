...
// This program tests some easy function pointer games with concrete values to establish correct usage of function pointers.
// It is unsafe for ReachSafety/MemSafety/MemCleanup in ILP32 and LP64.
int main() {
  int oneIsTrue = 0;
  int * dummyPtr = malloc(sizeof(int)); // Only used to make MemSafety/MemCleanup false

  int (*functionNoPtr)(int,int);
  functionNoPtr = foo;
  int sum = functionNoPtr(1, 3);
  // printf("%d\n", sum); // left for debugging
  oneIsTrue = oneIsTrue || (sum != 4);

  sum = bar(functionNoPtr);
  // printf("%d\n", sum); // left for debugging
  oneIsTrue = oneIsTrue || (sum != 88890);

  sum = barBar(functionNoPtr, 2, 5);
  // printf("%d\n", sum); // left for debugging
  oneIsTrue = oneIsTrue || (sum != 7);

  int (*functionPtr)(int,int);
  functionPtr = &foo;
  sum = functionPtr(3, 7);
  // printf("%d\n", sum); // left for debugging
  oneIsTrue = oneIsTrue || (sum != 10);

  sum = bar(functionPtr);
  // printf("%d\n", sum); // left for debugging
  oneIsTrue = oneIsTrue || (sum != 88892);

  sum = barBar(functionPtr, 4, 9);
  // printf("%d\n", sum); // left for debugging
  oneIsTrue = oneIsTrue || (sum != 13);

  sum = (*functionPtr)(5, 11);
  // printf("%d\n", sum); // left for debugging
  oneIsTrue = oneIsTrue || (sum != 16);

  functionPtr = functionFunction();
  sum = (*functionPtr)(6, 13);
  // printf("%d\n", sum); // left for debugging
  oneIsTrue = oneIsTrue || (sum != 19);

  sum = bar(functionPtr);
  // printf("%d\n", sum); // left for debugging
  oneIsTrue = oneIsTrue || (sum != 88894);

  sum = barBar(functionPtr, 7, 15);
  // printf("%d\n", sum); // left for debugging
  oneIsTrue = oneIsTrue || (sum != 22);

  FuncDefFoo funcDefFoo = functionFunction();
  sum = (*funcDefFoo)(8, 17);
  // printf("%d\n", sum); // left for debugging
  oneIsTrue = oneIsTrue || (sum != 25);

  sum = (funcDefFoo)(9, 19);
  // printf("%d\n", sum); // left for debugging
  oneIsTrue = oneIsTrue || (sum != 28);

  sum = bar(funcDefFoo);
  // printf("%d\n", sum); // left for debugging
  oneIsTrue = oneIsTrue || (sum != 88896);

  sum = barBar(funcDefFoo, 10, 21);
  // printf("%d\n", sum); // left for debugging
  oneIsTrue = oneIsTrue || (sum != 31);
  ...
  // printf("%d\n", sum); // left for debugging
  oneIsTrue = oneIsTrue || (sum != 3309);

  sum = (*funArray[1]) (1110, 2211);
  // printf("%d\n", sum); // left for debugging
  oneIsTrue = oneIsTrue || (sum != 3321);

  sum = (*funArray[2]) (1111, 2222);
  // printf("%d\n", sum); // left for debugging
  oneIsTrue = oneIsTrue || (sum != 3333);
