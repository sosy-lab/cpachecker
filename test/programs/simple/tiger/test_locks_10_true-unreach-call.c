...
int main()
{
    int p1 = input();  // condition variable
    int lk1; // lock variable

    int p2 = input();  // condition variable
    int lk2; // lock variable

    int p3 = input();  // condition variable
    int lk3; // lock variable

    int p4 = input();  // condition variable
    int lk4; // lock variable

    int p5 = input();  // condition variable
    int lk5; // lock variable

    int p6 = input();  // condition variable
    int lk6; // lock variable

    int p7 = input();  // condition variable
    int lk7; // lock variable

    int p8 = input();  // condition variable
    int lk8; // lock variable

    int p9 = input();  // condition variable
    int lk9; // lock variable

    int p10 = input();  // condition variable
