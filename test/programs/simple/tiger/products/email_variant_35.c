...
void
outgoing__wrappee__Keys (int client, int msg)
{
  setEmailFrom(msg, getClientId(client));
  mail(client, msg);
}
void
outgoing__wrappee__AutoResponder (int client, int msg)
{
...
void
outgoing__wrappee__AddressBook (int client, int msg)
{
...
void
incoming__wrappee__Encrypt (int client, int msg)
{
  deliver (client, msg);
}
...
void
incoming__wrappee__Sign (int client, int msg)
{
...
void
incoming__wrappee__Forward (int client, int msg)
{
...
void
incoming__wrappee__Verify (int client, int msg)
{
  verify (client, msg);
...
void
printMail__wrappee__Keys (int msg)
{
...
void
printMail__wrappee__AddressBook (int msg)
{
...
void
printMail__wrappee__Forward (int msg)
{
...
int
isReadable__wrappee__Keys (int msg)
{
  return 1;
}
