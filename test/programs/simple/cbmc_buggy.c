...
skip = 0;
*tmp___0 = 0;
if(! ((unsigned long )s->info_callback != (unsigned long )((void *)0))) { return (0); }
cb = s->info_callback;
s->in_handshake += 1;
if(! (tmp___1 & 12288)) { return (0); }
if(! (tmp___2 & 16384)) { return (0); }

state = s->state;
if(! (s->state == 12292)) { return (0); }
...
s->server = 0;
if(! ((unsigned long )cb != (unsigned long )((void *)0))) { return (0); }

if(! (!((s->version & 65280) != 768))) { return (0); }

s->type = 4096;
if(! ((unsigned long )s->init_buf == (unsigned long )((void *)0))) { return (0); }
buf = nondet_int();
if(! (!((unsigned long )buf == (unsigned long )((void *)0)))) { return (0); }
...
if(! (!(! (s->s3)->tmp.reuse_message))) { return (0); }
...
state = s->state;
if(! (!(s->state == 12292))) { return (0); }
if(! (!(s->state == 16384))) { return (0); }
if(! (!(s->state == 4096))) { return (0); }
if(! (!(s->state == 20480))) { return (0); }
if(! (!(s->state == 4099))) { return (0); }
if(! (s->state == 4368)) { return (0); }


s->shutdown = 0;
ret = nondet_int();
if(! (blastFlag == 0)) { return (0); }
blastFlag = 1;
...
s->state = 4384;
s->init_num = 0;
if(! ((unsigned long )s->bbio != (unsigned long )s->wbio)) { return (0); }
...
if(! (!(s->state == 4099))) { return (0); }
if(! (!(s->state == 4368))) { return (0); }
if(! (!(s->state == 4369))) { return (0); }
if(! (s->state == 4384)) { return (0); }


ret = nondet_int();
if(! (blastFlag == 1)) { return (0); }
blastFlag = 2;
...
if(! (!(s->state == 4369))) { return (0); }
if(! (!(s->state == 4384))) { return (0); }
if(! (!(s->state == 4385))) { return (0); }
if(! (!(s->state == 4400))) { return (0); }
if(! (!(s->state == 4401))) { return (0); }
if(! (!(s->state == 4416))) { return (0); }
if(! (!(s->state == 4417))) { return (0); }
if(! (!(s->state == 4432))) { return (0); }
if(! (!(s->state == 4433))) { return (0); }
if(! (!(s->state == 4448))) { return (0); }
if(! (!(s->state == 4449))) { return (0); }
if(! (!(s->state == 4464))) { return (0); }
if(! (!(s->state == 4465))) { return (0); }
if(! (!(s->state == 4466))) { return (0); }
if(! (!(s->state == 4467))) { return (0); }
if(! (!(s->state == 4480))) { return (0); }
if(! (!(s->state == 4481))) { return (0); }
if(! (!(s->state == 4496))) { return (0); }
if(! (!(s->state == 4497))) { return (0); }
if(! (!(s->state == 4512))) { return (0); }
if(! (!(s->state == 4513))) { return (0); }
if(! (!(s->state == 4528))) { return (0); }
if(! (!(s->state == 4529))) { return (0); }
if(! (s->state == 4560)) { return (0); }
...
if(! ((unsigned long )(s->s3)->tmp.new_compression == (unsigned long )((void *)0))) { return (0); }
...
if(! (!(s->state == 4529))) { return (0); }
if(! (!(s->state == 4560))) { return (0); }
if(! (!(s->state == 4561))) { return (0); }
if(! (s->state == 4352)) { return (0); }
...
if(! (!(((s->s3)->tmp.new_cipher)->algorithms & 256UL))) { return (0); }
ret = nondet_int();
if(! (blastFlag == 2)) { return (0); }
blastFlag = 3;
...
if(! ((s->s3)->tmp.cert_req == 1)) { return (0); }
s->state = 4496;
