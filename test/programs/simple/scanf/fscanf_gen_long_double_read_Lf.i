...
# 0 "fscanf_gen_long_double_read_Lf.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "fscanf_gen_long_double_read_Lf.c"
...
# 9 "fscanf_gen_long_double_read_Lf.c" 2


# 10 "fscanf_gen_long_double_read_Lf.c"
...
fscanf(
# 16 "fscanf_gen_long_double_read_Lf.c" 3 4
      stdin
# 16 "fscanf_gen_long_double_read_Lf.c"
           ,"%Lf", &i);
