# 0 "fscanf_manual_int_int_compare.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 0 "<command-line>" 2
# 1 "fscanf_manual_int_int_compare.c"
...
# 9 "fscanf_manual_int_int_compare.c" 2


# 10 "fscanf_manual_int_int_compare.c"
extern void __assert_fail(const char *, const char *, unsigned int, const char *) __attribute__((__nothrow__, __leaf__)) __attribute__((__noreturn__));
void reach_error() { __assert_fail("0", "fscanf_manual_int_int_compare.c", 3, "reach_error"); }
...
int main()
{
    ...
    fscanf(
# 18 "fscanf_manual_int_int_compare.c" 3 4
          stdin
# 18 "fscanf_manual_int_int_compare.c"
               , "%i", &i);
    fscanf(
# 19 "fscanf_manual_int_int_compare.c" 3 4
          stdin
# 19 "fscanf_manual_int_int_compare.c"
               , "%d", &j);
