...
# 0 "fscanf_gen_unsigned_char_read_hhx.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "fscanf_gen_unsigned_char_read_hhx.c"
...
# 9 "fscanf_gen_unsigned_char_read_hhx.c" 2


# 10 "fscanf_gen_unsigned_char_read_hhx.c"
...
fscanf(
# 16 "fscanf_gen_unsigned_char_read_hhx.c" 3 4
      stdin
# 16 "fscanf_gen_unsigned_char_read_hhx.c"
           ,"%hhx", &i);
