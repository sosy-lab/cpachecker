...
int main(void) {
  ...
  if ((9223372036854775807L << 0) != (9223372036854775807L)) {  /* maximum is valid only with count 0 here */
    goto ERROR;
  }
  if ((0L << 1) != (0L)) {
    goto ERROR;
  ...
  if ((9223372036854775806L << 0) != (9223372036854775806L)) {
    goto ERROR;
  }
  if ((0L << 32) != (0L)) {  /* half width */
    goto ERROR;
  }
  if ((1L << 32) != (4294967296L)) {  /* half width */
    goto ERROR;
  }
  if ((1L << 62) != (4611686018427387904L)) {  /* largest safe power-of-two result */
    goto ERROR;
  }
  if ((0L << 63) != (0L)) {  /* largest valid count; nonzero shift into sign bit would be undefined */
    goto ERROR;
  }
  ...
  if ((18446744073709551615UL << 0) != (18446744073709551615UL)) {  /* maximum; nonzero shift would wrap */
    goto ERROR;
  }
  if ((1UL << 1) != (2UL)) {
    goto ERROR;
  }
  if ((18446744073709551615UL << 0) != (18446744073709551615UL)) {  /* negative one converted to unsigned */
    goto ERROR;
  }
  if ((18446744073709551614UL << 0) != (18446744073709551614UL)) {  /* maximum minus one */
    goto ERROR;
  }
  if ((18446744073709551615UL << 0) != (18446744073709551615UL)) {  /* minimum minus one converted to unsigned */
    goto ERROR;
  }
  if ((0UL << 32) != (0UL)) {  /* half width */
    goto ERROR;
  }
  if ((1UL << 32) != (4294967296UL)) {  /* half width */
    goto ERROR;
  }
  if ((0UL << 63) != (0UL)) {  /* largest valid count */
    goto ERROR;
  }
  if ((1UL << 63) != (9223372036854775808UL)) {  /* top bit, still representable as unsigned */
    goto ERROR;
  }
