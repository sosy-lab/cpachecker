...
int main(void) {
  ...
  if ((0xF0F0F0F0F0F0F0F0UL >> 4) != 0x0F0F0F0F0F0F0F0FUL) {  /* 64-bit unsigned long right shift */
    goto ERROR;
  }
  if ((0x00000000FFFFFFFFUL << 32) != 0xFFFFFFFF00000000UL) {  /* 64-bit unsigned long left shift without lost bits */
    goto ERROR;
  }
