...
int main(void) {
  ...
  if (((-9223372036854775807L - 1L) >> 1) != (-4611686018427387904L)) {  /* minimum, shift by 1; implementation-defined arithmetic right shift */
    goto ERROR;
  }
  if (((-9223372036854775807L - 1L) >> 32) != ((-2147483647L - 1L))) {  /* minimum, shift by 32; implementation-defined arithmetic right shift */
    goto ERROR;
  }
  if (((-9223372036854775807L - 1L) >> 63) != (-1L)) {  /* minimum, shift by 63; implementation-defined arithmetic right shift */
    goto ERROR;
  }
  if ((9223372036854775807L >> 1) != (4611686018427387903L)) {  /* maximum, shift by 1 */
    goto ERROR;
  }
  if ((9223372036854775807L >> 32) != (2147483647L)) {  /* maximum, shift by 32 */
    goto ERROR;
  }
  if ((9223372036854775807L >> 63) != (0L)) {  /* maximum, shift by 63 */
    goto ERROR;
  }
  if ((0L >> 1) != (0L)) {  /* zero, shift by 1 */
    goto ERROR;
  }
  if ((0L >> 32) != (0L)) {  /* zero, shift by 32 */
    goto ERROR;
  }
  if ((0L >> 63) != (0L)) {  /* zero, shift by 63 */
    goto ERROR;
  }
  if ((1L >> 1) != (0L)) {  /* one, shift by 1 */
    goto ERROR;
  }
  if ((1L >> 32) != (0L)) {  /* one, shift by 32 */
    goto ERROR;
  }
  if ((1L >> 63) != (0L)) {  /* one, shift by 63 */
    goto ERROR;
  }
  if ((-1L >> 1) != (-1L)) {  /* negative one, shift by 1; implementation-defined arithmetic right shift */
    goto ERROR;
  }
  if ((-1L >> 32) != (-1L)) {  /* negative one, shift by 32; implementation-defined arithmetic right shift */
    goto ERROR;
  }
  if ((-1L >> 63) != (-1L)) {  /* negative one, shift by 63; implementation-defined arithmetic right shift */
    goto ERROR;
  }
  if ((9223372036854775806L >> 1) != (4611686018427387903L)) {  /* maximum minus one, shift by 1 */
    goto ERROR;
  }
  if ((9223372036854775806L >> 32) != (2147483647L)) {  /* maximum minus one, shift by 32 */
    goto ERROR;
  }
  if ((9223372036854775806L >> 63) != (0L)) {  /* maximum minus one, shift by 63 */
    goto ERROR;
  }
  ...
  if ((0UL >> 32) != (0UL)) {  /* minimum, shift by 32 */
    goto ERROR;
  }
  if ((0UL >> 63) != (0UL)) {  /* minimum, shift by 63 */
    goto ERROR;
  }
  if ((18446744073709551615UL >> 1) != (9223372036854775807UL)) {  /* maximum, shift by 1 */
    goto ERROR;
  }
  if ((18446744073709551615UL >> 32) != (4294967295UL)) {  /* maximum, shift by 32 */
    goto ERROR;
  }
  if ((18446744073709551615UL >> 63) != (1UL)) {  /* maximum, shift by 63 */
    goto ERROR;
  }
  if ((0UL >> 1) != (0UL)) {  /* zero, shift by 1 */
    goto ERROR;
  }
  if ((0UL >> 32) != (0UL)) {  /* zero, shift by 32 */
    goto ERROR;
  }
  if ((0UL >> 63) != (0UL)) {  /* zero, shift by 63 */
    goto ERROR;
  }
  if ((1UL >> 1) != (0UL)) {  /* one, shift by 1 */
    goto ERROR;
  }
  if ((1UL >> 32) != (0UL)) {  /* one, shift by 32 */
    goto ERROR;
  }
  if ((1UL >> 63) != (0UL)) {  /* one, shift by 63 */
    goto ERROR;
  }
  if ((18446744073709551615UL >> 1) != (9223372036854775807UL)) {  /* negative one converted to unsigned, shift by 1 */
    goto ERROR;
  }
  if ((18446744073709551615UL >> 32) != (4294967295UL)) {  /* negative one converted to unsigned, shift by 32 */
    goto ERROR;
  }
  if ((18446744073709551615UL >> 63) != (1UL)) {  /* negative one converted to unsigned, shift by 63 */
    goto ERROR;
  }
  if ((18446744073709551614UL >> 1) != (9223372036854775807UL)) {  /* maximum minus one, shift by 1 */
    goto ERROR;
  }
  if ((18446744073709551614UL >> 32) != (4294967295UL)) {  /* maximum minus one, shift by 32 */
    goto ERROR;
  }
  if ((18446744073709551614UL >> 63) != (1UL)) {  /* maximum minus one, shift by 63 */
    goto ERROR;
  }
  if ((18446744073709551615UL >> 1) != (9223372036854775807UL)) {  /* minimum minus one converted to unsigned, shift by 1 */
    goto ERROR;
  }
  if ((18446744073709551615UL >> 32) != (4294967295UL)) {  /* minimum minus one converted to unsigned, shift by 32 */
    goto ERROR;
  }
  if ((18446744073709551615UL >> 63) != (1UL)) {  /* minimum minus one converted to unsigned, shift by 63 */
    goto ERROR;
  }
