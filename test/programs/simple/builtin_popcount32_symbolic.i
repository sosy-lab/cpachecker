...
void test_popcount() {
  ...
  ((intRes1 || intRes2 || intRes3 || intRes4) ? (void) (0) : __assert_fail ("intRes1 || intRes2 || intRes3 || intRes4", "builtin_popcount32_symbolic.c", 37, __extension__ __PRETTY_FUNCTION__));
  ...
  ((uintRes1 || uintRes2 || uintRes3 || uintRes4) ? (void) (0) : __assert_fail ("uintRes1 || uintRes2 || uintRes3 || uintRes4", "builtin_popcount32_symbolic.c", 49, __extension__ __PRETTY_FUNCTION__));
  int nondet_intMax = __VERIFIER_nondet_int();
  if (!(nondet_intMax > 2147483646)) {
    return;
  }
  ((__builtin_popcount(nondet_intMax) == 31) ? (void) (0) : __assert_fail ("__builtin_popcount(nondet_intMax) == 31", "builtin_popcount32_symbolic.c", 55, __extension__ __PRETTY_FUNCTION__));
  int nondet_intMin = __VERIFIER_nondet_int();
  if (!(nondet_intMin < -2147483647)) {
    return;
  }
  ((__builtin_popcount(nondet_intMin) == 1) ? (void) (0) : __assert_fail ("__builtin_popcount(nondet_intMin) == 1", "builtin_popcount32_symbolic.c", 61, __extension__ __PRETTY_FUNCTION__));
  ...
  ((count_intAtLeastMinPlusOne == 2) ? (void) (0) : __assert_fail ("count_intAtLeastMinPlusOne == 2", "builtin_popcount32_symbolic.c", 71, __extension__ __PRETTY_FUNCTION__));
  int nondet_uintMax = __VERIFIER_nondet_uint();
  if (!(nondet_uintMax > 4294967294)) {
    return;
  }
  ((__builtin_popcount(nondet_uintMax) == 32) ? (void) (0) : __assert_fail ("__builtin_popcount(nondet_uintMax) == 32", "builtin_popcount32_symbolic.c", 77, __extension__ __PRETTY_FUNCTION__));
  ...
  ((count_uintAtLeastMaxMinusOne == 31 || count_uintAtLeastMaxMinusOne == 32) ? (void) (0) : __assert_fail ("count_uintAtLeastMaxMinusOne == 31 || count_uintAtLeastMaxMinusOne == 32", "builtin_popcount32_symbolic.c", 84, __extension__ __PRETTY_FUNCTION__));
}
void test_popcountl() {
  ...
  ((longRes1 || longRes2 || longRes3 || longRes4 || longRes5) ? (void) (0) : __assert_fail ("longRes1 || longRes2 || longRes3 || longRes4 || longRes5", "builtin_popcount32_symbolic.c", 105, __extension__ __PRETTY_FUNCTION__));
  ...
  ((ulongRes1 || ulongRes2 || ulongRes3 || ulongRes4 || ulongRes5) ? (void) (0) : __assert_fail ("ulongRes1 || ulongRes2 || ulongRes3 || ulongRes4 || ulongRes5", "builtin_popcount32_symbolic.c", 118, __extension__ __PRETTY_FUNCTION__));
  long nondet_longMax = __VERIFIER_nondet_long();
  if (!(nondet_longMax > 2147483646L)) {
    return;
  }
  ((__builtin_popcountl(nondet_longMax) == 31) ? (void) (0) : __assert_fail ("__builtin_popcountl(nondet_longMax) == 31", "builtin_popcount32_symbolic.c", 124, __extension__ __PRETTY_FUNCTION__));
  long nondet_longMin = __VERIFIER_nondet_long();
  if (!(nondet_longMin < -2147483647L)) {
    return;
  }
  ((__builtin_popcountl(nondet_longMin) == 1) ? (void) (0) : __assert_fail ("__builtin_popcountl(nondet_longMin) == 1", "builtin_popcount32_symbolic.c", 130, __extension__ __PRETTY_FUNCTION__));
  ...
  ((count_longAtLeastMinPlusOne == 2) ? (void) (0) : __assert_fail ("count_longAtLeastMinPlusOne == 2", "builtin_popcount32_symbolic.c", 140, __extension__ __PRETTY_FUNCTION__));
  unsigned long nondet_ulongMax = __VERIFIER_nondet_ulong();
  if (!(nondet_ulongMax > 4294967294UL)) {
    return;
  }
  ((__builtin_popcountl(nondet_ulongMax) == 32) ? (void) (0) : __assert_fail ("__builtin_popcountl(nondet_ulongMax) == 32", "builtin_popcount32_symbolic.c", 146, __extension__ __PRETTY_FUNCTION__));
  ...
  ((count_ulongAtLeastMaxMinusOne == 31 || count_ulongAtLeastMaxMinusOne == 32) ? (void) (0) : __assert_fail ("count_ulongAtLeastMaxMinusOne == 31 || count_ulongAtLeastMaxMinusOne == 32", "builtin_popcount32_symbolic.c", 153, __extension__ __PRETTY_FUNCTION__));
}
void test_popcountll() {
  ...
  ((longRes1 || longRes2 || longRes3 || longRes4 || longRes5 || longRes6) ? (void) (0) : __assert_fail ("longRes1 || longRes2 || longRes3 || longRes4 || longRes5 || longRes6", "builtin_popcount32_symbolic.c", 177, __extension__ __PRETTY_FUNCTION__));
  ...
  ((ulongRes1 || ulongRes2 || ulongRes3 || ulongRes4 || ulongRes5) ? (void) (0) : __assert_fail ("ulongRes1 || ulongRes2 || ulongRes3 || ulongRes4 || ulongRes5", "builtin_popcount32_symbolic.c", 190, __extension__ __PRETTY_FUNCTION__));
  long long nondet_llMax = __VERIFIER_nondet_longlong();
  if (!(nondet_llMax > 9223372036854775806LL)) {
    return;
  }
  ((__builtin_popcountll(nondet_llMax) == 63) ? (void) (0) : __assert_fail ("__builtin_popcountll(nondet_llMax) == 63", "builtin_popcount32_symbolic.c", 196, __extension__ __PRETTY_FUNCTION__));
  long long nondet_llMin = __VERIFIER_nondet_longlong();
  if (!(nondet_llMin < -9223372036854775807LL)) {
    return;
  }
  ((__builtin_popcountll(nondet_llMin) == 1) ? (void) (0) : __assert_fail ("__builtin_popcountll(nondet_llMin) == 1", "builtin_popcount32_symbolic.c", 202, __extension__ __PRETTY_FUNCTION__));
  ...
  ((count_llAtLeastMinPlusOne == 2) ? (void) (0) : __assert_fail ("count_llAtLeastMinPlusOne == 2", "builtin_popcount32_symbolic.c", 212, __extension__ __PRETTY_FUNCTION__));
  long long nondet_llMin2 = __VERIFIER_nondet_ulonglong();
  if (!(nondet_llMin2 < 0 && nondet_llMin2 >= -2LL)) {
    return;
  }
  ((__builtin_popcountll(nondet_llMin2) == 64 || __builtin_popcountll(nondet_llMin2) == 63) ? (void) (0) : __assert_fail ("__builtin_popcountll(nondet_llMin2) == 64 || __builtin_popcountll(nondet_llMin2) == 63", "builtin_popcount32_symbolic.c", 218, __extension__ __PRETTY_FUNCTION__));
  unsigned long long nondet_ullMax = __VERIFIER_nondet_ulonglong();
  if (!(nondet_ullMax > 18446744073709551614ULL)) {
    return;
  }
  ((__builtin_popcountll(nondet_ullMax) == 64) ? (void) (0) : __assert_fail ("__builtin_popcountll(nondet_ullMax) == 64", "builtin_popcount32_symbolic.c", 224, __extension__ __PRETTY_FUNCTION__));
  ...
  ((count_ullAtLeastMaxMinusOne == 63 || count_ullAtLeastMaxMinusOne == 64) ? (void) (0) : __assert_fail ("count_ullAtLeastMaxMinusOne == 63 || count_ullAtLeastMaxMinusOne == 64", "builtin_popcount32_symbolic.c", 231, __extension__ __PRETTY_FUNCTION__));
}
int main() {
  test_popcount();
  test_popcountl();
