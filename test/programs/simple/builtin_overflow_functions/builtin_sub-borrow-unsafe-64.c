...
int main(void) {
  ...
  const unsigned long long int model_subcl_expected_res = 18446744069414584320ULL;
  unsigned long int model_subcl_bout;
  unsigned long int model_subcl_res = __builtin_subcl(0UL, 1UL, 4294967295UL, &model_subcl_bout);
  all_expected_checks_fail =
    all_expected_checks_fail || ((unsigned long long int)model_subcl_res != model_subcl_expected_res);
