...
int main(void) {
  ...
  __VERIFIER_assert((sizeof(long int) == sizeof(int) && (int)sub_overflow_long_max == int_max) ||
  ...
  __VERIFIER_assert((sizeof(long int) == sizeof(int) && (int)sub_overflow_long_min == int_min) ||
         (sizeof(long int) == sizeof(long long int) &&
  ...
  __VERIFIER_assert(sub_overflow_result_1 == signed_char_max);

  // __builtin_sub_overflow(-128, 1, &sub_overflow_result_1) returns 1.
  __VERIFIER_assert(sub_overflow_overflow_1 == 1);
  ...
  __VERIFIER_assert(sub_overflow_result_2 == unsigned_char_max);

  // __builtin_sub_overflow(0, 1, &sub_overflow_result_2) returns 1.
  __VERIFIER_assert(sub_overflow_overflow_2 == 1);
  ...
  __VERIFIER_assert(sub_overflow_result_3 == short_min);

  // __builtin_sub_overflow(32767, -1, &sub_overflow_result_3) returns 1.
  __VERIFIER_assert(sub_overflow_overflow_3 == 1);
  ...
  __VERIFIER_assert(sub_overflow_result_4 == 0U);

  // __builtin_sub_overflow(65535U, 65535U, &sub_overflow_result_4) returns 0.
  __VERIFIER_assert(sub_overflow_overflow_4 == 0);
  ...
  __VERIFIER_assert(sub_overflow_result_5 == int_max);

  // __builtin_sub_overflow((-2147483647 - 1), 1, &sub_overflow_result_5) returns 1.
  __VERIFIER_assert(sub_overflow_overflow_5 == 1);
  ...
  __VERIFIER_assert(sub_overflow_result_6 == 1U);

  // __builtin_sub_overflow(0U, 4294967295U, &sub_overflow_result_6) returns 1.
  __VERIFIER_assert(sub_overflow_overflow_6 == 1);
  ...
  __VERIFIER_assert(sub_overflow_result_7 == sub_overflow_long_min);
  ...
  __VERIFIER_assert(sub_overflow_overflow_7 == 1);
  ...
  __VERIFIER_assert(sub_overflow_result_8 == sub_overflow_unsigned_long_max);

  // __builtin_sub_overflow(0UL, 1UL, &sub_overflow_result_8) returns 1.
  __VERIFIER_assert(sub_overflow_overflow_8 == 1);
  ...
  __VERIFIER_assert(sub_overflow_result_9 == long_long_min);

  // __builtin_sub_overflow(0LL, -9223372036854775808LL, &sub_overflow_result_9) returns 1.
  __VERIFIER_assert(sub_overflow_overflow_9 == 1);
  ...
  __VERIFIER_assert(sub_overflow_result_11 == char_max);
  ...
  __VERIFIER_assert(sub_overflow_overflow_11 == 1);
  ...
  __VERIFIER_assert(sub_overflow_result_12 == 0);

  // __builtin_sub_overflow(1ULL, 1LL, &sub_overflow_result_12) returns 0.
  __VERIFIER_assert(sub_overflow_overflow_12 == 0);
  ...
  __VERIFIER_assert(sub_overflow_result_13 == unsigned_int_max);

  // __builtin_sub_overflow(-1LL, 0ULL, &sub_overflow_result_13) returns 1.
  __VERIFIER_assert(sub_overflow_overflow_13 == 1);
  ...
  __VERIFIER_assert(ssub_overflow_result_1 == 0);

  // __builtin_ssub_overflow(0, 0, &ssub_overflow_result_1) returns 0.
  __VERIFIER_assert(ssub_overflow_overflow_1 == 0);
  ...
  __VERIFIER_assert(ssub_overflow_result_2 == int_max);

  // __builtin_ssub_overflow(2147483647, 0, &ssub_overflow_result_2) returns 0.
  __VERIFIER_assert(ssub_overflow_overflow_2 == 0);
  ...
  __VERIFIER_assert(ssub_overflow_result_3 == int_min);

  // __builtin_ssub_overflow((-2147483647 - 1), 0, &ssub_overflow_result_3) returns 0.
  __VERIFIER_assert(ssub_overflow_overflow_3 == 0);
  ...
  __VERIFIER_assert(ssub_overflow_result_4 == -int_max);

  // __builtin_ssub_overflow((-2147483647 - 1), -1, &ssub_overflow_result_4) returns 0.
  __VERIFIER_assert(ssub_overflow_overflow_4 == 0);
  ...
  __VERIFIER_assert(ssub_overflow_result_5 == 2147483646);

  // __builtin_ssub_overflow(2147483647, 1, &ssub_overflow_result_5) returns 0.
  __VERIFIER_assert(ssub_overflow_overflow_5 == 0);
  ...
  __VERIFIER_assert(ssub_overflow_result_6 == int_min);

  // __builtin_ssub_overflow(2147483647, -1, &ssub_overflow_result_6) returns 1.
  __VERIFIER_assert(ssub_overflow_overflow_6 == 1);
  ...
  __VERIFIER_assert(ssub_overflow_result_7 == int_max);

  // __builtin_ssub_overflow((-2147483647 - 1), 1, &ssub_overflow_result_7) returns 1.
  __VERIFIER_assert(ssub_overflow_overflow_7 == 1);
  ...
  __VERIFIER_assert(ssub_overflow_result_8 == int_min);

  // __builtin_ssub_overflow(0, (-2147483647 - 1), &ssub_overflow_result_8) returns 1.
  __VERIFIER_assert(ssub_overflow_overflow_8 == 1);
  ...
  // ILP32: The calculated long maximum must equal int maximum 2147483647.
  // LP64: The calculated long maximum must equal long long maximum 9223372036854775807LL.
  __VERIFIER_assert((sizeof(long int) == sizeof(int) && (int)ssubl_overflow_long_max == int_max) ||
         (sizeof(long int) == sizeof(long long int) &&
  ...
  // ILP32: The calculated long minimum must equal int minimum -2147483648.
  // LP64: The calculated long minimum must equal long long minimum -9223372036854775808.
  __VERIFIER_assert((sizeof(long int) == sizeof(int) && (int)ssubl_overflow_long_min == int_min) ||
         (sizeof(long int) == sizeof(long long int) &&
  ...
  __VERIFIER_assert(ssubl_overflow_result_1 == 0L);

  // __builtin_ssubl_overflow(0L, 0L, &ssubl_overflow_result_1) returns 0.
  __VERIFIER_assert(ssubl_overflow_overflow_1 == 0);
  ...
  __VERIFIER_assert(ssubl_overflow_result_2 == ssubl_overflow_long_max);
  ...
  __VERIFIER_assert(ssubl_overflow_overflow_2 == 0);
  ...
  __VERIFIER_assert(ssubl_overflow_result_3 == ssubl_overflow_long_min);
  ...
  __VERIFIER_assert(ssubl_overflow_overflow_3 == 0);
  ...
  __VERIFIER_assert(ssubl_overflow_result_4 == ((-((long int)((~0UL) >> 1)) - 1L)) + 1L);
  ...
  __VERIFIER_assert(ssubl_overflow_overflow_4 == 0);
  ...
  __VERIFIER_assert(ssubl_overflow_result_5 == ((long int)((~0UL) >> 1)) - 1L);
  ...
  __VERIFIER_assert(ssubl_overflow_overflow_5 == 0);
  ...
  __VERIFIER_assert(ssubl_overflow_result_6 == ssubl_overflow_long_min);
  ...
  __VERIFIER_assert(ssubl_overflow_overflow_6 == 1);
  ...
  __VERIFIER_assert(ssubl_overflow_result_7 == ssubl_overflow_long_max);
  ...
  __VERIFIER_assert(ssubl_overflow_overflow_7 == 1);
  ...
  __VERIFIER_assert(ssubl_overflow_result_8 == ssubl_overflow_long_min);
  ...
  __VERIFIER_assert(ssubl_overflow_overflow_8 == 1);
  ...
  __VERIFIER_assert(ssubll_overflow_result_1 == 0LL);

  // __builtin_ssubll_overflow(0LL, 0LL, &ssubll_overflow_result_1) returns 0.
  __VERIFIER_assert(ssubll_overflow_overflow_1 == 0);
  ...
  __VERIFIER_assert(ssubll_overflow_result_2 == long_long_max);

  // __builtin_ssubll_overflow(9223372036854775807LL, 0LL, &ssubll_overflow_result_2) returns 0.
  __VERIFIER_assert(ssubll_overflow_overflow_2 == 0);
  ...
  __VERIFIER_assert(ssubll_overflow_result_3 == long_long_min);

  // __builtin_ssubll_overflow(-9223372036854775808LL, 0LL, &ssubll_overflow_result_3) returns 0.
  __VERIFIER_assert(ssubll_overflow_overflow_3 == 0);
  ...
  __VERIFIER_assert(ssubll_overflow_result_4 == -long_long_max);

  // __builtin_ssubll_overflow(-9223372036854775808LL, -1LL, &ssubll_overflow_result_4) returns 0.
  __VERIFIER_assert(ssubll_overflow_overflow_4 == 0);
  ...
  __VERIFIER_assert(ssubll_overflow_result_5 == 9223372036854775806LL);

  // __builtin_ssubll_overflow(9223372036854775807LL, 1LL, &ssubll_overflow_result_5) returns 0.
  __VERIFIER_assert(ssubll_overflow_overflow_5 == 0);
  ...
  __VERIFIER_assert(ssubll_overflow_result_6 == long_long_min);

  // __builtin_ssubll_overflow(9223372036854775807LL, -1LL, &ssubll_overflow_result_6) returns 1.
  __VERIFIER_assert(ssubll_overflow_overflow_6 == 1);
  ...
  __VERIFIER_assert(ssubll_overflow_result_7 == long_long_max);

  // __builtin_ssubll_overflow(-9223372036854775808LL, 1LL, &ssubll_overflow_result_7) returns 1.
  __VERIFIER_assert(ssubll_overflow_overflow_7 == 1);
  ...
  __VERIFIER_assert(ssubll_overflow_result_8 == long_long_min);

  // __builtin_ssubll_overflow(0LL, -9223372036854775808LL, &ssubll_overflow_result_8) returns 1.
  __VERIFIER_assert(ssubll_overflow_overflow_8 == 1);
  ...
  __VERIFIER_assert(usub_overflow_result_1 == 0U);

  // __builtin_usub_overflow(0U, 0U, &usub_overflow_result_1) returns 0.
  __VERIFIER_assert(usub_overflow_overflow_1 == 0);
  ...
  __VERIFIER_assert(usub_overflow_result_2 == unsigned_int_max);

  // __builtin_usub_overflow(4294967295U, 0U, &usub_overflow_result_2) returns 0.
  __VERIFIER_assert(usub_overflow_overflow_2 == 0);
  ...
  __VERIFIER_assert(usub_overflow_result_3 == 0U);

  // __builtin_usub_overflow(4294967295U, 4294967295U, &usub_overflow_result_3) returns 0.
  __VERIFIER_assert(usub_overflow_overflow_3 == 0);
  ...
  __VERIFIER_assert(usub_overflow_result_4 == 0U);

  // __builtin_usub_overflow(1U, 1U, &usub_overflow_result_4) returns 0.
  __VERIFIER_assert(usub_overflow_overflow_4 == 0);
  ...
  __VERIFIER_assert(usub_overflow_result_5 == unsigned_int_max);

  // __builtin_usub_overflow(0U, 1U, &usub_overflow_result_5) returns 1.
  __VERIFIER_assert(usub_overflow_overflow_5 == 1);
  ...
  __VERIFIER_assert(usub_overflow_result_6 == 1U);

  // __builtin_usub_overflow(0U, 4294967295U, &usub_overflow_result_6) returns 1.
  __VERIFIER_assert(usub_overflow_overflow_6 == 1);
  ...
  __VERIFIER_assert(usub_overflow_result_7 == unsigned_int_max);

  // __builtin_usub_overflow(1U, 2U, &usub_overflow_result_7) returns 1.
  __VERIFIER_assert(usub_overflow_overflow_7 == 1);
  ...
  __VERIFIER_assert(usubl_overflow_result_1 == 0UL);

  // __builtin_usubl_overflow(0UL, 0UL, &usubl_overflow_result_1) returns 0.
  __VERIFIER_assert(usubl_overflow_overflow_1 == 0);
  ...
  __VERIFIER_assert(usubl_overflow_result_2 == usubl_overflow_unsigned_long_max);
  ...
  __VERIFIER_assert(usubl_overflow_overflow_2 == 0);
  ...
  __VERIFIER_assert(usubl_overflow_result_3 == 0UL);
  ...
  __VERIFIER_assert(usubl_overflow_overflow_3 == 0);
  ...
  __VERIFIER_assert(usubl_overflow_result_4 == 0UL);

  // __builtin_usubl_overflow(1UL, 1UL, &usubl_overflow_result_4) returns 0.
  __VERIFIER_assert(usubl_overflow_overflow_4 == 0);
  ...
  __VERIFIER_assert(usubl_overflow_result_5 == usubl_overflow_unsigned_long_max);

  // __builtin_usubl_overflow(0UL, 1UL, &usubl_overflow_result_5) returns 1.
  __VERIFIER_assert(usubl_overflow_overflow_5 == 1);
  ...
  __VERIFIER_assert(usubl_overflow_result_6 == 1UL);
  ...
  __VERIFIER_assert(usubl_overflow_overflow_6 == 1);
  ...
  __VERIFIER_assert(usubl_overflow_result_7 == usubl_overflow_unsigned_long_max);

  // __builtin_usubl_overflow(1UL, 2UL, &usubl_overflow_result_7) returns 1.
  __VERIFIER_assert(usubl_overflow_overflow_7 == 1);
  ...
  __VERIFIER_assert(usubll_overflow_result_1 == 0ULL);

  // __builtin_usubll_overflow(0ULL, 0ULL, &usubll_overflow_result_1) returns 0.
  __VERIFIER_assert(usubll_overflow_overflow_1 == 0);
  ...
  __VERIFIER_assert(usubll_overflow_result_2 == unsigned_long_long_max);

  // __builtin_usubll_overflow(18446744073709551615ULL, 0ULL, &usubll_overflow_result_2) returns 0.
  __VERIFIER_assert(usubll_overflow_overflow_2 == 0);
  ...
  __VERIFIER_assert(usubll_overflow_result_4 == 0ULL);

  // __builtin_usubll_overflow(1ULL, 1ULL, &usubll_overflow_result_4) returns 0.
  __VERIFIER_assert(usubll_overflow_overflow_4 == 0);
  ...
  __VERIFIER_assert(usubll_overflow_result_5 == unsigned_long_long_max);

  // __builtin_usubll_overflow(0ULL, 1ULL, &usubll_overflow_result_5) returns 1.
  __VERIFIER_assert(usubll_overflow_overflow_5 == 1);
  ...
  __VERIFIER_assert(usubll_overflow_result_6 == 1ULL);

  // __builtin_usubll_overflow(0ULL, 18446744073709551615ULL, &usubll_overflow_result_6) returns 1.
  __VERIFIER_assert(usubll_overflow_overflow_6 == 1);
  ...
  __VERIFIER_assert(usubll_overflow_result_7 == unsigned_long_long_max);

  // __builtin_usubll_overflow(1ULL, 2ULL, &usubll_overflow_result_7) returns 1.
  __VERIFIER_assert(usubll_overflow_overflow_7 == 1);
  return 0;
}
