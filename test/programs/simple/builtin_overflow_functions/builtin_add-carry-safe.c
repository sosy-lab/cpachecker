...
int main(void) {
  ...
  if (sizeof(long int) == 4U) {
    ...
    // ILP32: 4294967295UL + 1UL + carry-in 0UL = 4294967296; stored result = 0UL and carry-out = 1UL.
    __VERIFIER_assert(model_addcl_cout == 1UL);
  } else {
    unsigned long int model_addcl_cout;
    (void)__builtin_addcl(4294967295UL, 1UL, 0UL, &model_addcl_cout);

    // LP64: 4294967295UL + 1UL + carry-in 0UL = 4294967296UL; result = 4294967296UL and carry-out = 0UL.
    __VERIFIER_assert(model_addcl_cout == 0UL);
  }
  ...
  __VERIFIER_assert(addc_0_0_cin0_res == 0U);

  __VERIFIER_assert(addc_0_0_cin0_cout == 0U);
  ...
  __VERIFIER_assert(addc_max_0_cin0_res == uint_max);

  __VERIFIER_assert(addc_max_0_cin0_cout == 0U);
  ...
  __VERIFIER_assert(addc_1_2_cin1_res == 4U);

  __VERIFIER_assert(addc_1_2_cin1_cout == 0U);
  ...
  __VERIFIER_assert(addc_max_1_cin0_res == 0U);

  __VERIFIER_assert(addc_max_1_cin0_cout == 1U);
  ...
  __VERIFIER_assert(addc_max_0_cin1_res == 0U);

  __VERIFIER_assert(addc_max_0_cin1_cout == 1U);
  ...
  __VERIFIER_assert(addc_max_max_cin2_res == 0U);

  __VERIFIER_assert(addc_max_max_cin2_cout == 1U);
  ...
  __VERIFIER_assert(addc_1_0_cinmax_res == 0U);

  __VERIFIER_assert(addc_1_0_cinmax_cout == 1U);
  ...
  // ILP32: 0UL + 0UL + carry-in 0UL = 0; result = 0UL and carry-out = 0UL because 0 <= 4294967295UL.
  // LP64: 0UL + 0UL + carry-in 0UL = 0; result = 0UL and carry-out = 0UL because 0 <= 18446744073709551615UL.
  __VERIFIER_assert(addcl_0_0_cin0_res == 0UL);

  __VERIFIER_assert(addcl_0_0_cin0_cout == 0UL);
  ...
  // ILP32: 4294967295UL + 0UL + carry-in 0UL = 4294967295; result = 4294967295UL and carry-out = 0UL because 4294967295 <= 4294967295UL.
  // LP64: 18446744073709551615UL + 0UL + carry-in 0UL = 18446744073709551615; result = 18446744073709551615UL and carry-out = 0UL because
  // 18446744073709551615 <= 18446744073709551615UL.
  __VERIFIER_assert(addcl_max_0_cin0_res == addcl_max);

  __VERIFIER_assert(addcl_max_0_cin0_cout == 0UL);
  ...
  // ILP32: 1UL + 2UL + carry-in 1UL = 4; result = 4UL and carry-out = 0UL because 4 <= 4294967295UL.
  // LP64: 1UL + 2UL + carry-in 1UL = 4; result = 4UL and carry-out = 0UL because 4 <= 18446744073709551615UL.
  __VERIFIER_assert(addcl_1_2_cin1_res == 4UL);

  __VERIFIER_assert(addcl_1_2_cin1_cout == 0UL);
  ...
  // ILP32: 4294967295UL + 1UL + carry-in 0UL = 4294967296; stored result = 0UL and carry-out = 1UL because 4294967296 > 4294967295UL.
  // LP64: 18446744073709551615UL + 1UL + carry-in 0UL = 18446744073709551616; stored result = 0UL and carry-out = 1UL because
  // 18446744073709551616 > 18446744073709551615UL.
  __VERIFIER_assert(addcl_max_1_cin0_res == 0UL);

  __VERIFIER_assert(addcl_max_1_cin0_cout == 1UL);
  ...
  // ILP32: 4294967295UL + 0UL + carry-in 1UL = 4294967296; stored result = 0UL and carry-out = 1UL because 4294967296 > 4294967295UL.
  // LP64: 18446744073709551615UL + 0UL + carry-in 1UL = 18446744073709551616; stored result = 0UL and carry-out = 1UL because
  // 18446744073709551616 > 18446744073709551615UL.
  __VERIFIER_assert(addcl_max_0_cin1_res == 0UL);

  __VERIFIER_assert(addcl_max_0_cin1_cout == 1UL);
  ...
  // ILP32: 4294967295UL + 4294967295UL + carry-in 2UL = 8589934592; stored result = 0UL and carry-out = 1UL because 8589934592 >
  // 4294967295UL.
  // LP64: 18446744073709551615UL + 18446744073709551615UL + carry-in 2UL = 36893488147419103232; stored result = 0UL and carry-out = 1UL
  // because 36893488147419103232 > 18446744073709551615UL.
  __VERIFIER_assert(addcl_max_max_cin2_res == 0UL);

  __VERIFIER_assert(addcl_max_max_cin2_cout == 1UL);
  ...
  // ILP32: 1UL + 0UL + carry-in 4294967295UL = 4294967296; stored result = 0UL and carry-out = 1UL because 4294967296 > 4294967295UL.
  // LP64: 1UL + 0UL + carry-in 18446744073709551615UL = 18446744073709551616; stored result = 0UL and carry-out = 1UL because
  // 18446744073709551616 > 18446744073709551615UL.
  __VERIFIER_assert(addcl_1_0_cinmax_res == 0UL);

  __VERIFIER_assert(addcl_1_0_cinmax_cout == 1UL);
  ...
  __VERIFIER_assert(addcll_0_0_cin0_res == 0ULL);

  __VERIFIER_assert(addcll_0_0_cin0_cout == 0ULL);
  ...
  __VERIFIER_assert(addcll_max_0_cin0_res == ull_max);

  __VERIFIER_assert(addcll_max_0_cin0_cout == 0ULL);
  ...
  __VERIFIER_assert(addcll_1_2_cin1_res == 4ULL);

  __VERIFIER_assert(addcll_1_2_cin1_cout == 0ULL);
  ...
  __VERIFIER_assert(addcll_max_1_cin0_res == 0ULL);

  __VERIFIER_assert(addcll_max_1_cin0_cout == 1ULL);
  ...
  // 18446744073709551616 > 18446744073709551615ULL.
  __VERIFIER_assert(addcll_max_0_cin1_res == 0ULL);

  __VERIFIER_assert(addcll_max_0_cin1_cout == 1ULL);
  ...
  __VERIFIER_assert(addcll_max_max_cin2_res == 0ULL);

  __VERIFIER_assert(addcll_max_max_cin2_cout == 1ULL);
  ...
  // 18446744073709551616 > 18446744073709551615ULL.
  __VERIFIER_assert(addcll_1_0_cinmax_res == 0ULL);

  __VERIFIER_assert(addcll_1_0_cinmax_cout == 1ULL);
