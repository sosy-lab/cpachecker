...
int main(void) {
  ...
  if (sizeof(long int) == 4U) {
    ...
    (void)model_smull_res;

    // ILP32: 2147483647L * 2L = 4294967294; stored result = -2L and overflow = 1 because it exceeds long.
    __VERIFIER_assert(model_smull_ov == 1);
  } else {
    long int model_smull_res;
    int model_smull_ov = __builtin_smull_overflow(2147483647L, 2L, &model_smull_res);
    (void)model_smull_res;

    // LP64: 2147483647L * 2L = 4294967294L, which fits long; result = 4294967294L and overflow = 0.
    __VERIFIER_assert(model_smull_ov == 0);
  }
  ...
  __VERIFIER_assert(mul_schar_max_1_res == schar_max);

  __VERIFIER_assert(mul_schar_max_1_ov == 0);
  ...
  __VERIFIER_assert(mul_schar_min_m1_res == schar_min);

  __VERIFIER_assert(mul_schar_min_m1_ov == 1);
  ...
  __VERIFIER_assert(mul_uchar_max_max_res == 1U);

  __VERIFIER_assert(mul_uchar_max_max_ov == 1);
  ...
  __VERIFIER_assert(mul_short_max_2_res == -2);

  __VERIFIER_assert(mul_short_max_2_ov == 1);
  ...
  __VERIFIER_assert(mul_ushort_2_32767_res == 65534U);

  __VERIFIER_assert(mul_ushort_2_32767_ov == 0);
  ...
  __VERIFIER_assert(mul_int_min_m1_res == int_min);

  __VERIFIER_assert(mul_int_min_m1_ov == 1);
  ...
  __VERIFIER_assert(mul_uint_max_max_res == 1U);

  __VERIFIER_assert(mul_uint_max_max_ov == 1);
  ...
  // ILP32: 2147483647L * 0L = 0, which fits the destination range; stored result = 0L and overflow = 0.
  // LP64: 9223372036854775807L * 0L = 0, which fits the destination range; stored result = 0L and overflow = 0.
  __VERIFIER_assert(mul_long_max_0_res == 0L);

  __VERIFIER_assert(mul_long_max_0_ov == 0);
  ...
  __VERIFIER_assert(mul_ll_min_0_res == 0LL);

  __VERIFIER_assert(mul_ll_min_0_ov == 0);
  ...
  __VERIFIER_assert(mul_ull_max_max_res == 1ULL);

  __VERIFIER_assert(mul_ull_max_max_ov == 1);
  ...
  __VERIFIER_assert(mul_char_max_2_res == char_2);

  __VERIFIER_assert(mul_char_max_2_ov == 1);
  ...
  __VERIFIER_assert(mul_int_1_1_res == -1);

  __VERIFIER_assert(mul_int_1_1_ov == 0);
  ...
  __VERIFIER_assert(smul_0_0_res == 0);

  __VERIFIER_assert(smul_0_0_ov == 0);
  ...
  __VERIFIER_assert(smul_max_0_res == 0);

  __VERIFIER_assert(smul_max_0_ov == 0);
  ...
  __VERIFIER_assert(smul_min_0_res == 0);

  __VERIFIER_assert(smul_min_0_ov == 0);
  ...
  __VERIFIER_assert(smul_max_1_res == int_max);

  __VERIFIER_assert(smul_max_1_ov == 0);
  ...
  __VERIFIER_assert(smul_min_1_res == int_min);

  __VERIFIER_assert(smul_min_1_ov == 0);
  ...
  // 2147483647 * -1 = -2147483647, which fits the destination range; stored result = -2147483647 and overflow = 0.
  __VERIFIER_assert(smul_max_m1_res == -int_max);

  __VERIFIER_assert(smul_max_m1_ov == 0);
  ...
  // -2147483648 * -1 = 2147483648, outside the destination range; stored result = -2147483648 and overflow = 1.
  __VERIFIER_assert(smul_min_m1_res == int_min);

  __VERIFIER_assert(smul_min_m1_ov == 1);
  ...
  __VERIFIER_assert(smul_max_2_res == -2);

  __VERIFIER_assert(smul_max_2_ov == 1);
  ...
  __VERIFIER_assert(smul_min_2_res == 0);

  __VERIFIER_assert(smul_min_2_ov == 1);
  ...
  __VERIFIER_assert(smull_0_0_res == 0L);

  __VERIFIER_assert(smull_0_0_ov == 0);
  ...
  // ILP32: 2147483647L * 0L = 0, which fits the destination range; stored result = 0L and overflow = 0.
  // LP64: 9223372036854775807L * 0L = 0, which fits the destination range; stored result = 0L and overflow = 0.
  __VERIFIER_assert(smull_max_0_res == 0L);

  __VERIFIER_assert(smull_max_0_ov == 0);
  ...
  // ILP32: -2147483648L * 0L = 0, which fits the destination range; stored result = 0L and overflow = 0.
  // LP64: -9223372036854775808L * 0L = 0, which fits the destination range; stored result = 0L and overflow = 0.
  __VERIFIER_assert(smull_min_0_res == 0L);

  __VERIFIER_assert(smull_min_0_ov == 0);
  ...
  // overflow = 0.
  __VERIFIER_assert(smull_max_1_res == smull_max);

  __VERIFIER_assert(smull_max_1_ov == 0);
  ...
  // ILP32: -2147483648L * 1L = -2147483648, which fits the destination range; stored result = -2147483648L and overflow = 0.
  // LP64: -9223372036854775808L * 1L = -9223372036854775808, which fits the destination range; stored result = -9223372036854775808L and
  // overflow = 0.
  __VERIFIER_assert(smull_min_1_res == smull_min);

  __VERIFIER_assert(smull_min_1_ov == 0);
  ...
  // ILP32: -2147483648L * -1L = 2147483648, outside the destination range; stored result = -2147483648L and overflow = 1.
  // LP64: -9223372036854775808L * -1L = 9223372036854775808, outside the destination range; stored result = -9223372036854775808L and
  // overflow = 1.
  __VERIFIER_assert(smull_min_m1_res == smull_min);

  __VERIFIER_assert(smull_min_m1_ov == 1);
  ...
  // ILP32: 2147483647L * 2L = 4294967294, outside the destination range; stored result = -2L and overflow = 1.
  // LP64: 9223372036854775807L * 2L = 18446744073709551614, outside the destination range; stored result = -2L and overflow = 1.
  __VERIFIER_assert(smull_max_2_res == -2L);

  __VERIFIER_assert(smull_max_2_ov == 1);
  ...
  // ILP32: -2147483648L * 2L = -4294967296, outside the destination range; stored result = 0L and overflow = 1.
  // LP64: -9223372036854775808L * 2L = -18446744073709551616, outside the destination range; stored result = 0L and overflow = 1.
  __VERIFIER_assert(smull_min_2_res == 0L);

  __VERIFIER_assert(smull_min_2_ov == 1);
  ...
  __VERIFIER_assert(smull_1_m1_res == 1L);

  __VERIFIER_assert(smull_1_m1_ov == 0);
  ...
  __VERIFIER_assert(smulll_0_0_res == 0LL);

  __VERIFIER_assert(smulll_0_0_ov == 0);
  ...
  __VERIFIER_assert(smulll_max_0_res == 0LL);

  __VERIFIER_assert(smulll_max_0_ov == 0);
  ...
  // -9223372036854775808LL * 0LL = 0, which fits the destination range; stored result = 0LL and overflow = 0.
  __VERIFIER_assert(smulll_min_0_res == 0LL);

  __VERIFIER_assert(smulll_min_0_ov == 0);
  ...
  // = 0.
  __VERIFIER_assert(smulll_max_1_res == ll_max);

  __VERIFIER_assert(smulll_max_1_ov == 0);
  ...
  // overflow = 0.
  __VERIFIER_assert(smulll_min_1_res == ll_min);

  __VERIFIER_assert(smulll_min_1_ov == 0);
  ...
  // overflow = 0.
  __VERIFIER_assert(smulll_max_m1_res == -ll_max);

  __VERIFIER_assert(smulll_max_m1_ov == 0);
  ...
  // = 1.
  __VERIFIER_assert(smulll_min_m1_res == ll_min);

  __VERIFIER_assert(smulll_min_m1_ov == 1);
  ...
  __VERIFIER_assert(smulll_max_2_res == -2LL);

  __VERIFIER_assert(smulll_max_2_ov == 1);
  ...
  __VERIFIER_assert(smulll_min_2_res == 0LL);

  __VERIFIER_assert(smulll_min_2_ov == 1);
  ...
  __VERIFIER_assert(smulll_1_m1_res == 1LL);

  __VERIFIER_assert(smulll_1_m1_ov == 0);
  ...
  __VERIFIER_assert(umul_0_uint_max_res == 0U);
  ...
  __VERIFIER_assert(umul_1_uint_max_res == uint_max);

  __VERIFIER_assert(umul_1_uint_max_ov == 0);
  ...
  __VERIFIER_assert(umul_2_2147483647u_res == 4294967294U);

  __VERIFIER_assert(umul_2_2147483647u_ov == 0);
  ...
  __VERIFIER_assert(umul_2_2147483648u_res == 0U);

  __VERIFIER_assert(umul_2_2147483648u_ov == 1);
  ...
  // 4294967295U * 4294967295U = 18446744065119617025, outside the destination range; stored result = 1U and overflow = 1.
  __VERIFIER_assert(umul_max_max_res == 1U);

  __VERIFIER_assert(umul_max_max_ov == 1);
  ...
  __VERIFIER_assert(umul_max_2_res == 4294967294U);

  __VERIFIER_assert(umul_max_2_ov == 1);
  ...
  // ILP32: 0UL * 4294967295UL = 0, which fits the destination range; stored result = 0UL and overflow = 0.
  // LP64: 0UL * 18446744073709551615UL = 0, which fits the destination range; stored result = 0UL and overflow = 0.
  __VERIFIER_assert(umull_0_ulong_max_res == 0UL);

  __VERIFIER_assert(umull_0_ulong_max_ov == 0);
  ...
  // ILP32: 1UL * 4294967295UL = 4294967295, which fits the destination range; stored result = 4294967295UL and overflow = 0.
  // LP64: 1UL * 18446744073709551615UL = 18446744073709551615, which fits the destination range; stored result = 18446744073709551615UL and
  // overflow = 0.
  __VERIFIER_assert(umull_1_ulong_max_res == umull_max);

  __VERIFIER_assert(umull_1_ulong_max_ov == 0);
  ...
  __VERIFIER_assert(umull_2_halfmax1_res == 0UL);

  __VERIFIER_assert(umull_2_halfmax1_ov == 1);
  ...
  // ILP32: 4294967295UL * 4294967295UL = 18446744065119617025, outside the destination range; stored result = 1UL and overflow = 1.
  // LP64: 18446744073709551615UL * 18446744073709551615UL = 340282366920938463426481119284349108225, outside the destination range; stored
  // result = 1UL and overflow = 1.
  __VERIFIER_assert(umull_max_max_res == 1UL);

  __VERIFIER_assert(umull_max_max_ov == 1);
  ...
  __VERIFIER_assert(umulll_0_ull_max_res == 0ULL);

  __VERIFIER_assert(umulll_0_ull_max_ov == 0);
  ...
  // overflow = 0.
  __VERIFIER_assert(umulll_1_ull_max_res == ull_max);

  __VERIFIER_assert(umulll_1_ull_max_ov == 0);
  ...
  // overflow = 0.
  __VERIFIER_assert(umulll_2_halfmax_res == 18446744073709551614ULL);

  __VERIFIER_assert(umulll_2_halfmax_ov == 0);
  ...
  __VERIFIER_assert(umulll_2_halfmax1_res == 0ULL);

  __VERIFIER_assert(umulll_2_halfmax1_ov == 1);
  ...
  // 18446744073709551615ULL * 18446744073709551615ULL = 340282366920938463426481119284349108225, outside the destination range; stored
  // result = 1ULL and overflow = 1.
  __VERIFIER_assert(umulll_max_max_res == 1ULL);

  __VERIFIER_assert(umulll_max_max_ov == 1);
  ...
  // overflow = 1.
  __VERIFIER_assert(umulll_max_2_res == 18446744073709551614ULL);

  __VERIFIER_assert(umulll_max_2_ov == 1);
