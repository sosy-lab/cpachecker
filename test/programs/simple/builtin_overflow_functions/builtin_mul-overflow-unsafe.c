...
int main(void) {
  ...
  all_expected_checks_fail = all_expected_checks_fail ||
    (sizeof(unsigned long int) == sizeof(unsigned int) && (unsigned int)mul_overflow_unsigned_long_max != unsigned_int_max) ||
  ...
  all_expected_checks_fail = all_expected_checks_fail ||
    (sizeof(long int) == sizeof(int) && (int)mul_overflow_long_max != int_max) ||
  ...
  // LP64: The calculated unsigned long must equal unsigned long long maximum 18446744073709551615ULL.
  all_expected_checks_fail = all_expected_checks_fail ||
    (sizeof(unsigned long int) == sizeof(unsigned int) && (unsigned int)smull_overflow_unsigned_long_max != unsigned_int_max) ||
    (sizeof(unsigned long int) == sizeof(unsigned long long int) &&
  ...
  // LP64: The calculated long maximum must equal long long maximum 9223372036854775807LL.
  all_expected_checks_fail = all_expected_checks_fail ||
    (sizeof(long int) == sizeof(int) && (int)smull_overflow_long_max != int_max) ||
    (sizeof(long int) == sizeof(long long int) &&
  ...
  all_expected_checks_fail = all_expected_checks_fail ||
    (sizeof(long int) == sizeof(int) && (int)smull_overflow_long_min != int_min) ||
    (sizeof(long int) == sizeof(long long int) &&
  ...
  // LP64: The calculated unsigned long must equal unsigned long long maximum 18446744073709551615ULL.
  all_expected_checks_fail = all_expected_checks_fail ||
    (sizeof(unsigned long int) == sizeof(unsigned int) && (unsigned int)umull_overflow_unsigned_long_max != unsigned_int_max) ||
    (sizeof(unsigned long int) == sizeof(unsigned long long int) &&
