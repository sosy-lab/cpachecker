...
int main(void) {
  ...
  // __builtin_sub_overflow(-128, 1, &sub_overflow_signed_char_min_minus_one_as_signed_char_result) stores 127.
  if (!(sub_overflow_signed_char_min_minus_one_as_signed_char_result == signed_char_max))
    goto ERROR;

  // __builtin_sub_overflow(-128, 1, &sub_overflow_signed_char_min_minus_one_as_signed_char_result) returns 1.
  ...
  // __builtin_sub_overflow(0, 1, &sub_overflow_zero_minus_one_as_unsigned_char_result) stores 255U.
  if (!(sub_overflow_zero_minus_one_as_unsigned_char_result == unsigned_char_max))
    goto ERROR;

  // __builtin_sub_overflow(0, 1, &sub_overflow_zero_minus_one_as_unsigned_char_result) returns 1.
  ...
  // __builtin_sub_overflow(32767, -1, &sub_overflow_short_max_minus_minus_one_as_short_int_result) stores -32768.
  if (!(sub_overflow_short_max_minus_minus_one_as_short_int_result == short_min))
    goto ERROR;

  // __builtin_sub_overflow(32767, -1, &sub_overflow_short_max_minus_minus_one_as_short_int_result) returns 1.
  ...
  // __builtin_sub_overflow(65535U, 65535U, &sub_overflow_unsigned_short_max_minus_unsigned_short_max_as_unsigned_short_int_result) stores
  // 0U.
  if (!(sub_overflow_unsigned_short_max_minus_unsigned_short_max_as_unsigned_short_int_result == 0U))
    goto ERROR;

  // __builtin_sub_overflow(65535U, 65535U, &sub_overflow_unsigned_short_max_minus_unsigned_short_max_as_unsigned_short_int_result) returns
  // 0.
  ...
  // __builtin_sub_overflow((-2147483647 - 1), 1, &sub_overflow_int_min_minus_one_as_int_result) stores 2147483647.
  if (!(sub_overflow_int_min_minus_one_as_int_result == int_max))
    goto ERROR;

  // __builtin_sub_overflow((-2147483647 - 1), 1, &sub_overflow_int_min_minus_one_as_int_result) returns 1.
  ...
  // __builtin_sub_overflow(0U, 4294967295U, &sub_overflow_zero_minus_unsigned_int_max_as_unsigned_int_result) stores 1U.
  if (!(sub_overflow_zero_minus_unsigned_int_max_as_unsigned_int_result == 1U))
    goto ERROR;

  // __builtin_sub_overflow(0U, 4294967295U, &sub_overflow_zero_minus_unsigned_int_max_as_unsigned_int_result) returns 1.
  ...
  // ILP32: __builtin_sub_overflow(2147483647L, -1L, &sub_overflow_long_max_minus_minus_one_as_long_int_result) stores -2147483648L.
  // LP64: __builtin_sub_overflow(9223372036854775807L, -1L, &sub_overflow_long_max_minus_minus_one_as_long_int_result) stores
  // -9223372036854775808L.
  if (!(sub_overflow_long_max_minus_minus_one_as_long_int_result == sub_overflow_long_min))
    goto ERROR;

  // ILP32: __builtin_sub_overflow(2147483647L, -1L, &sub_overflow_long_max_minus_minus_one_as_long_int_result) returns 1.
  // LP64: __builtin_sub_overflow(9223372036854775807L, -1L, &sub_overflow_long_max_minus_minus_one_as_long_int_result) returns 1.
  ...
  // ILP32: __builtin_sub_overflow(0UL, 1UL, &sub_overflow_zero_minus_one_as_unsigned_long_int_result) stores 4294967295UL.
  // LP64: __builtin_sub_overflow(0UL, 1UL, &sub_overflow_zero_minus_one_as_unsigned_long_int_result) stores 18446744073709551615UL.
  if (!(sub_overflow_zero_minus_one_as_unsigned_long_int_result == sub_overflow_unsigned_long_max))
    goto ERROR;

  // __builtin_sub_overflow(0UL, 1UL, &sub_overflow_zero_minus_one_as_unsigned_long_int_result) returns 1.
  ...
  // __builtin_sub_overflow(0LL, -9223372036854775808LL, &sub_overflow_zero_minus_long_long_min_as_long_long_int_result) stores
  // -9223372036854775808LL.
  if (!(sub_overflow_zero_minus_long_long_min_as_long_long_int_result == long_long_min))
    goto ERROR;

  // __builtin_sub_overflow(0LL, -9223372036854775808LL, &sub_overflow_zero_minus_long_long_min_as_long_long_int_result) returns 1.
  ...
  // __builtin_sub_overflow(18446744073709551615ULL, 18446744073709551615ULL,
  // &sub_overflow_unsigned_long_long_max_minus_unsigned_long_long_max_as_unsigned_long_long_int_result) stores 0ULL.
  if (!(sub_overflow_unsigned_long_long_max_minus_unsigned_long_long_max_as_unsigned_long_long_int_result == 0ULL))
    goto ERROR;

  // __builtin_sub_overflow(18446744073709551615ULL, 18446744073709551615ULL,
  // &sub_overflow_unsigned_long_long_max_minus_unsigned_long_long_max_as_unsigned_long_long_int_result) returns 0.
  ...
  // __builtin_sub_overflow((char)-128, 1, &sub_overflow_char_min_minus_one_as_char_result) stores (char)127.
  if (!(sub_overflow_char_min_minus_one_as_char_result == char_max))
    goto ERROR;

  // __builtin_sub_overflow(-128, 1, &sub_overflow_char_min_minus_one_as_char_result) or __builtin_sub_overflow(0, 1,
  // &sub_overflow_char_min_minus_one_as_char_result)
  ...
  // __builtin_sub_overflow(1ULL, 1LL, &sub_overflow_one_minus_one_as_int_result) stores 0.
  if (!(sub_overflow_one_minus_one_as_int_result == 0))
    goto ERROR;

  // __builtin_sub_overflow(1ULL, 1LL, &sub_overflow_one_minus_one_as_int_result) returns 0.
  ...
  // __builtin_sub_overflow(-1LL, 0ULL, &sub_overflow_minus_one_minus_zero_as_unsigned_int_result) stores 4294967295U.
  if (!(sub_overflow_minus_one_minus_zero_as_unsigned_int_result == unsigned_int_max))
    goto ERROR;

  // __builtin_sub_overflow(-1LL, 0ULL, &sub_overflow_minus_one_minus_zero_as_unsigned_int_result) returns 1.
  ...
  // __builtin_ssub_overflow(0, 0, &ssub_overflow_zero_minus_zero_result) stores 0.
  if (!(ssub_overflow_zero_minus_zero_result == 0))
    goto ERROR;

  // __builtin_ssub_overflow(0, 0, &ssub_overflow_zero_minus_zero_result) returns 0.
  ...
  // __builtin_ssub_overflow(2147483647, 0, &ssub_overflow_int_max_minus_zero_result) stores 2147483647.
  if (!(ssub_overflow_int_max_minus_zero_result == int_max))
    goto ERROR;

  // __builtin_ssub_overflow(2147483647, 0, &ssub_overflow_int_max_minus_zero_result) returns 0.
  ...
  // __builtin_ssub_overflow((-2147483647 - 1), 0, &ssub_overflow_int_min_minus_zero_result) stores (-2147483647 - 1).
  if (!(ssub_overflow_int_min_minus_zero_result == int_min))
    goto ERROR;

  // __builtin_ssub_overflow((-2147483647 - 1), 0, &ssub_overflow_int_min_minus_zero_result) returns 0.
  ...
  // __builtin_ssub_overflow((-2147483647 - 1), -1, &ssub_overflow_int_min_minus_minus_one_result) stores (-2147483647 - 1) + 1.
  if (!(ssub_overflow_int_min_minus_minus_one_result == -int_max))
    goto ERROR;

  // __builtin_ssub_overflow((-2147483647 - 1), -1, &ssub_overflow_int_min_minus_minus_one_result) returns 0.
  ...
  // __builtin_ssub_overflow(2147483647, 1, &ssub_overflow_int_max_minus_one_result) stores 2147483647 - 1.
  if (!(ssub_overflow_int_max_minus_one_result == 2147483646))
    goto ERROR;

  // __builtin_ssub_overflow(2147483647, 1, &ssub_overflow_int_max_minus_one_result) returns 0.
  ...
  // __builtin_ssub_overflow(2147483647, -1, &ssub_overflow_int_max_minus_minus_one_result) stores (-2147483647 - 1).
  if (!(ssub_overflow_int_max_minus_minus_one_result == int_min))
    goto ERROR;

  // __builtin_ssub_overflow(2147483647, -1, &ssub_overflow_int_max_minus_minus_one_result) returns 1.
  ...
  // __builtin_ssub_overflow((-2147483647 - 1), 1, &ssub_overflow_int_min_minus_one_result) stores 2147483647.
  if (!(ssub_overflow_int_min_minus_one_result == int_max))
    goto ERROR;

  // __builtin_ssub_overflow((-2147483647 - 1), 1, &ssub_overflow_int_min_minus_one_result) returns 1.
  ...
  // __builtin_ssub_overflow(0, (-2147483647 - 1), &ssub_overflow_zero_minus_int_min_result) stores (-2147483647 - 1).
  if (!(ssub_overflow_zero_minus_int_min_result == int_min))
    goto ERROR;

  // __builtin_ssub_overflow(0, (-2147483647 - 1), &ssub_overflow_zero_minus_int_min_result) returns 1.
  ...
  // __builtin_ssubl_overflow(0L, 0L, &ssubl_overflow_zero_minus_zero_result) stores 0L.
  if (!(ssubl_overflow_zero_minus_zero_result == 0L))
    goto ERROR;

  // __builtin_ssubl_overflow(0L, 0L, &ssubl_overflow_zero_minus_zero_result) returns 0.
  ...
  // ILP32: __builtin_ssubl_overflow(2147483647L, 0L, &ssubl_overflow_long_max_minus_zero_result) stores 2147483647L.
  // LP64: __builtin_ssubl_overflow(9223372036854775807L, 0L, &ssubl_overflow_long_max_minus_zero_result) stores 9223372036854775807L.
  if (!(ssubl_overflow_long_max_minus_zero_result == ssubl_overflow_long_max))
    goto ERROR;

  // ILP32: __builtin_ssubl_overflow(2147483647L, 0L, &ssubl_overflow_long_max_minus_zero_result) returns 0.
  // LP64: __builtin_ssubl_overflow(9223372036854775807L, 0L, &ssubl_overflow_long_max_minus_zero_result) returns 0.
  ...
  // ILP32: __builtin_ssubl_overflow(-2147483648L, 0L, &ssubl_overflow_long_min_minus_zero_result) stores -2147483648L.
  // LP64: __builtin_ssubl_overflow(-9223372036854775808L, 0L, &ssubl_overflow_long_min_minus_zero_result) stores -9223372036854775808L.
  if (!(ssubl_overflow_long_min_minus_zero_result == ssubl_overflow_long_min))
    goto ERROR;

  // ILP32: __builtin_ssubl_overflow(-2147483648L, 0L, &ssubl_overflow_long_min_minus_zero_result) returns 0.
  // LP64: __builtin_ssubl_overflow(-9223372036854775808L, 0L, &ssubl_overflow_long_min_minus_zero_result) returns 0.
  ...
  // ILP32: __builtin_ssubl_overflow(-2147483648L, -1L, &ssubl_overflow_long_min_minus_minus_one_result) stores -2147483648L + 1L.
  // LP64: __builtin_ssubl_overflow(-9223372036854775808L, -1L, &ssubl_overflow_long_min_minus_minus_one_result) stores
  // -9223372036854775808L + 1L.
  if (!(ssubl_overflow_long_min_minus_minus_one_result == ((-((long int)((~0UL) >> 1)) - 1L)) + 1L))
    goto ERROR;

  // ILP32: __builtin_ssubl_overflow(-2147483648L, -1L, &ssubl_overflow_long_min_minus_minus_one_result) returns 0.
  // LP64: __builtin_ssubl_overflow(-9223372036854775808L, -1L, &ssubl_overflow_long_min_minus_minus_one_result) returns 0.
  ...
  // ILP32: __builtin_ssubl_overflow(2147483647L, 1L, &ssubl_overflow_long_max_minus_one_result) stores 2147483647L - 1L.
  // LP64: __builtin_ssubl_overflow(9223372036854775807L, 1L, &ssubl_overflow_long_max_minus_one_result) stores 9223372036854775807L - 1L.
  if (!(ssubl_overflow_long_max_minus_one_result == ((long int)((~0UL) >> 1)) - 1L))
    goto ERROR;

  // ILP32: __builtin_ssubl_overflow(2147483647L, 1L, &ssubl_overflow_long_max_minus_one_result) returns 0.
  // LP64: __builtin_ssubl_overflow(9223372036854775807L, 1L, &ssubl_overflow_long_max_minus_one_result) returns 0.
  ...
  // ILP32: __builtin_ssubl_overflow(2147483647L, -1L, &ssubl_overflow_long_max_minus_minus_one_result) stores -2147483648L.
  // LP64: __builtin_ssubl_overflow(9223372036854775807L, -1L, &ssubl_overflow_long_max_minus_minus_one_result) stores
  // -9223372036854775808L.
  if (!(ssubl_overflow_long_max_minus_minus_one_result == ssubl_overflow_long_min))
    goto ERROR;

  // ILP32: __builtin_ssubl_overflow(2147483647L, -1L, &ssubl_overflow_long_max_minus_minus_one_result) returns 1.
  // LP64: __builtin_ssubl_overflow(9223372036854775807L, -1L, &ssubl_overflow_long_max_minus_minus_one_result) returns 1.
  ...
  // ILP32: __builtin_ssubl_overflow(-2147483648L, 1L, &ssubl_overflow_long_min_minus_one_result) stores 2147483647L.
  // LP64: __builtin_ssubl_overflow(-9223372036854775808L, 1L, &ssubl_overflow_long_min_minus_one_result) stores 9223372036854775807L.
  if (!(ssubl_overflow_long_min_minus_one_result == ssubl_overflow_long_max))
    goto ERROR;

  // ILP32: __builtin_ssubl_overflow(-2147483648L, 1L, &ssubl_overflow_long_min_minus_one_result) returns 1.
  // LP64: __builtin_ssubl_overflow(-9223372036854775808L, 1L, &ssubl_overflow_long_min_minus_one_result) returns 1.
  ...
  // ILP32: __builtin_ssubl_overflow(0L, -2147483648L, &ssubl_overflow_zero_minus_long_min_result) stores -2147483648L.
  // LP64: __builtin_ssubl_overflow(0L, -9223372036854775808L, &ssubl_overflow_zero_minus_long_min_result) stores -9223372036854775808L.
  if (!(ssubl_overflow_zero_minus_long_min_result == ssubl_overflow_long_min))
    goto ERROR;

  // ILP32: __builtin_ssubl_overflow(0L, -2147483648L, &ssubl_overflow_zero_minus_long_min_result) returns 1.
  // LP64: __builtin_ssubl_overflow(0L, -9223372036854775808L, &ssubl_overflow_zero_minus_long_min_result) returns 1.
  ...
  // __builtin_ssubll_overflow(0LL, 0LL, &ssubll_overflow_zero_minus_zero_result) stores 0LL.
  if (!(ssubll_overflow_zero_minus_zero_result == 0LL))
    goto ERROR;

  // __builtin_ssubll_overflow(0LL, 0LL, &ssubll_overflow_zero_minus_zero_result) returns 0.
  ...
  // __builtin_ssubll_overflow(9223372036854775807LL, 0LL, &ssubll_overflow_long_long_max_minus_zero_result) stores 9223372036854775807LL.
  if (!(ssubll_overflow_long_long_max_minus_zero_result == long_long_max))
    goto ERROR;

  // __builtin_ssubll_overflow(9223372036854775807LL, 0LL, &ssubll_overflow_long_long_max_minus_zero_result) returns 0.
  ...
  // __builtin_ssubll_overflow(-9223372036854775808LL, 0LL, &ssubll_overflow_long_long_min_minus_zero_result) stores -9223372036854775808LL.
  if (!(ssubll_overflow_long_long_min_minus_zero_result == long_long_min))
    goto ERROR;

  // __builtin_ssubll_overflow(-9223372036854775808LL, 0LL, &ssubll_overflow_long_long_min_minus_zero_result) returns 0.
  ...
  // __builtin_ssubll_overflow(-9223372036854775808LL, -1LL, &ssubll_overflow_long_long_min_minus_minus_one_result) stores
  // -9223372036854775808LL + 1LL.
  if (!(ssubll_overflow_long_long_min_minus_minus_one_result == -long_long_max))
    goto ERROR;

  // __builtin_ssubll_overflow(-9223372036854775808LL, -1LL, &ssubll_overflow_long_long_min_minus_minus_one_result) returns 0.
  ...
  // __builtin_ssubll_overflow(9223372036854775807LL, 1LL, &ssubll_overflow_long_long_max_minus_one_result) stores 9223372036854775807LL -
  // 1LL.
  if (!(ssubll_overflow_long_long_max_minus_one_result == 9223372036854775806LL))
    goto ERROR;

  // __builtin_ssubll_overflow(9223372036854775807LL, 1LL, &ssubll_overflow_long_long_max_minus_one_result) returns 0.
  ...
  // __builtin_ssubll_overflow(9223372036854775807LL, -1LL, &ssubll_overflow_long_long_max_minus_minus_one_result) stores
  // -9223372036854775808LL.
  if (!(ssubll_overflow_long_long_max_minus_minus_one_result == long_long_min))
    goto ERROR;

  // __builtin_ssubll_overflow(9223372036854775807LL, -1LL, &ssubll_overflow_long_long_max_minus_minus_one_result) returns 1.
  ...
  // __builtin_ssubll_overflow(-9223372036854775808LL, 1LL, &ssubll_overflow_long_long_min_minus_one_result) stores 9223372036854775807LL.
  if (!(ssubll_overflow_long_long_min_minus_one_result == long_long_max))
    goto ERROR;

  // __builtin_ssubll_overflow(-9223372036854775808LL, 1LL, &ssubll_overflow_long_long_min_minus_one_result) returns 1.
  ...
  // __builtin_ssubll_overflow(0LL, -9223372036854775808LL, &ssubll_overflow_zero_minus_long_long_min_result) stores -9223372036854775808LL.
  if (!(ssubll_overflow_zero_minus_long_long_min_result == long_long_min))
    goto ERROR;

  // __builtin_ssubll_overflow(0LL, -9223372036854775808LL, &ssubll_overflow_zero_minus_long_long_min_result) returns 1.
  ...
  // __builtin_usub_overflow(0U, 0U, &usub_overflow_zero_minus_zero_result) stores 0U.
  if (!(usub_overflow_zero_minus_zero_result == 0U))
    goto ERROR;

  // __builtin_usub_overflow(0U, 0U, &usub_overflow_zero_minus_zero_result) returns 0.
  ...
  // __builtin_usub_overflow(4294967295U, 0U, &usub_overflow_unsigned_int_max_minus_zero_result) stores 4294967295U.
  if (!(usub_overflow_unsigned_int_max_minus_zero_result == unsigned_int_max))
    goto ERROR;

  // __builtin_usub_overflow(4294967295U, 0U, &usub_overflow_unsigned_int_max_minus_zero_result) returns 0.
  ...
  // __builtin_usub_overflow(4294967295U, 4294967295U, &usub_overflow_unsigned_int_max_minus_unsigned_int_max_result) stores 0U.
  if (!(usub_overflow_unsigned_int_max_minus_unsigned_int_max_result == 0U))
    goto ERROR;

  // __builtin_usub_overflow(4294967295U, 4294967295U, &usub_overflow_unsigned_int_max_minus_unsigned_int_max_result) returns 0.
  ...
  // __builtin_usub_overflow(1U, 1U, &usub_overflow_one_minus_one_result) stores 0U.
  if (!(usub_overflow_one_minus_one_result == 0U))
    goto ERROR;

  // __builtin_usub_overflow(1U, 1U, &usub_overflow_one_minus_one_result) returns 0.
  ...
  // __builtin_usub_overflow(0U, 1U, &usub_overflow_zero_minus_one_result) stores 4294967295U.
  if (!(usub_overflow_zero_minus_one_result == unsigned_int_max))
    goto ERROR;

  // __builtin_usub_overflow(0U, 1U, &usub_overflow_zero_minus_one_result) returns 1.
  ...
  // __builtin_usub_overflow(0U, 4294967295U, &usub_overflow_zero_minus_unsigned_int_max_result) stores 1U.
  if (!(usub_overflow_zero_minus_unsigned_int_max_result == 1U))
    goto ERROR;

  // __builtin_usub_overflow(0U, 4294967295U, &usub_overflow_zero_minus_unsigned_int_max_result) returns 1.
  ...
  // __builtin_usub_overflow(1U, 2U, &usub_overflow_one_minus_two_result) stores 4294967295U.
  if (!(usub_overflow_one_minus_two_result == unsigned_int_max))
    goto ERROR;

  // __builtin_usub_overflow(1U, 2U, &usub_overflow_one_minus_two_result) returns 1.
  ...
  // __builtin_usubl_overflow(0UL, 0UL, &usubl_overflow_zero_minus_zero_result) stores 0UL.
  if (!(usubl_overflow_zero_minus_zero_result == 0UL))
    goto ERROR;

  // __builtin_usubl_overflow(0UL, 0UL, &usubl_overflow_zero_minus_zero_result) returns 0.
  ...
  // ILP32: __builtin_usubl_overflow(4294967295UL, 0UL, &usubl_overflow_unsigned_long_max_minus_zero_result) stores 4294967295UL.
  // LP64: __builtin_usubl_overflow(18446744073709551615UL, 0UL, &usubl_overflow_unsigned_long_max_minus_zero_result) stores
  // 18446744073709551615UL.
  if (!(usubl_overflow_unsigned_long_max_minus_zero_result == usubl_overflow_unsigned_long_max))
    goto ERROR;

  // ILP32: __builtin_usubl_overflow(4294967295UL, 0UL, &usubl_overflow_unsigned_long_max_minus_zero_result) returns 0.
  // LP64: __builtin_usubl_overflow(18446744073709551615UL, 0UL, &usubl_overflow_unsigned_long_max_minus_zero_result) returns 0.
  ...
  // ILP32: __builtin_usubl_overflow(4294967295UL, 4294967295UL, &usubl_overflow_unsigned_long_max_minus_unsigned_long_max_result) stores
  // 0UL.
  // LP64: __builtin_usubl_overflow(18446744073709551615UL, 18446744073709551615UL,
  // &usubl_overflow_unsigned_long_max_minus_unsigned_long_max_result) stores 0UL.
  if (!(usubl_overflow_unsigned_long_max_minus_unsigned_long_max_result == 0UL))
    goto ERROR;

  // ILP32: __builtin_usubl_overflow(4294967295UL, 4294967295UL, &usubl_overflow_unsigned_long_max_minus_unsigned_long_max_result) returns
  // 0.
  // LP64: __builtin_usubl_overflow(18446744073709551615UL, 18446744073709551615UL,
  // &usubl_overflow_unsigned_long_max_minus_unsigned_long_max_result) returns 0.
  ...
  // __builtin_usubl_overflow(1UL, 1UL, &usubl_overflow_one_minus_one_result) stores 0UL.
  if (!(usubl_overflow_one_minus_one_result == 0UL))
    goto ERROR;

  // __builtin_usubl_overflow(1UL, 1UL, &usubl_overflow_one_minus_one_result) returns 0.
  ...
  // ILP32: __builtin_usubl_overflow(0UL, 1UL, &usubl_overflow_zero_minus_one_result) stores 4294967295UL.
  // LP64: __builtin_usubl_overflow(0UL, 1UL, &usubl_overflow_zero_minus_one_result) stores 18446744073709551615UL.
  if (!(usubl_overflow_zero_minus_one_result == usubl_overflow_unsigned_long_max))
    goto ERROR;

  // __builtin_usubl_overflow(0UL, 1UL, &usubl_overflow_zero_minus_one_result) returns 1.
  ...
  // ILP32: __builtin_usubl_overflow(0UL, 4294967295UL, &usubl_overflow_zero_minus_unsigned_long_max_result) stores 1UL.
  // LP64: __builtin_usubl_overflow(0UL, 18446744073709551615UL, &usubl_overflow_zero_minus_unsigned_long_max_result) stores 1UL.
  if (!(usubl_overflow_zero_minus_unsigned_long_max_result == 1UL))
    goto ERROR;

  // ILP32: __builtin_usubl_overflow(0UL, 4294967295UL, &usubl_overflow_zero_minus_unsigned_long_max_result) returns 1.
  // LP64: __builtin_usubl_overflow(0UL, 18446744073709551615UL, &usubl_overflow_zero_minus_unsigned_long_max_result) returns 1.
  ...
  // ILP32: __builtin_usubl_overflow(1UL, 2UL, &usubl_overflow_one_minus_two_result) stores 4294967295UL.
  // LP64: __builtin_usubl_overflow(1UL, 2UL, &usubl_overflow_one_minus_two_result) stores 18446744073709551615UL.
  if (!(usubl_overflow_one_minus_two_result == usubl_overflow_unsigned_long_max))
    goto ERROR;

  // __builtin_usubl_overflow(1UL, 2UL, &usubl_overflow_one_minus_two_result) returns 1.
  ...
  // __builtin_usubll_overflow(0ULL, 0ULL, &usubll_overflow_zero_minus_zero_result) stores 0ULL.
  if (!(usubll_overflow_zero_minus_zero_result == 0ULL))
    goto ERROR;

  // __builtin_usubll_overflow(0ULL, 0ULL, &usubll_overflow_zero_minus_zero_result) returns 0.
  ...
  // __builtin_usubll_overflow(18446744073709551615ULL, 0ULL, &usubll_overflow_unsigned_long_long_max_minus_zero_result) stores
  // 18446744073709551615ULL.
  if (!(usubll_overflow_unsigned_long_long_max_minus_zero_result == unsigned_long_long_max))
    goto ERROR;

  // __builtin_usubll_overflow(18446744073709551615ULL, 0ULL, &usubll_overflow_unsigned_long_long_max_minus_zero_result) returns 0.
  ...
  // __builtin_usubll_overflow(18446744073709551615ULL, 18446744073709551615ULL,
  // &usubll_overflow_unsigned_long_long_max_minus_unsigned_long_long_max_result) stores 0ULL.
  if (!(usubll_overflow_unsigned_long_long_max_minus_unsigned_long_long_max_result == 0ULL))
    goto ERROR;

  // __builtin_usubll_overflow(18446744073709551615ULL, 18446744073709551615ULL,
  // &usubll_overflow_unsigned_long_long_max_minus_unsigned_long_long_max_result) returns 0.
  ...
  // __builtin_usubll_overflow(1ULL, 1ULL, &usubll_overflow_one_minus_one_result) stores 0ULL.
  if (!(usubll_overflow_one_minus_one_result == 0ULL))
    goto ERROR;

  // __builtin_usubll_overflow(1ULL, 1ULL, &usubll_overflow_one_minus_one_result) returns 0.
  ...
  // __builtin_usubll_overflow(0ULL, 1ULL, &usubll_overflow_zero_minus_one_result) stores 18446744073709551615ULL.
  if (!(usubll_overflow_zero_minus_one_result == unsigned_long_long_max))
    goto ERROR;

  // __builtin_usubll_overflow(0ULL, 1ULL, &usubll_overflow_zero_minus_one_result) returns 1.
  ...
  // __builtin_usubll_overflow(0ULL, 18446744073709551615ULL, &usubll_overflow_zero_minus_unsigned_long_long_max_result) stores 1ULL.
  if (!(usubll_overflow_zero_minus_unsigned_long_long_max_result == 1ULL))
    goto ERROR;

  // __builtin_usubll_overflow(0ULL, 18446744073709551615ULL, &usubll_overflow_zero_minus_unsigned_long_long_max_result) returns 1.
  ...
  // __builtin_usubll_overflow(1ULL, 2ULL, &usubll_overflow_one_minus_two_result) stores 18446744073709551615ULL.
  if (!(usubll_overflow_one_minus_two_result == unsigned_long_long_max))
    goto ERROR;

  // __builtin_usubll_overflow(1ULL, 2ULL, &usubll_overflow_one_minus_two_result) returns 1.
