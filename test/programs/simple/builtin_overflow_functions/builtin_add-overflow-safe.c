...
int main(void) {
  ...
  __VERIFIER_assert((sizeof(long int) == sizeof(int) && (int)add_overflow_long_max == int_max) ||
  ...
  __VERIFIER_assert((sizeof(long int) == sizeof(int) && (int)add_overflow_long_min == int_min) ||
         (sizeof(long int) == sizeof(long long int) &&
  ...
  __VERIFIER_assert(add_overflow_result_1 == signed_char_max);

  // __builtin_add_overflow(127, 0, &add_overflow_result_1) returns 0.
  __VERIFIER_assert(add_overflow_overflow_1 == 0);
  ...
  __VERIFIER_assert(add_overflow_result_2 == signed_char_min);

  // __builtin_add_overflow(127, 1, &add_overflow_result_2) returns 1.
  __VERIFIER_assert(add_overflow_overflow_2 == 1);
  ...
  __VERIFIER_assert(add_overflow_result_3 == 0);

  // __builtin_add_overflow(255U, 1, &add_overflow_result_3) returns 1.
  __VERIFIER_assert(add_overflow_overflow_3 == 1);
  ...
  __VERIFIER_assert(add_overflow_result_4 == short_max);

  // __builtin_add_overflow(-32768, -1, &add_overflow_result_4) returns 1.
  __VERIFIER_assert(add_overflow_overflow_4 == 1);
  ...
  __VERIFIER_assert(add_overflow_result_5 == 0U);

  // __builtin_add_overflow(-1, 1U, &add_overflow_result_5) returns 0.
  __VERIFIER_assert(add_overflow_overflow_5 == 0);
  ...
  __VERIFIER_assert(add_overflow_result_6 == int_min);

  // __builtin_add_overflow(2147483647, 1, &add_overflow_result_6) returns 1.
  __VERIFIER_assert(add_overflow_overflow_6 == 1);
  ...
  __VERIFIER_assert(add_overflow_result_7 == 0U);

  // __builtin_add_overflow(4294967295U, 1U, &add_overflow_result_7) returns 1.
  __VERIFIER_assert(add_overflow_overflow_7 == 1);
  ...
  __VERIFIER_assert(add_overflow_result_8 == add_overflow_long_min);
  ...
  __VERIFIER_assert(add_overflow_overflow_8 == 1);
  ...
  __VERIFIER_assert(add_overflow_result_9 == 0UL);
  ...
  __VERIFIER_assert(add_overflow_overflow_9 == 1);
  ...
  __VERIFIER_assert(add_overflow_result_10 == long_long_max);

  // __builtin_add_overflow(-9223372036854775808LL, -1LL, &add_overflow_result_10) returns 1.
  __VERIFIER_assert(add_overflow_overflow_10 == 1);
  ...
  __VERIFIER_assert(add_overflow_result_11 == 0ULL);

  // __builtin_add_overflow(18446744073709551615ULL, 1ULL, &add_overflow_result_11) returns 1.
  __VERIFIER_assert(add_overflow_overflow_11 == 1);
  ...
  __VERIFIER_assert(add_overflow_result_12 == char_min);

  // __builtin_add_overflow((char)127, 1, &add_overflow_result_12) returns 1.
  __VERIFIER_assert(add_overflow_overflow_12 == 1);
  ...
  __VERIFIER_assert(add_overflow_result_13 == 0);

  // __builtin_add_overflow(-1LL, 1ULL, &add_overflow_result_13) returns 0.
  __VERIFIER_assert(add_overflow_overflow_13 == 0);
  ...
  __VERIFIER_assert(add_overflow_result_14 == (int)unsigned_long_long_max);

  // __builtin_add_overflow(18446744073709551615ULL, 0, &add_overflow_result_14) returns 1.
  __VERIFIER_assert(add_overflow_overflow_14 == 1);
  ...
  __VERIFIER_assert(sadd_overflow_result_1 == 0);

  // __builtin_sadd_overflow(0, 0, &sadd_overflow_result_1) returns 0.
  __VERIFIER_assert(sadd_overflow_overflow_1 == 0);
  ...
  __VERIFIER_assert(sadd_overflow_result_2 == int_max);

  // __builtin_sadd_overflow(2147483647, 0, &sadd_overflow_result_2) returns 0.
  __VERIFIER_assert(sadd_overflow_overflow_2 == 0);
  ...
  __VERIFIER_assert(sadd_overflow_result_3 == int_min);

  // __builtin_sadd_overflow((-2147483647 - 1), 0, &sadd_overflow_result_3) returns 0.
  __VERIFIER_assert(sadd_overflow_overflow_3 == 0);
  ...
  __VERIFIER_assert(sadd_overflow_result_4 == 2147483646);

  // __builtin_sadd_overflow(2147483647, -1, &sadd_overflow_result_4) returns 0.
  __VERIFIER_assert(sadd_overflow_overflow_4 == 0);
  ...
  __VERIFIER_assert(sadd_overflow_result_5 == -int_max);

  // __builtin_sadd_overflow((-2147483647 - 1), 1, &sadd_overflow_result_5) returns 0.
  __VERIFIER_assert(sadd_overflow_overflow_5 == 0);
  ...
  __VERIFIER_assert(sadd_overflow_result_6 == int_min);

  // __builtin_sadd_overflow(2147483647, 1, &sadd_overflow_result_6) returns 1.
  __VERIFIER_assert(sadd_overflow_overflow_6 == 1);
  ...
  __VERIFIER_assert(sadd_overflow_result_7 == int_max);

  // __builtin_sadd_overflow((-2147483647 - 1), -1, &sadd_overflow_result_7) returns 1.
  __VERIFIER_assert(sadd_overflow_overflow_7 == 1);
  ...
  // ILP32: The calculated long maximum must equal int maximum 2147483647.
  // LP64: The calculated long maximum must equal long long maximum 9223372036854775807LL.
  __VERIFIER_assert((sizeof(long int) == sizeof(int) && (int)saddl_overflow_long_max == int_max) ||
         (sizeof(long int) == sizeof(long long int) &&
  ...
  // ILP32: The calculated long minimum must equal int minimum -2147483648.
  // LP64: The calculated long minimum must equal long long minimum -9223372036854775808.
  __VERIFIER_assert((sizeof(long int) == sizeof(int) && (int)saddl_overflow_long_min == int_min) ||
         (sizeof(long int) == sizeof(long long int) &&
  ...
  __VERIFIER_assert(saddl_overflow_result_1 == 0L);

  // __builtin_saddl_overflow(0L, 0L, &saddl_overflow_result_1) returns 0.
  __VERIFIER_assert(saddl_overflow_overflow_1 == 0);
  ...
  __VERIFIER_assert(saddl_overflow_result_2 == saddl_overflow_long_max);
  ...
  __VERIFIER_assert(saddl_overflow_overflow_2 == 0);
  ...
  __VERIFIER_assert(saddl_overflow_result_3 == saddl_overflow_long_min);
  ...
  __VERIFIER_assert(saddl_overflow_overflow_3 == 0);
  ...
  __VERIFIER_assert(saddl_overflow_result_4 == ((long int)((~0UL) >> 1)) - 1L);
  ...
  __VERIFIER_assert(saddl_overflow_overflow_4 == 0);
  ...
  __VERIFIER_assert(saddl_overflow_result_5 == ((-((long int)((~0UL) >> 1)) - 1L)) + 1L);
  ...
  __VERIFIER_assert(saddl_overflow_overflow_5 == 0);
  ...
  __VERIFIER_assert(saddl_overflow_result_6 == saddl_overflow_long_min);
  ...
  __VERIFIER_assert(saddl_overflow_overflow_6 == 1);
  ...
  __VERIFIER_assert(saddl_overflow_result_7 == saddl_overflow_long_max);
  ...
  __VERIFIER_assert(saddl_overflow_overflow_7 == 1);
  ...
  __VERIFIER_assert(saddll_overflow_result_1 == 0LL);

  // __builtin_saddll_overflow(0LL, 0LL, &saddll_overflow_result_1) returns 0.
  __VERIFIER_assert(saddll_overflow_overflow_1 == 0);
  ...
  __VERIFIER_assert(saddll_overflow_result_2 == long_long_max);

  // __builtin_saddll_overflow(9223372036854775807LL, 0LL, &saddll_overflow_result_2) returns 0.
  __VERIFIER_assert(saddll_overflow_overflow_2 == 0);
  ...
  __VERIFIER_assert(saddll_overflow_result_3 == long_long_min);

  // __builtin_saddll_overflow(-9223372036854775808LL, 0LL, &saddll_overflow_result_3) returns 0.
  __VERIFIER_assert(saddll_overflow_overflow_3 == 0);
  ...
  __VERIFIER_assert(saddll_overflow_result_4 == 9223372036854775806LL);

  // __builtin_saddll_overflow(9223372036854775807LL, -1LL, &saddll_overflow_result_4) returns 0.
  __VERIFIER_assert(saddll_overflow_overflow_4 == 0);
  ...
  __VERIFIER_assert(saddll_overflow_result_5 == -long_long_max);

  // __builtin_saddll_overflow(-9223372036854775808LL, 1LL, &saddll_overflow_result_5) returns 0.
  __VERIFIER_assert(saddll_overflow_overflow_5 == 0);
  ...
  __VERIFIER_assert(saddll_overflow_result_6 == long_long_min);

  // __builtin_saddll_overflow(9223372036854775807LL, 1LL, &saddll_overflow_result_6) returns 1.
  __VERIFIER_assert(saddll_overflow_overflow_6 == 1);
  ...
  __VERIFIER_assert(saddll_overflow_result_7 == long_long_max);

  // __builtin_saddll_overflow(-9223372036854775808LL, -1LL, &saddll_overflow_result_7) returns 1.
  __VERIFIER_assert(saddll_overflow_overflow_7 == 1);
  ...
  __VERIFIER_assert(uadd_overflow_result_1 == 0U);

  // __builtin_uadd_overflow(0U, 0U, &uadd_overflow_result_1) returns 0.
  __VERIFIER_assert(uadd_overflow_overflow_1 == 0);
  ...
  __VERIFIER_assert(uadd_overflow_result_2 == unsigned_int_max);

  // __builtin_uadd_overflow(4294967295U, 0U, &uadd_overflow_result_2) returns 0.
  __VERIFIER_assert(uadd_overflow_overflow_2 == 0);
  ...
  __VERIFIER_assert(uadd_overflow_result_3 == unsigned_int_max);

  // __builtin_uadd_overflow(4294967295U - 1U, 1U, &uadd_overflow_result_3) returns 0.
  __VERIFIER_assert(uadd_overflow_overflow_3 == 0);
  ...
  __VERIFIER_assert(uadd_overflow_result_4 == 0U);

  // __builtin_uadd_overflow(4294967295U, 1U, &uadd_overflow_result_4) returns 1.
  __VERIFIER_assert(uadd_overflow_overflow_4 == 1);
  ...
  __VERIFIER_assert(uadd_overflow_result_5 == 1U);

  // __builtin_uadd_overflow(4294967295U, 2U, &uadd_overflow_result_5) returns 1.
  __VERIFIER_assert(uadd_overflow_overflow_5 == 1);
  ...
  __VERIFIER_assert(uadd_overflow_result_6 == 4294967294U);

  // __builtin_uadd_overflow(4294967295U, 4294967295U, &uadd_overflow_result_6) returns 1.
  __VERIFIER_assert(uadd_overflow_overflow_6 == 1);
  ...
  __VERIFIER_assert(uaddl_overflow_result_1 == 0UL);

  // __builtin_uaddl_overflow(0UL, 0UL, &uaddl_overflow_result_1) returns 0.
  __VERIFIER_assert(uaddl_overflow_overflow_1 == 0);
  ...
  __VERIFIER_assert(uaddl_overflow_result_2 == uaddl_overflow_unsigned_long_max);
  ...
  __VERIFIER_assert(uaddl_overflow_overflow_2 == 0);
  ...
  __VERIFIER_assert(uaddl_overflow_result_3 == uaddl_overflow_unsigned_long_max);
  ...
  __VERIFIER_assert(uaddl_overflow_overflow_3 == 0);
  ...
  __VERIFIER_assert(uaddl_overflow_result_4 == 0UL);
  ...
  __VERIFIER_assert(uaddl_overflow_overflow_4 == 1);
  ...
  __VERIFIER_assert(uaddl_overflow_result_5 == 1UL);
  ...
  __VERIFIER_assert(uaddl_overflow_overflow_5 == 1);
  ...
  __VERIFIER_assert(uaddl_overflow_result_6 == (~0UL) - 1UL);
  ...
  __VERIFIER_assert(uaddl_overflow_overflow_6 == 1);
  ...
  __VERIFIER_assert(uaddll_overflow_result_1 == 0ULL);

  // __builtin_uaddll_overflow(0ULL, 0ULL, &uaddll_overflow_result_1) returns 0.
  __VERIFIER_assert(uaddll_overflow_overflow_1 == 0);
  ...
  __VERIFIER_assert(uaddll_overflow_result_2 == unsigned_long_long_max);

  // __builtin_uaddll_overflow(18446744073709551615ULL, 0ULL, &uaddll_overflow_result_2) returns 0.
  __VERIFIER_assert(uaddll_overflow_overflow_2 == 0);
  ...
  __VERIFIER_assert(uaddll_overflow_result_3 == unsigned_long_long_max);

  // __builtin_uaddll_overflow(18446744073709551614ULL, 1ULL, &uaddll_overflow_result_3) returns 0.
  __VERIFIER_assert(uaddll_overflow_overflow_3 == 0);
  ...
  __VERIFIER_assert(uaddll_overflow_result_4 == 0ULL);

  // __builtin_uaddll_overflow(18446744073709551615ULL, 1ULL, &uaddll_overflow_result_4) returns 1.
  __VERIFIER_assert(uaddll_overflow_overflow_4 == 1);
  ...
  __VERIFIER_assert(uaddll_overflow_result_5 == 1ULL);

  // __builtin_uaddll_overflow(18446744073709551615ULL, 2ULL, &uaddll_overflow_result_5) returns 1.
  __VERIFIER_assert(uaddll_overflow_overflow_5 == 1);
  ...
  __VERIFIER_assert(uaddll_overflow_result_6 == 18446744073709551614ULL);

  // __builtin_uaddll_overflow(18446744073709551615ULL, 18446744073709551615ULL, &uaddll_overflow_result_6) returns 1.
  __VERIFIER_assert(uaddll_overflow_overflow_6 == 1);
  return 0;
}
