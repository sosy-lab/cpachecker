...
int main(void) {
  ...
  // LP64: 4294967295UL + 1UL = 4294967296UL; carry-out = 0UL because the sum fits in unsigned long.
  unsigned long int model_addcl_carry_out;
  (void)__builtin_addcl(4294967295UL, 1UL, 0UL, &model_addcl_carry_out);
  all_expected_checks_fail = all_expected_checks_fail || (model_addcl_carry_out != 0UL);
  ...
  // 0UL + 0UL + carry-in 0UL = 0; result = 0UL and carry-out = 0UL because 0 <= 18446744073709551615UL.
  ...
  // 18446744073709551615UL + 0UL + carry-in 0UL = 18446744073709551615; result = 18446744073709551615UL and carry-out = 0UL because
  ...
  // 1UL + 2UL + carry-in 1UL = 4; result = 4UL and carry-out = 0UL because 4 <= 18446744073709551615UL.
  ...
  // 18446744073709551615UL + 1UL + carry-in 0UL = 18446744073709551616; stored result = 0UL and carry-out = 1UL because
  // 18446744073709551616 > 18446744073709551615UL.
  ...
  // 18446744073709551615UL + 0UL + carry-in 1UL = 18446744073709551616; stored result = 0UL and carry-out = 1UL because
  // 18446744073709551616 > 18446744073709551615UL.
  ...
  // 18446744073709551615UL + 18446744073709551615UL + carry-in 2UL = 36893488147419103232; stored result = 0UL and carry-out = 1UL because
  // 36893488147419103232 > 18446744073709551615UL.
  ...
  // 1UL + 0UL + carry-in 18446744073709551615UL = 18446744073709551616; stored result = 0UL and carry-out = 1UL because
  // 18446744073709551616 > 18446744073709551615UL.
