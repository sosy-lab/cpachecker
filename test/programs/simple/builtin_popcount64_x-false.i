...
void reach_error() { ((0) ? (void) (0) : __assert_fail ("0", "builtin_popcount64_x-false.c", 13, __extension__ __PRETTY_FUNCTION__)); }
...
int test_popcountll() {
  ...
  int res28 = __builtin_popcountll(test_longDongMinPlusOne) != 2;
