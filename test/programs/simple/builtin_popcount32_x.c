...
void test_popcountl() {
  ...
  assert(__builtin_popcountl(test_longMax) == 31);
  assert(__builtin_popcountl(test_longMin) == 1);
  assert(__builtin_popcountl(test_longMinPlusOne) == 2);
  assert(__builtin_popcountl(test_ulongMax) == 32);
  assert(__builtin_popcountl(test_ulongMaxMinusOne) == 31);
}
...
void test_popcountll() {
  ...
  assert(__builtin_popcountll(test_longLongMinusOne) == 64);
