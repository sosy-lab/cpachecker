# 0 "fscanf_long_read_li.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "fscanf_long_read_li.c"
...
# 9 "fscanf_long_read_li.c" 2


# 10 "fscanf_long_read_li.c"
extern void __assert_fail(const char *, const char *, unsigned int, const char *) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__noreturn__));
void reach_error() { __assert_fail("0", "fscanf_long_read_li.c", 3, "reach_error"); }

int main() {
long i = 0;

fscanf(
# 16 "fscanf_long_read_li.c" 3 4
      stdin
# 16 "fscanf_long_read_li.c"
           ,"%li", &i);
