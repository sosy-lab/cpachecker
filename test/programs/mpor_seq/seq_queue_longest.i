...
int main(void) {
  ...
  while (execute) {
    ...
    if (next_thread == 0) {
      ...
      switch (pc[1]) {
        case 0: pc[1] = 3; continue;
        case 3: __g_14_m_locked = 1; pc[1] = 4; continue;
        case 4: __t1_27_value = __VERIFIER_nondet_int(); pc[1] = 5; continue;
        case 5: pc[1] = 6; continue;
        case 6: __p1_24_q = &__g_18_queue;  __p1_25_x = __t1_27_value;  pc[1] = 27; __return_pc_t1_enqueue = 7;  continue;
        ...
        case 10: __p1_26_q = &__g_18_queue;  pc[1] = 49; __return_pc_t1_empty = 11;  continue;
        ...
        case 50: if (!((__p1_26_q->head) == (__p1_26_q->tail))) { pc[1] = 54;  }else if ((__p1_26_q->head) == (__p1_26_q->tail)) { pc[1] = 51;  }continue;
        ...
        case 55: pc[1] = 44; continue;
      }

    } else if (next_thread == 2) {
      switch (pc[2]) {
        case 0: pc[2] = 3; continue;
