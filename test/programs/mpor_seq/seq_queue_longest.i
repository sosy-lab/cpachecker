  ...
  while (execute) {
    ...
    if (next_thread == 0) {
      ...
      switch (pc[1]) {
        ...
        case 17: if (!(__g_16_enqueue_flag == 0)) { pc[1] = 21;  }else if (__g_16_enqueue_flag == 0) { pc[1] = 18;  }continue;
      ...
      switch (pc[2]) {
        ...
        case 4: if (!(__t2_34_i < 800)) { pc[2] = 37;  }else if (__t2_34_i < 800) { pc[2] = 5;  }continue;
