...
{ int s__info_callback ;
  ...
  tmp = input();
  s__info_callback = input();
  s__ctx__info_callback = input();
  tmp___1 = input();
  tmp___2 = input();
  tmp___3 = input();
  tmp___4 = input();
  ...
  tmp___10 = input();
  s__cert = input();
  s__s3__tmp__reuse_message = input();
  s__debug = input();
  s__hit = input();
  s__s3__tmp__new_cipher__algorithms = input();
  s__options = input();
  s__cert__pkeys__AT0__privatekey = input();
  s__verify_mode = input();
  s__session__peer = input();
  s__s3__tmp__new_cipher__algo_strength = input();
  s__s3__tmp__new_cipher = input();
  num1 = input();
