...
{ int status ;
  ...
  DisketteExtension__PoweringDown = input();
  DisketteExtension__ThreadReferenceCount = input();
...
{ int DeviceObject__DeviceExtension ;
  ...
  // initialization added by ah
  DeviceObject__DeviceExtension = input();
  Irp__Tail__Overlay__CurrentStackLocation = input();
  disketteExtension__IsRemoved = input();
  disketteExtension__IsStarted = input();
  disketteExtension__FloppyThread = input();
  disketteExtension__InterfaceString__Buffer = input();
  disketteExtension__ArcName__Length = input();
  doneEvent = input();
  irpSp__MinorFunction = input();
...
{ int DeviceObject__DeviceExtension ;
  ...
  doneEvent = input();
  fdcInfo = input();
  fdcInfo__MaxTransferSize = input();
  fdcInfo__AcpiBios = input();
  fdcInfo__UnitNumber = input();
  fdcInfo__AcpiFdiSupported = input();
  fdcInfo__PeripheralNumber = input();
  disketteExtension__DriveType = input();
  KUSER_SHARED_DATA__AlternativeArchitecture_NEC98x86 = input();
...
{ int disketteExtension__HoldNewRequests ;
  ...
  // initialization added by ah
  disketteExtension__AcrName__Length = input();
  disketteExtension__HoldNewRequests = input();
  disketteExtension__IsRemoved = input();
  disketteExtension__IsStarted = input();
  disketteExtension__InterfaceString__Buffer = input();
  irpSp__Parameters__DeviceIoControl__OutputBufferLength = input();
  sizeof__MOUNTDEV_UNIQUE_ID = input();
  __cil_tmp39 = input();
  __cil_tmp40 = input();
  __cil_tmp41 = input();
  __cil_tmp42 = input();
  ...
  __cil_tmp90 = input();
  __cil_tmp91 = input();
  irpSp__Parameters__DeviceIoControl__IoControlCode___1 = input();
  irpSp__Parameters__DeviceIoControl__InputBufferLength = input();
  sizeof__FORMAT_PARAMETERS = input();
  sizeof__MOUNTDEV_NAME = input();
  Irp__AssociatedIrp__SystemBuffer = input();
  disketteExtension__DeviceName__Length = input();
  sizeof__USHORT = input();
  sizeof__DISK_GEOMETRY = input();
  sizeof__FORMAT_EX_PARAMETERS = input();
  disketteExtension__InterfaceString__Length = input();
  formatExParametersSize = input();
  formatExParameters__FormatGapLength = input();
  formatExParameters__SectorsPerTrack = input();
  highestDriveMediaType = input();
  lowestDriveMediaType = input();
...
{ int DriveMediaConstants__driveMediaType__MediaType ;
  ...
  // initialization added by ah
  FormatParameters__MediaType = input();
  DriveMediaConstants__driveMediaType__MediaType = input();
  FAKE_CONDITION = input();
