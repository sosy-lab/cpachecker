...
{ int Irp__Tail__Overlay__CurrentStackLocation ;
  ...
  irpSp__Parameters__UsageNotification__Type = input();
  irpSp__Parameters__UsageNotification__InPath = input();
  deviceExtension__PagingPathCount = input();
...
{ int deviceExtension__PlayActive ;
  ...
  // initialization added by ah
  deviceExtension__PlayActive = input();
  currentBuffer = input();
  irp_CdAudioIsPlayActive = input();
  status = input();
  ioStatus__Status = input();
  currentBuffer__Header__AudioStatus = input();
...
{ int Irp__Tail__Overlay__CurrentStackLocation ;
  ...
  currentIrpStack__Parameters__DeviceIoControl__InputBufferLength = input();
  sizeof__SUB_Q_CURRENT_POSITION = input();
  sizeof__CDROM_SEEK_AUDIO_MSF = input();
  sizeof__CDROM_PLAY_AUDIO_MSF = input();
  SubQPtr = input();
  userPtr__Format = input();
  lastSession = input();
  Toc = input();
  inputBuffer__EndingM = input();
  inputBuffer__StartingM = input();
  inputBuffer__EndingS = input();
  inputBuffer__StartingS = input();
  inputBuffer__EndingF = input();
  inputBuffer__StartingF = input();
