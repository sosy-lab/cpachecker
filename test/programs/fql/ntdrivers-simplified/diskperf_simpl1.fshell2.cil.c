...
{ int DeviceObject__DeviceExtension ;
  ...
  // initialization added by ah
  DeviceObject__DeviceExtension = input();
  deviceExtension__WmilibContext = input();
...
{ int Irp__CurrentLocation ;
  ...
  DeviceObject__DeviceExtension = input();
  Irp__Tail__Overlay__CurrentStackLocation = input();
  currentIrpStack__Parameters__DeviceIoControl__IoControlCode = input();
  currentIrpStack__Parameters__DeviceIoControl__OutputBufferLength = input();
  sizeof__DISK_PERFORMANCE = input();
  deviceExtension__DiskCounters = input();
  Irp__AssociatedIrp__SystemBuffer = input();
  deviceExtension__Processors = input();
  deviceExtension__QueueDepth = input();
...
{ int DeviceObject__DeviceExtension ;
  ...
  output = input();
  ioStatus__Status = input();
  output__NameLength = input();
  volumeNumber__VolumeManagerName__0 = input();
