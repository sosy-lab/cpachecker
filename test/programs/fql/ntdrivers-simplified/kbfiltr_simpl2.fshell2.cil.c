...
{ int irpStack__MajorFunction ;
  ...
  // initialization added by ah
  irpStack__MajorFunction = input();
  devExt__UpperConnectData__ClassService = input();
...
{ int Irp__IoStatus__Information ;
  ...
  __cil_tmp44 = input();
  __cil_tmp45 = input();
  irpStack__Parameters__DeviceIoControl__IoControlCode = input();
  irpStack__Parameters__DeviceIoControl__InputBufferLength = input();
  irpStack__Parameters__DeviceIoControl__Type3InputBuffer = input();
  devExt__UpperConnectData__ClassService = input();
  sizeof__CONNECT_DATA = input();
  sizeof__INTERNAL_I8042_HOOK_KEYBOARD = input();
  hookKeyboard__InitializationRoutine = input();
  hookKeyboard__IsrRoutine = input();
