...
{ int deviceExtension__Active = __VERIFIER_nondet_int() ;
  ...
  {
  {
  status2 = CdAudioForwardIrpSynchronous(DeviceObject, Irp);
  }
  {
  if (status2 < 0) {
    return (status2);
  ...
  if (deviceExtension__Active == 255) {
    ...
    while (1) {
      ...
      {
      status2 = SendSrbSynchronous(deviceExtension, srb, inquiryDataPtr, 36);
      }
    }
  ...
  if (irpSp__MinorFunction == 0) {
    ...
    if (irpSp__MinorFunction == 22) {
      ...
      if (0) {
        switch_1_0: 
        {
        status3 = CdAudioStartDevice(DeviceObject, Irp);
        ...
        {
        status3 = KeWaitForSingleObject(deviceExtension__PagingPathCountEvent, Executive,
                                       KernelMode, 0, 0);
        setPagable = 0;
        }
        ...
        {
        status3 = CdAudioForwardIrpSynchronous(DeviceObject, Irp);
        }
        if (status3 >= 0) {
          if (irpSp__Parameters__UsageNotification__InPath) {
      ...
      if (deviceExtension__Active == 1) {
        ...
        if (deviceExtension__Active == 7) {
          ...
          if (0) {
            switch_2_2: 
            {
            status4 = CdAudio535DeviceControl(DeviceObject, Irp);
            }
            goto switch_2_break;
            switch_2_3: 
            {
            status4 = CdAudio435DeviceControl(DeviceObject, Irp);
            }
            goto switch_2_break;
            switch_2_1: 
            {
            status4 = CdAudioAtapiDeviceControl(DeviceObject, Irp);
            }
            goto switch_2_break;
            switch_2_7: 
            {
            status4 = CdAudioHPCdrDeviceControl(DeviceObject, Irp);
            }
            goto switch_2_break;
            switch_2_default: 
            {
            deviceExtension__Active = 0;
            status4 = CdAudioSendToNextDriver(DeviceObject, Irp);
            }
          } else {
            switch_2_break: ;
          }
...
{ int Irp__Tail__Overlay__CurrentStackLocation = __VERIFIER_nondet_int() ;
                    ...
                    if (currentIrpStack__Parameters__DeviceIoControl__IoControlCode == __cil_tmp105) {
                      ...
                      if (0) {
                        ...
                        if (lastSession == 0) {
                          ...
                          status6 = -1073741670;
                          Irp__IoStatus__Information = 0;
                          tmp___0 = AG_SetStatusAndReturn(status6, Irp, deviceExtension__TargetDeviceObject);
                          }
                          return (tmp___0);
                        }
                        {
                        ...
                        status6 = SendSrbSynchronous(deviceExtension, srb, lastSession,
                        ...
                        if (status6 < 0) {
                          {
                          Irp__IoStatus__Information = 0;
                          tmp___1 = AG_SetStatusAndReturn(status6, Irp, deviceExtension__TargetDeviceObject);
                          }
                          return (tmp___1);
                        } else {
                          status6 = 0;
                        ...
                        if (Toc == 0) {
                          ...
                          status6 = -1073741670;
                          Irp__IoStatus__Information = 0;
                          tmp___3 = AG_SetStatusAndReturn(status6, Irp, deviceExtension__TargetDeviceObject);
                          }
                          return (tmp___3);
                        }
                        {
                        srb__TimeOutValue = 10;
                        srb__CdbLength = 10;
                        status6 = SendSrbSynchronous(deviceExtension, srb, Toc, sizeof__CDROM_TOC);
                        }
                        if (status6 >= 0) {
                          {
                          ...
                          if (__cil_tmp108 != -1073741764) {
                            {
                            Irp__IoStatus__Information = 0;
                            tmp___4 = AG_SetStatusAndReturn(status6, Irp, deviceExtension__TargetDeviceObject);
                            }
                            return (tmp___4);
                          }
                          }
                        ...
                        if (SubQPtr == 0) {
                          ...
                          status6 = -1073741670;
                          Irp__IoStatus__Information = 0;
                          tmp___5 = AG_SetStatusAndReturn(status6, Irp, deviceExtension__TargetDeviceObject);
                          }
                          return (tmp___5);
                        }
                        if (userPtr__Format != 1) {
                          ...
                          status6 = -1073741823;
                          Irp__IoStatus__Information = 0;
                          tmp___6 = AG_SetStatusAndReturn(status6, Irp, deviceExtension__TargetDeviceObject);
                          }
                          return (tmp___6);
                        }
                        {
                        srb__CdbLength = 10;
                        srb__TimeOutValue = 10;
                        status6 = SendSrbSynchronous(deviceExtension, srb, SubQPtr,
                        ...
                        srb__CdbLength = 10;
                        srb__TimeOutValue = 10;
                        status6 = SendSrbSynchronous(deviceExtension, srb, 0, 0);
                        }
                        if (status6 >= 0) {
  ...
  {
  tmp___8 = AG_SetStatusAndReturn(status6, Irp, deviceExtension__TargetDeviceObject);
  }
  return (tmp___8);
}
}
                      ...
                      if (currentIrpStack__Parameters__DeviceIoControl__IoControlCode == __cil_tmp87) {
                        ...
                        if (currentIrpStack__Parameters__DeviceIoControl__IoControlCode == __cil_tmp92) {
                          ...
                          if (0) {
                            ...
                            srb__TimeOutValue = 10;
                            srb__CdbLength = 10;
                            status7 = SendSrbSynchronous(deviceExtension, srb, Toc,
                                                        sizeof__CDROM_TOC);
                            }
                            {
                            if (status7 < 0) {
                            ...
                            srb__CdbLength = 10;
                            srb__TimeOutValue = 10;
                            status7 = SendSrbSynchronous(deviceExtension, srb, 0, 0);
                            }
                            if (status7 >= 0) {
                            ...
                            srb__CdbLength = 10;
                            srb__TimeOutValue = 10;
                            status7 = SendSrbSynchronous(deviceExtension, srb, SubQPtr,
                            ...
                            srb__CdbLength = 10;
                            srb__TimeOutValue = 10;
                            status7 = SendSrbSynchronous(deviceExtension, srb, SubQPtr___0,
                                                        sizeof__SUB_Q_CHANNEL_DATA);
                            }
                            if (status7 >= 0) {
                              if (deviceExtension__Paused == 1) {
...
{ int currentIrpStack__Parameters__DeviceIoControl__IoControlCode = __VERIFIER_nondet_int() ;
  ...
  if (currentIrpStack__Parameters__DeviceIoControl__IoControlCode == __cil_tmp17) {
    ...
    srb__CdbLength = 12;
    srb__TimeOutValue = 10;
    status8 = SendSrbSynchronous(deviceExtension, srb, 0, 0);
    }
    {
    if (status8 < 0) {
      {
...
{ int deviceExtension__TargetDeviceObject = __VERIFIER_nondet_int() ;
  ...
  {
  irpSp__Control = 224;
  status9 = IofCallDriver(deviceExtension__TargetDeviceObject, Irp);
  status9 = 259;
  }
  if (status9) {
    {
	...
	tmp_ndt_3 = __VERIFIER_nondet_int();
        if (tmp_ndt_3 == 4) {
          ...
          if (0) {
            switch_5_2: 
            {
            status10 = CdAudioDeviceControl(devobj, pirp);
            }
            goto switch_5_break;
            switch_5_3: 
            {
            status10 = CdAudioPnp(devobj, pirp);
            }
            goto switch_5_break;
            switch_5_4: 
            {
            status10 = CdAudioPower(devobj, pirp);
            }
            goto switch_5_break;
            switch_5_default: ;
            return (-1);
