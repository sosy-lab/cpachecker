  ...
  if (irpSp__MinorFunction == 0) {
    ...
    if (irpSp__MinorFunction == 2) {
      ...
      if (0) {
        switch_0_0: 
        {
        status1 = DiskPerfStartDevice(DeviceObject, Irp);
        }
        goto switch_0_break;
        switch_0_2: 
        {
        status1 = DiskPerfRemoveDevice(DeviceObject, Irp);
        }
        goto switch_0_break;
        switch_0_default: 
        {
...
{ int DeviceObject__DeviceExtension = __VERIFIER_nondet_int() ;
  ...
  status2 = DiskPerfForwardIrpSynchronous(DeviceObject, Irp);
...
{ int DeviceObject__DeviceExtension = __VERIFIER_nondet_int() ;
  ...
  status3 = DiskPerfForwardIrpSynchronous(DeviceObject, Irp);
...
{ int Irp__Tail__Overlay__CurrentStackLocation = __VERIFIER_nondet_int() ;
  ...
  irpSp__Control = 224;
  status4 = IofCallDriver(deviceExtension__TargetDeviceObject, Irp);
  }
  {
...
{ int DeviceObject__DeviceExtension = __VERIFIER_nondet_int() ;
  ...
  {
  status6 = IofCallDriver(deviceExtension__TargetDeviceObject, irp);
  }
  {
	    ...
	    tmp_ndt_5 = __VERIFIER_nondet_int();
            if (tmp_ndt_5 == 12) {
              ...
              if (0) {
                switch_2_0: 
                {
                status7 = DiskPerfCreate(devobj, pirp);
                }
                goto switch_2_break;
                switch_2_2: 
                {
                status7 = DiskPerfDeviceControl(devobj, pirp);
                }
                goto switch_2_break;
                switch_2_3: 
                {
                status7 = DiskPerfDispatchPnp(devobj, pirp);
                }
                goto switch_2_break;
                switch_2_4: 
                {
                status7 = DiskPerfDispatchPower(devobj, pirp);
                }
                goto switch_2_break;
                switch_2_12: 
                {
                status7 = DiskPerfShutdownFlush(devobj, pirp);
                }
                goto switch_2_break;
                switch_2_default: ;
                return (-1);
