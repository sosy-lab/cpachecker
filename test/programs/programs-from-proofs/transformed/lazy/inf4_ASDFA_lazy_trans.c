...
equilateral = 1;
s = 0;
 __return_622 = ((equilateral + isoscles) + triangle) + scalene;
return 1;
}
else 
{
...
{
s = 0;
 __return_625 = ((equilateral + isoscles) + triangle) + scalene;
return 1;
}
}
}
...
isoscles = 1;
s = 0;
 __return_623 = ((equilateral + isoscles) + triangle) + scalene;
return 1;
}
else 
{
...
{
s = 0;
 __return_624 = ((equilateral + isoscles) + triangle) + scalene;
return 1;
}
}
}
