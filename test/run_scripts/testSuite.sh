...
testsPositive="benchmarks/lu-fig2.fixed-restarting.sh benchmarks/lu-fig4-complete.fixed-restarting.sh benchmarks/read_write_lock-restarting.sh  various/mutex-safe-restarting.sh various/simple-safe-modular-restarting.sh benchmarks/naivebakery-restarting.sh"
