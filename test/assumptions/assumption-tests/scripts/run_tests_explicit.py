...
def run_single(benchmark, config, time_limit, mem_limit):
    ...
    retval = p.wait()
    tot_time, outcome, reached, maxheap = None, None, None, None
    ...
    if outcome is None:
        outcome = 'UNKNOWN'
    return tot_time, outcome, reached, maxheap
