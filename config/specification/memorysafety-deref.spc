...
STATE USEFIRST Init :
  CHECK("has-invalid-writes") -> ERROR("valid-deref: invalid pointer dereference in $location");
  CHECK("has-invalid-reads") -> ERROR("valid-deref: invalid pointer dereference in $location");
