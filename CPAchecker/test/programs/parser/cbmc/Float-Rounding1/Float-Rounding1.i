...
# 134 "/usr/include/fenv.h" 3 4

# 4 "Float-Rounding1/main.c" 2
...
void roundingTest (float f1, float f2) {
  ...
  ((roundToNearestSum == 0x1.000002p+0f) ? (void) (0) : __assert_fail ("roundToNearestSum == 0x1.000002p+0f", "Float-Rounding1/main.c", 17, __PRETTY_FUNCTION__));
  ...
  ((roundDownSum == 0x1.0p+0f) ? (void) (0) : __assert_fail ("roundDownSum == 0x1.0p+0f", "Float-Rounding1/main.c", 24, __PRETTY_FUNCTION__));
