...
# This script will download and build mpfr-java with its dependencies GMP and MPFR and copy the
# libraries to the CPAchecker /lib directory.
#
# It is meant to be run inside a podman container. Please refer to the README file in this folder
