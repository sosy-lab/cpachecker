...
JNIEXPORT jobject JNICALL Java_org_sosy_1lab_cpachecker_util_floatingpoint_CFloatNativeAPI_fdimFp(JNIEnv* env, jclass cl, jobject wrapper1, jint type1, jobject wrapper2, jint type2) {
	t_ld fp_1 = transformWrapperFromJava(env, wrapper1, type1);
	t_ld fp_2 = transformWrapperFromJava(env, wrapper2, type2);
	...
	switch(maxType) {
		case org_sosy_lab_cpachecker_util_floatingpoint_CFloatNativeAPI_FP_TYPE_SINGLE:
			result.f_value = fdimf(fp_1.f_value, fp_2.f_value);
			break;
		case org_sosy_lab_cpachecker_util_floatingpoint_CFloatNativeAPI_FP_TYPE_DOUBLE:
			result.d_value = fdim(chooseOf2(type1, fp_1), chooseOf2(type2, fp_2));
			break;
		case org_sosy_lab_cpachecker_util_floatingpoint_CFloatNativeAPI_FP_TYPE_LONG_DOUBLE:
			result.ld_value = fdiml(chooseOf3(type1, fp_1), chooseOf3(type2, fp_2));
			break;
		default:
			throwException(env, EX_TEXT);
	}
...
JNIEXPORT jobject JNICALL Java_org_sosy_1lab_cpachecker_util_floatingpoint_CFloatNativeAPI_fminFp(JNIEnv* env, jclass cl, jobject wrapper1, jint type1, jobject wrapper2, jint type2) {
	t_ld fp_1 = transformWrapperFromJava(env, wrapper1, type1);
	t_ld fp_2 = transformWrapperFromJava(env, wrapper2, type2);
	...
	switch(maxType) {
		case org_sosy_lab_cpachecker_util_floatingpoint_CFloatNativeAPI_FP_TYPE_SINGLE:
			result.f_value = fminf(fp_1.f_value, fp_2.f_value);
			break;
		case org_sosy_lab_cpachecker_util_floatingpoint_CFloatNativeAPI_FP_TYPE_DOUBLE:
			result.d_value = fmin(chooseOf2(type1, fp_1), chooseOf2(type2, fp_2));
			break;
		case org_sosy_lab_cpachecker_util_floatingpoint_CFloatNativeAPI_FP_TYPE_LONG_DOUBLE:
			result.ld_value = fminl(chooseOf3(type1, fp_1), chooseOf3(type2, fp_2));
			break;
		default:
			throwException(env, EX_TEXT);
	}
...
JNIEXPORT jobject JNICALL Java_org_sosy_1lab_cpachecker_util_floatingpoint_CFloatNativeAPI_fmaxFp(JNIEnv* env, jclass cl, jobject wrapper1, jint type1, jobject wrapper2, jint type2) {
	t_ld fp_1 = transformWrapperFromJava(env, wrapper1, type1);
	t_ld fp_2 = transformWrapperFromJava(env, wrapper2, type2);
	...
	switch(maxType) {
		case org_sosy_lab_cpachecker_util_floatingpoint_CFloatNativeAPI_FP_TYPE_SINGLE:
			result.f_value = fmaxf(fp_1.f_value, fp_2.f_value);
			break;
		case org_sosy_lab_cpachecker_util_floatingpoint_CFloatNativeAPI_FP_TYPE_DOUBLE:
			result.d_value = fmax(chooseOf2(type1, fp_1), chooseOf2(type2, fp_2));
			break;
		case org_sosy_lab_cpachecker_util_floatingpoint_CFloatNativeAPI_FP_TYPE_LONG_DOUBLE:
			result.ld_value = fmaxl(chooseOf3(type1, fp_1), chooseOf3(type2, fp_2));
			break;
		default:
			throwException(env, EX_TEXT);
	}
...
JNIEXPORT jobject JNICALL Java_org_sosy_1lab_cpachecker_util_floatingpoint_CFloatNativeAPI_modfFp(JNIEnv* env, jclass cl, jobject wrapper, jint type) {
	t_ld fp = transformWrapperFromJava(env, wrapper, type);
	...
	switch(type) {
		case org_sosy_lab_cpachecker_util_floatingpoint_CFloatNativeAPI_FP_TYPE_SINGLE:
		        float integerPartf = 0;
			result.f_value = modff(fp.f_value, &integerPartf);
			break;
		case org_sosy_lab_cpachecker_util_floatingpoint_CFloatNativeAPI_FP_TYPE_DOUBLE:
			double integerPart = 0;
			result.d_value = modf(fp.d_value, &integerPart);
			break;
		case org_sosy_lab_cpachecker_util_floatingpoint_CFloatNativeAPI_FP_TYPE_LONG_DOUBLE:
			long double integerPartl = 0;
			result.ld_value = modfl(fp.ld_value, &integerPartl);
			break;
		default:
			throwException(env, EX_TEXT);
	}
