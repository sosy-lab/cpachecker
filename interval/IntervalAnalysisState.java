...
public class IntervalAnalysisState
    implements Serializable,
        ...
        PseudoPartitionable, ForgetfulState<IntervalAnalysisInformation>{
  ...
  public IntervalAnalysisState(
    ...
    this.referenceCounts = pReferencesMap;
  }

  public IntervalAnalysisState(PersistentMap<String, Interval> pIntervals) {
    this.intervals = pIntervals;
    referenceCounts = PathCopyingPersistentTreeMap.of();
  }
  ...
  public PersistentMap<String, Interval> getPersistentIntervalMap() {
    return intervals;
  }
  ...
  public static IntervalAnalysisState copyOf(IntervalAnalysisState state) {
    return new IntervalAnalysisState(state.intervals, state.referenceCounts);
  }
  ...
  public IntervalAnalysisInformation forget(MemoryLocation memoryLocation) {
    ...
    PersistentMap<String, Interval> putThis = PathCopyingPersistentTreeMap.of();
    putThis = putThis.putAndCopy(mem, interval);

    return new IntervalAnalysisInformation(putThis);
  }

  @Override
  public void remember(final MemoryLocation pLocation, final IntervalAnalysisInformation pInformation){
  ...
  public Set<MemoryLocation> getTrackedMemoryLocations(){
    ...
    for (String mem : intervals.keySet())
      result.add(MemoryLocation.valueOf(mem));
    return result;
  }

  @Override
  public int getSize(){return intervals.size();}
