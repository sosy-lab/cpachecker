...
var functions = ["main"];
var fCallEdges = {};
var cfaInfo = {"edges":{"5->0":{"source":5,"file":"..\/Schreibtisch\/correctExample.c","stmt":"int main(int argc, char *argv[]); Function start dummy edge int i = 2; return 0;","target":0,"line":1,"type":"MultiEdge"},"1->5":{"source":1,"file":"<none>","stmt":"INIT GLOBAL VARS","target":5,"line":0,"type":"BlankEdge"}},"nodes":{"0":{"no":0,"func":"main"},"1":{"no":1,"func":"main"},"5":{"no":5,"func":"main"}}};
var errorPathData = {}; //ERRORPATH
var combinedNodes = {};
var sourceFiles = ["../Schreibtisch/correctExample.c"];
