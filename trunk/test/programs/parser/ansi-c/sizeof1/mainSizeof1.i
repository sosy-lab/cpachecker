...
# 2 "sizeof1/main.c" 2
# 32 "sizeof1/main.c"
int some_array__LINE__[(sizeof(void *)==sizeof(long int)) ? 1 : -1];;
int some_array__LINE__[(sizeof(int)==4) ? 1 : -1];;
int some_array__LINE__[(sizeof(long int)==4 || sizeof(long int)==8) ? 1 : -1];;
int some_array__LINE__[(sizeof(long long int)==8) ? 1 : -1];;
int some_array__LINE__[(sizeof(wchar_t)==4) ? 1 : -1];;
int some_array__LINE__[(sizeof(float)==4) ? 1 : -1];;
int some_array__LINE__[(sizeof(double)==8) ? 1 : -1];;
int some_array__LINE__[(sizeof(long double)>=sizeof(double)) ? 1 : -1];;
