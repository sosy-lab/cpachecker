// SPDX-FileCopyrightText: 2001 hereUare Communications, Inc. <raghud@hereuare.com>
// SPDX-FileCopyrightText: 2003 Alan DeKok <aland@freeradius.org>
//
...
static int eaptls_detach(void *arg)
{
  ...
  conf->check_cert_cn = malloc(10UL);
  strcpy(conf->check_cert_cn, "TEST");
