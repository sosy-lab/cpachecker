# 1 "../versisec/bind/progs1/bindCA-1999-14rrextract-nxt_expands_vars_bad.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../versisec/bind/progs1/bindCA-1999-14rrextract-nxt_expands_vars_bad.c"
...
# 3 "../versisec/bind/progs1/bindCA-1999-14rrextract-nxt_expands_vars_bad.c" 2
...
rrextract(u_char *msg, int msglen, u_char *rrp, u_char *dname, int namelen)
{
  ...
  int n;
  u_int32_t ttl;
  u_char data[2*2 + 2*2 + 4 + 2];
  data [(2*2) + 2*2 + 4 + 2 - 1] = 0;
  ...
  ((dlen - n <= sizeof data - (strlen((char *)data) + 1)) ? (void) (0) : __assert_fail ("dlen - n <= sizeof data - (strlen((char *)data) + 1)", "../versisec/bind/progs1/bindCA-1999-14rrextract-nxt_expands_vars_bad.c", 61, __PRETTY_FUNCTION__));
