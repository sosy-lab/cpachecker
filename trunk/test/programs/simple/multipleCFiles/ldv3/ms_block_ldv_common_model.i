# 1 "/work/ldvuser/mutilin/launch/work/current--X--drivers--X--defaultlinux-3.17-rc1.tar.xz--X--32_7a--X--cpachecker/linux-3.17-rc1.tar.xz/csd_deg_dscv/2246/dscv_tempdir/rule-instrumentor/32_7a/common-model/ldv_common_model.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 1 "<command-line>" 2
# 1 "/home/ldvuser/ldv/inst/kernel-rules/models/config-tracers.h" 1
# 1 "<command-line>" 2
# 1 "/work/ldvuser/mutilin/launch/work/current--X--drivers--X--defaultlinux-3.17-rc1.tar.xz--X--32_7a--X--cpachecker/linux-3.17-rc1.tar.xz/csd_deg_dscv/2246/dscv_tempdir/rule-instrumentor/32_7a/common-model/ldv_common_model.c"
...
# 148 "./arch/x86/include/asm/segment.h"
# 1 "./arch/x86/include/asm/cache.h" 1
# 149 "./arch/x86/include/asm/segment.h" 2
...
# 229 "./arch/x86/include/asm/pgtable_types.h"
...
# 230 "./arch/x86/include/asm/pgtable_types.h" 2
...
# 39 "./arch/x86/include/asm/spinlock_types.h" 2
# 332 "./arch/x86/include/asm/paravirt_types.h" 2
...
# 675 "./arch/x86/include/asm/paravirt_types.h"
...
# 65 "./arch/x86/include/asm/ptrace.h" 2
...
# 132 "./arch/x86/include/asm/alternative.h"
...
# 251 "./arch/x86/include/asm/cpufeature.h"
# 1 "include/linux/bitops.h" 1
# 252 "./arch/x86/include/asm/cpufeature.h" 2
...
# 133 "./arch/x86/include/asm/alternative.h" 2
# 213 "./arch/x86/include/asm/alternative.h"
struct paravirt_patch_site;
...
static inline __attribute__((no_instrument_function)) void __attribute__((deprecated)) smp_mb__before_clear_bit(void)
{
...
static inline __attribute__((no_instrument_function)) void __attribute__((deprecated)) smp_mb__after_clear_bit(void)
{
...
# 4 "/work/ldvuser/mutilin/launch/work/current--X--drivers--X--defaultlinux-3.17-rc1.tar.xz--X--32_7a--X--cpachecker/linux-3.17-rc1.tar.xz/csd_deg_dscv/2246/dscv_tempdir/rule-instrumentor/32_7a/common-model/ldv_common_model.c" 2
...
# 523 "./arch/x86/include/asm/percpu.h" 2
...
# 197 "./arch/x86/include/uapi/asm/sigcontext.h"
struct _xsave_hdr {
 __u64 xstate_bv;
 __u64 reserved1[2];
 __u64 reserved2[5];
...
# 132 "./arch/x86/include/asm/msr.h" 2
...
# 264 "./arch/x86/include/asm/processor.h"
struct tss_struct {
...
{
# 544 "./arch/x86/include/asm/processor.h"
}
...
# 250 "./arch/x86/include/asm/atomic.h"
...
# 251 "./arch/x86/include/asm/atomic.h" 2
...
static inline __attribute__((no_instrument_function)) void __attribute__((deprecated)) smp_mb__before_atomic_inc(void)
{
 extern void __smp_mb__before_atomic(void);
 __smp_mb__before_atomic();
}
...
static inline __attribute__((no_instrument_function)) void __attribute__((deprecated)) smp_mb__after_atomic_inc(void)
{
 extern void __smp_mb__after_atomic(void);
 __smp_mb__after_atomic();
}
...
static inline __attribute__((no_instrument_function)) void __attribute__((deprecated)) smp_mb__before_atomic_dec(void)
{
 extern void __smp_mb__before_atomic(void);
 __smp_mb__before_atomic();
}
...
static inline __attribute__((no_instrument_function)) void __attribute__((deprecated)) smp_mb__after_atomic_dec(void)
{
 extern void __smp_mb__after_atomic(void);
 __smp_mb__after_atomic();
}
...
# 5 "/work/ldvuser/mutilin/launch/work/current--X--drivers--X--defaultlinux-3.17-rc1.tar.xz--X--32_7a--X--cpachecker/linux-3.17-rc1.tar.xz/csd_deg_dscv/2246/dscv_tempdir/rule-instrumentor/32_7a/common-model/ldv_common_model.c" 2
...
# 6 "/work/ldvuser/mutilin/launch/work/current--X--drivers--X--defaultlinux-3.17-rc1.tar.xz--X--32_7a--X--cpachecker/linux-3.17-rc1.tar.xz/csd_deg_dscv/2246/dscv_tempdir/rule-instrumentor/32_7a/common-model/ldv_common_model.c" 2
# 1 "/home/ldvuser/ldv/inst/kernel-rules/verifier/rcv.h" 1
# 10 "/home/ldvuser/ldv/inst/kernel-rules/verifier/rcv.h"
...
static inline __attribute__((no_instrument_function)) int ldv_undef_int_negative(void)
{
...
static inline __attribute__((no_instrument_function)) int ldv_undef_int_nonpositive(void)
{
  int ret = ldv_undef_int();
...
# 7 "/work/ldvuser/mutilin/launch/work/current--X--drivers--X--defaultlinux-3.17-rc1.tar.xz--X--32_7a--X--cpachecker/linux-3.17-rc1.tar.xz/csd_deg_dscv/2246/dscv_tempdir/rule-instrumentor/32_7a/common-model/ldv_common_model.c" 2
...
int ldv_mutex_lock_interruptible_i_mutex_of_inode(struct mutex *lock)
{
  ...
  ((ldv_mutex_i_mutex_of_inode == 1) ? 0 : ldv_error());
...
void ldv_mutex_unlock_i_mutex_of_inode(struct mutex *lock)
{
  ...
  ((ldv_mutex_i_mutex_of_inode == 2) ? 0 : ldv_error());
...
static int ldv_mutex_lock_of_memstick_host;
...
int ldv_mutex_lock_interruptible_lock_of_memstick_host(struct mutex *lock)
{
  ...
  ((ldv_mutex_lock_of_memstick_host == 1) ? 0 : ldv_error());
...
void ldv_mutex_unlock_lock_of_memstick_host(struct mutex *lock)
{
  ...
  ((ldv_mutex_lock_of_memstick_host == 2) ? 0 : ldv_error());

  ldv_mutex_lock_of_memstick_host = 1;
}

static int ldv_mutex_msb_disk_lock;
...
int ldv_mutex_lock_interruptible_msb_disk_lock(struct mutex *lock)
{
  ...
  ((ldv_mutex_msb_disk_lock == 1) ? 0 : ldv_error());
...
void ldv_mutex_unlock_msb_disk_lock(struct mutex *lock)
{
  ...
  ((ldv_mutex_msb_disk_lock == 2) ? 0 : ldv_error());
