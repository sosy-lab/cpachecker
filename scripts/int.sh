./scripts/cpa.sh -timelimit 10s -setprop log.level=$1 -preprocess -bmc-interpolation -setprop bmc.deriveInterpolantFromSuffix=$2 -spec sv-comp-reachability -stats $3
